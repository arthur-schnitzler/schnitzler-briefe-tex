...
\newcommand\correspDesc[1]{\toendnotes[C]{\footnotesize\hangpara{4em}{1}{\makebox[4em][l]{\makebox[3.6em][r]{X}}}#1\endgraf}}
...
% Zeilennummern statt Seitennummern für sindex anzeigen - FUNKTIONIERT NOCH NICHT
% Rückkehr zur ursprünglichen sindex-Definition, Konfiguration erforderlich
\makeatletter
% Verwende die originale sindex-Definition von reledmac
% Benötigt weitere Forschung für korrekte Zeilennummernreferenzen
\makeatother
