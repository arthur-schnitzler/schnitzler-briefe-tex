%% latex-vorspann.tex
%% Gemeinsamer Vorspann für Korrekturansicht und Leseansicht.
%% Diese Datei wird mit \input eingebunden; die einbindende Datei
%% muss vorher den Schalter setzen:
%%
%%   \newif\ifkorrekturansicht
%%   \korrekturansichttrue   % oder \korrekturansichtfalse
%%
%% Der Schalter steuert nur noch den Index-Korrekturcode
%% (macht \index-Einträge unsichtbar, nur in der Korrekturansicht aktiv).
%% ---------------------------------------------------------------
...
\usepackage[english, french, greek, hebrew, japanese, ngerman]{babel}
\usepackage{ipa}  % für das Seitenwechselzeichen
...
\setkomafont{chapter}{\normalfont\Large}
\renewcommand{\chapterpagestyle}{empty}% The first page in each chapter won't have any heading or footer
...
% Griechische Schrift für Babel konfigurieren
\babelfont[greek]{rm}[Path=../schnitzler-briefe-tex-private-files/]{Brill-Roman.ttf}
\newcommand\griechisch[1]{\foreignlanguage{greek}{#1}}

% Hebräische Schrift für Babel konfigurieren
\babelfont[hebrew]{rm}[Path=../schnitzler-briefe-tex-private-files/]{SBL_Hbrw.ttf}
\newcommand\hebraeisch[1]{\mbox{\foreignlanguage{hebrew}{#1}}}

% Japanisch (derzeit auskommentiert)
...
\doublehyphendemerits=1000000 % verhindert zu viele aufeinanderfolgende Trennstriche am Zeilenende

\input{../tex-inputs/tikz-include}
...
%% Sperrung erreicht man mit \so{gesperrtes Wort}
\sodef\so{}{.14em}{.4em plus.1em minus .1em}{.4em plus.1em minus .1em}

% Schriften der KOMA-Elemente
...
% Fußnoten neu anfangen pro Kapitel/Section
\makeatletter
...
\setlength{\skip\footins}{8mm plus 2mm} % Abstand Fußnote – Text
\interfootnotelinepenalty=10000 % Kein Seitenwechsel in Fußnote
...
% ---------------------------------------------------------------
% SEITENUMBRÜCHE UND EINFÜGUNGSZEICHEN
% ---------------------------------------------------------------
...
\renewcommand\briefempfaengerindex[1]{\sindex[briefe-out]{#1}}
...
\newcommand\eventindex[1]{{\sindex[pw]{#1}}}

\renewcommand\pwindex[1]{{{\sindex[pw]{#1}}}}
\renewcommand\oindex[1]{{{\sindex[pw]{#1}}}}
\renewcommand\orgindex[1]{{{\sindex[pw]{#1}}}}
\renewcommand\eventindex[1]{{{\sindex[pw]{#1}}}}

\newcommand\url[1]{\mbox{#1}}
\renewcommand\ngermanhyphenmins{33}

% Korrektur für sichtbare Index-Einträge – mache \index unsichtbar
\ifkorrekturansicht
  \makeatletter
  \let\original@index\index
  \renewcommand{\index}[2][]{\@bsphack\original@index[#1]{#2}\@esphack}
  \makeatother
\fi

% ---------------------------------------------------------------
% SYMBOLE (Anhang-Ikonen)
% ---------------------------------------------------------------
...
\newcommand{\symmary}{\includegraphics[height=6pt]{../schnitzler-briefe-tex-private-files/noun-hint-626818.png}}
\newcommand{\symcorresp}{\includegraphics[height=6pt]{../schnitzler-briefe-tex-private-files/noun_628664_cc.png}}
...
\newcommand\correspDesc[1]{\toendnotes[C]{\footnotesize\hangpara{4em}{1}{\makebox[4em][l]{\makebox[3.6em][r]{\symcorresp}}}#1\endgraf}}
...
% Das folgende auskommentiert, funktionierte nicht mehr, ging aber in Bahr/Schnitzler.
% Sollte eigentlich dazu dienen, beim Inhaltsverzeichnis die Nummern rechtsbündig zu setzen
\iffalse
...
% ---------------------------------------------------------------
% ERWÄHNTE ENTITÄTEN (Platzhalter-Befehle)
% ---------------------------------------------------------------
...
% HINWEIS: reledmac schreibt \@@number {1} in .idx-Dateien
% Dies wird durch ein Post-Processing in der Engine bereinigt
...
\renewcommand*{\ledrsnotefontsetup}{\scriptsize\sffamily}% right
\thispagestyle{empty}
