\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: André Antoine,  Bech, Georg Brandes, Marie Reinhard, Émile Soutif}
         \newcommand{\erwaehnteOrte}{Orte: Berlin, Dresden, Kopenhagen, Paris, Théâtre Antoine-Simone Berriau, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Der grüne Kakadu. Groteske in einem Akt, Die Nächste, Tagebuch}
