\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Leo Van-Jung}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Weinlaube}
         \newcommand{\erwaehnteOrte}{Orte: Baby Tower Hill, Beach Hotel, Frankgasse, Hong Kong, Klosterneuburg, Wien, Yantai, Österreich}
