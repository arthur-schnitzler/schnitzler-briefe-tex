\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Hugo von Hofmannsthal, Romeo Omarini, Antonio Omarini}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Hôtel du Dauphin}
         \newcommand{\erwaehnteOrte}{Orte: Borromäische Inseln, Isola Bella, Italien, Lago Maggiore, Mailand, Salzburg, Wien}
