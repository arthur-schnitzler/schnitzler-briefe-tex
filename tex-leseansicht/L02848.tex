\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Paula Beer-Hofmann, Jenny Mamroth, Marie Reinhard}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Deutsches Theater Berlin}
         \newcommand{\erwaehnteOrte}{Orte: Berlin, China, Deutsches Postamt in Shanghai, Deutsches Theater Berlin, Deutschland, Italien, Jangtsekiang, Paris, Shanghai, Wien, Wollzeile}
         \newcommand{\erwaehnteWerke}{Werke: Das Vermächtnis. Schauspiel in drei Akten, Der Ehrentag, Die Frau des Weisen. Erzählung, Die Frau des Weisen. Novelletten, Die Toten schweigen, Ein Abschied, Frankfurter Zeitung, Tagebuch}
