\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Anna Bahr-Mildenburg, Hugo von Hofmannsthal, Gustav Mahler, Friedrich Nietzsche, Olga Schnitzler, Siegfried Trebitsch}
         \newcommand{\erwaehnteOrte}{Orte: Lueg am Wolfgangsee, Oper, Rodaun, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Also sprach Zarathustra, Der Apostel. Schauspiel in drei Aufzügen, Der Franzl. Fünf Bilder aus dem Leben eines guten Mannes, Die Walküre, Genesung. Roman, Symphonie Nr. 3 D-Moll, Tristan und Isolde}
