\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Ernst von Wolzogen}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Neues Wiener Tagblatt}
         \newcommand{\erwaehnteOrte}{Orte: Steyrerhof, Volkstheater, Wien, Überbrettl}
         \newcommand{\erwaehnteWerke}{Werke: Der Meister. Komödie in drei Akten, Zum großen Wurstel}
