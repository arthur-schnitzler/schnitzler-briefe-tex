\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Jakob Julius David, Franz Held, Jaques Joachim, Eduard Michael Kafka}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Jung Wien, Leopold Weiss, Moderne Dichtung/Moderne Rundschau}
         \newcommand{\erwaehnteOrte}{Orte: Buchfeldgasse, Joseph G. Wieninger, Weinhandlung, Tuchlauben, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Das Märchen. Schauspiel in drei Aufzügen, Die drei Elixire, Ein Pyrrhus-Sieg. Geschichte eines glücklichen Pechvogels, Hagars Sohn. Schauspiel in vier Acten, Tagebuch}
