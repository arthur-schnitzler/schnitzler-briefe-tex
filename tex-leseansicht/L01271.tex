\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Hugo von Hofmannsthal, Olga Schnitzler, Gustav Schwarzkopf}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Wiener Verlag}
         \newcommand{\erwaehnteOrte}{Orte: IX., Alsergrund, Liesingerstraße, Palasthotel Berlin, Rodaun, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Der einsame Weg. Schauspiel in fünf Akten, Professor Bernhardi. Komödie in fünf Akten, Reigen. Zehn Dialoge}
