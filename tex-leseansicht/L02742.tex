\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Lou Andreas-Salomé, Richard Beer-Hofmann, Theodor Herzl, Hugo von Hofmannsthal, Leopold Sonnemann}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Frankfurter Zeitung, Houghton Library}
         \newcommand{\erwaehnteOrte}{Orte: Bad Aussee, Bad Ischl, Bad Tölz, Bayern, Hotel Marienbad, München, Paris, Salzburg, Straßburg, Ungarn, rue Feydeau}
         \newcommand{\erwaehnteWerke}{Werke: Freiwild. Schauspiel in 3 Akten, Liebelei. Schauspiel in drei Akten, Tagebuch}
