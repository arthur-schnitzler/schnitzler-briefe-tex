\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Lou Andreas-Salomé, Henry Becque, Richard Beer-Hofmann, Clementine Goldmann, Lucien Muhlfeld, Julius Schnitzler, Helene Schnitzler, Hans Schnitzler, Louise Schnitzler, Leopold Sonnemann}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Frankfurter Zeitung}
         \newcommand{\erwaehnteOrte}{Orte: Bad Ischl, Bad Tölz, Kopenhagen, München, Paris, rue Feydeau}
         \newcommand{\erwaehnteWerke}{Werke: La Revue blanche, Pour le Cœur gros de la Poupée, Querelles littéraires}
