...
\newline{}Versand: 1) Stempel: »\nobreak{}\oindex{XVIII., Währing@\textbf{XVIII., Währing}, \emph{Verwaltungsgebiet}|pwk}{[}Wi{]}en 110, 3. X. 04, IX\nobreak{}«.   2) Stempel: »\nobreak{}\oindex{Rodaun@\textbf{Rodaun}, \emph{Region}|pwk}Rodaun, 3. {[}10.{]} 04\nobreak{}«. }
\buchAbdrucke{\weitereDrucke{Hugo von Hofmannsthal, Arthur Schnitzler: \emph{Briefwechsel}. Herausgegeben von Therese Nickl und Heinrich Schnitzler. Frankfurt am Main: \emph{S. Fischer} 1964, S. 203.} }\toendnotes[C]{\smallbreak}\pstart{}{\pb}\damage{Herr}n \textsc{Dr Hugo v Hofmannsthal}\pend{}\pstart{}\textsc{Rodaun \textsuperscript{b}/Liesing}\oindex{Rodaun@\textbf{Rodaun}, \emph{Region}|pw}\pend{}\pstart{}\textsc{Badgasse 5}\oindex{Badgasse@\textbf{Badgasse}, \emph{Straße}|pw}.\pend{}{\bigskip}\vspace{1em}
\pstart
...
\pstart
           lieber, in d\substVorne{}\textsuperscript{er}\substDazwischen{}ieſer\substHinten{} Woche werden wir uns kaum{ }ſehen können; – es fügt{ }ſich gerade, daſs allerlei
               ...
               Eintheilung? Wenn man einmal in den Vormittagsſtunden nach Rodaun\oindex{Rodaun@\textbf{Rodaun}, \emph{Region}|pw} käme, (wofür ich freilich nicht garantiren kann) würde
               man Sie{ }ſtören?\pend
