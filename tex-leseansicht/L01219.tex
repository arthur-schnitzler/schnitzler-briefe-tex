\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen:  Dante Alighieri, Eleonora Duse, Gabriele D’Annunzio, Emil von Jettel-Ettenach}
         \newcommand{\erwaehnteInstitutionen}{}
         \newcommand{\erwaehnteOrte}{Orte: Burgtheater, Italien, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Die göttliche Komödie}
