...
\toendnotes[C]{\smallbreak\pagebreak[2]}\Standort{DLA, A:Schnitzler, HS.NZ85.1.4230,8.}
...
\physDesc{maschinenschriftliche Abschrift1 Blatt, 1 Seite, 2161 Zeichen
\newline{}Schreibmaschine}
\pstart
           \raggedleft{}{\pb}Ziſtersdorf\oindex{Zistersdorf@\textbf{Zistersdorf}, \emph{A.ADM3}|pw}, am 1. Juni 1915\pend
           
\pstart{}Hochverehrter Herr Doktor!\pend\vspace{0.5em}
\pstart
           Sie haben an mehreren meiner literariſchen Produktionen, zuerſt an der »Geſchichte des \textsc{Alî ibn
                     Bekkâr}\pwindex{Geschichte des Alî ibn Bekkâr mit Schams an-Nahâr@\emph{Die Geschichte des Alî ibn Bekkâr mit Schams an-Nahâr}|pw}«, dann am »\textsc{Neidhard}\pwindex{Neidhard@\emph{Neidhard}|pw}« und zuletzt an der Studie »\textsc{Fatme}\pwindex{Fatme@\emph{Fatme}|pw}«, einen mich derart ermutigenden Anteil genommen, daß ich es heute wage, Ihnen
               die beifolgenden ſechs Szenen, die ich unter dem Titel »\textsc{\uline{Der Fremde}}\pwindex{Fremde@\emph{Der Fremde}|pw}« zuſammenfaſſen möchte, mit der ergebenen Bitte zu überſenden, Sie möchten dies
...
\pstart
           Hinzu kommt noch die Erwägung, daß ſich »Der
                  Fremde\pwindex{Fremde@\emph{Der Fremde}|pw}« der Idee nach als drittes Stück der »Geſchichte des \textsc{Alî ibn Bekkâr}\pwindex{Geschichte des Alî ibn Bekkâr mit Schams an-Nahâr@\emph{Die Geschichte des Alî ibn Bekkâr mit Schams an-Nahâr}|pw}« und dem »\textsc{Neidhard}\pwindex{Neidhard@\emph{Neidhard}|pw}« anreiht, die Sie, hochverehrter Herr Doktor, bereits kennen, indem er den
...
\pstart
           ...
           \leftskip=0em{}
\pstart
           \noindent{}\raggedleft{}(D\textsuperscript{r} Rob. Ad. Pollak,{\\}kk. Bez. Richter,{\\}Ziſtersdorf\oindex{Zistersdorf@\textbf{Zistersdorf}, \emph{A.ADM3}|pw})\pend
           \selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzAdam, Robert@\emph{von Robert Adam}!1915-06-011@{1. 6. 1915}|)be}\mylabel{L02207h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
