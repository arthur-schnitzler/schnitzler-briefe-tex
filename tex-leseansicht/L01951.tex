\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Eduard von Bauernfeld, Heinrich Schnitzler, Moritz von Schwind}
         \newcommand{\erwaehnteOrte}{Orte: Edmund-Weiß-Gasse, München, Salzburg, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Die Landpartie. Schwind und Bauernfeld auf einem Leiterwagen}
