\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen:  ?? [Italienischlehrerin in Wien], Hermann Bahr, Richard Beer-Hofmann, Hugo von Hofmannsthal, Gertrude von Hofmannsthal, Edgar von Karg-Bebenburg, Hans Bernhard Schlesinger, Olga Schnitzler, Jakob Wassermann}
         \newcommand{\erwaehnteInstitutionen}{}
         \newcommand{\erwaehnteOrte}{Orte: Badgasse, Hotel Hammerand, Hotel de l’Europe, Hütteldorf, Neuwaldegg, Rodaun, Salzburg, Thüringen, Wien, XVIII., Währing}
         \newcommand{\erwaehnteWerke}{Werke: Die Göttinnen oder Die drei Romane der Herzogin von Assy, Die Jagd nach Liebe}
