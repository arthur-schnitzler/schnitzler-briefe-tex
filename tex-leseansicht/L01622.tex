\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Wagner}
         \newcommand{\erwaehnteInstitutionen}{}
         \newcommand{\erwaehnteOrte}{Orte: Bayreuth, Dänemark, Helsingør, Kurhotellet, Marienlyst, Markgräfliches Opernhaus, Richard-Wagner-Festspielhaus}
