\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Georg Brandes, Emil Granichstaedten,  –r–}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Lessing-Theater}
         \newcommand{\erwaehnteOrte}{Orte: Frankgasse, Lessing-Theater, Volkstheater, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Anatol, Das Märchen. Schauspiel in drei Aufzügen, Das Vaterland, Die Presse, Feuilleton. Deutsches Volkstheater [Märchen], Menschen und Werke, Theater und Kunst [Uraufführung Das Märchen]}
