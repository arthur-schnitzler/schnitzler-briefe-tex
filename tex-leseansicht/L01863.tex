...
\newline{}Schnitzler: mit Bleistift beschriftet: »\textsc{Beer Hofm.}« \newline{}Ordnung: mit Bleistift von unbekannter Hand nummeriert:
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzBeer-Hofmann, Richard@\emph{von Richard Beer-Hofmann}!1909-08-041@{4. 8. 1909}|)be}\mylabel{h}\end{ledgroupsized}  \newcommand{\dateiname}{L01863}\newcommand{\titel}{Richard Beer-Hofmann an Arthur Schnitzler, 4. 8. 1909}\newcommand{\editorInnen}{Martin Anton Müller und Gerd-Hermann Susen}\input{../tex-inputs/latex-pdf-abspann}
