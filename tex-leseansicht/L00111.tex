\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Marie Herzfeld, Otto Ludwig}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Bibliographisches Bureau}
         \newcommand{\erwaehnteOrte}{Orte: Bad Fusch, Strobl, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Anatol, Ascanio und Gioconda, Das Märchen. Schauspiel in drei Aufzügen, Sterben. Novelle}
