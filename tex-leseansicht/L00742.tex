\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Leopold von Andrian-Werburg, Eberhard von Bodenhausen, Friedrich Hess-Diller, Hugo von Hofmannsthal, Robert Lutz, Hans Bernhard Schlesinger}
         \newcommand{\erwaehnteOrte}{Orte: Wien}
         \newcommand{\erwaehnteWerke}{Werke: Der weiße Fächer. Ein Zwischenspiel, Die Hochzeit der Sobeide, Die Schwestern}
