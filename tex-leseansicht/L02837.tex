\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Otto Brahm, Alfred Dreyfus, Hugo von Hofmannsthal, Isidor Singer, Leopold Sonnemann}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Burgtheater, Frankfurter Zeitung, Vossische Zeitung}
         \newcommand{\erwaehnteOrte}{Orte: Frankreich, Paris, Wien, rue de la Bourse}
         \newcommand{\erwaehnteWerke}{Werke: Burgtheater. [Demission von Max Burckhard], Das Vermächtnis. Schauspiel in drei Akten, Die Zeit. Wiener Wochenschrift}
