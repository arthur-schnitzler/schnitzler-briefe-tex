\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen:  ?? [dänischer Journalist, der Schnitzler interviewt], Richard Beer-Hofmann, Gaius Iulius Caesar, Giacomo Girolamo Casanova,  Homer, Buonarroti Michelangelo,  Molière, Fridtjof Nansen, Olga Schnitzler, Heinrich Schnitzler, Lili Schnitzler,  Voltaire}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Københavns Universitet, Philipp Reclam jun., Studentersamfundet}
         \newcommand{\erwaehnteOrte}{Orte: Dagmar Teatret, Frankreich, Kopenhagen, Russland, Wien}
         \newcommand{\erwaehnteWerke}{Werke: ?? [nicht ermitteltes dänisches Interview], Arthur Schnitzler. En Samtale med en beremt Wiener [1921], Gaius Julius Cæsar, Hellas, Homer, Michelangelo Buonarotti, Reigen. Zehn Dialoge, Tartuffe, Voltaire und sein Jahrhundert, Wolfgang Goethe}
