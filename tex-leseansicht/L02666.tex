...
\newline{}Versand: 1) Stempel: »\nobreak{}\oindex{Brüssel@\textbf{Brüssel}, \emph{Hauptstadt}|pwk}\begin{otherlanguage}{dutch}’Sgravenhage\end{otherlanguage}, \begin{otherlanguage}{dutch}5 Jul 91\end{otherlanguage}, 7–8N\nobreak{}«.   2) Stempel: »\nobreak{}\oindex{Wien@\textbf{Wien}, \emph{Verwaltungsgebiet}|pwk}Wien 1/1, 7{[}.{]} 7. 91, 4\textsuperscript{1}/\textsubscript{2}
                                       - 6N, Bestellt\nobreak{}«. 
\newline{}Schnitzler: mit Bleistift das Empfangsdatum »7/ 7 91« und das Jahr »91« vermerkt }\toendnotes[C]{\smallbreak}\pstart{}\textsc{{\pb}Autriche\oindex{Österreich@\textbf{Österreich}|pw}!}\pend{}\pstart{}\textsc{Herrn}\pend{}\pstart{}\textsc{Dr. Arthur Schnitzler}\pend{}\pstart{}\textsc{Wien\oindex{Wien@\textbf{Wien}, \emph{Verwaltungsgebiet}|pw}}\pend{}\pstart{}\textsc{I. Giselastraſse 11\oindex{Ordination Arthur Schnitzler [Bösendorferstraße 11]@\textbf{Ordination Arthur Schnitzler [Bösendorferstraße 11]}, \emph{Ordination}|pw}.}\pend{}{\bigskip}\vspace{1em}
\pstart
