\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hans Christian Andersen, Otto Brahm, Richard Voss}
         \newcommand{\erwaehnteOrte}{Orte: Carl-Theater, Frankgasse, I., Innere Stadt, IX., Alsergrund, Silberner Brunnen, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Die blonde Kathrein. Ein Märchenspiel}
