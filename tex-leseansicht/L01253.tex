...
\physDesc{1 Blatt, 1 Seite, Fotokopie}\toendnotes[C]{\smallbreak}\pstart
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHauptmann, Gerhart@\emph{von Gerhart Hauptmann}!1902-11-291@{{[}29. 11. 1902{]}}|)be}\mylabel{h}\end{ledgroupsized}  \newcommand{\dateiname}{L01253}\newcommand{\titel}{Gerhart Hauptmann an Arthur Schnitzler, [29. 11. 1902]}\newcommand{\editorInnen}{Martin Anton Müller und Gerd-Hermann Susen}
            \footnotesize
