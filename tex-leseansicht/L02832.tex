\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehntePersonen}{Personen: Alfred Dreyfus, Maximilian von Schwartzkoppen, Leopold Sonnemann, Ferdinand Walsin-Esterházy, Alice Ziegler}
         \renewcommand{\erwaehnteInstitutionen}{Institutionen: Frankfurter Zeitung}
         \renewcommand{\erwaehnteOrte}{Orte: Paris, Prag, rue de la Bourse}
