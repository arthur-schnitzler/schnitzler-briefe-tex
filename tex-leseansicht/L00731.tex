\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehntePersonen}{Personen: Franz Grillparzer, Hugo von Hofmannsthal, Josef Kainz}
         \renewcommand{\erwaehnteOrte}{Orte: Burgtheater, Frankgasse 1, Hinterbrühl, IX., Alsergrund, Wien}
         \renewcommand{\erwaehnteWerke}{Werke: Die Jüdin von Toledo}
