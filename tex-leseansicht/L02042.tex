\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehnteInstitutionen}{Institutionen: Ernst Rowohlt Verlag}
         \renewcommand{\erwaehnteOrte}{Orte: Leipzig, Wien}
         \renewcommand{\erwaehnteWerke}{Werke: Bayreuth}
               \section[Hermann Bahr: Widmungsexemplar Bayreuth für Arthur Schnitzler, November 1911]{ Hermann Bahr: Widmungsexemplar Bayreuth für Arthur Schnitzler, November
