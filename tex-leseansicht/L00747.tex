\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehntePersonen}{Personen:  ?? [Autografensammlerin], Hermann Bahr}
...
\newline{}Ordnung: 1) Lochung  2) mit Bleistift von unbekannter Hand datiert:
                                    »8. XII. 97«}\buchAbdrucke{\weitereDrucke{1) \emph{8. 12. 1897.} In: Arthur Schnitzler: \emph{The Letters of Arthur Schnitzler to Hermann Bahr}. Edited, annotated, and with an introduction, by Donald G.
