\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Robert Michel,  Sophokles}
         \newcommand{\erwaehnteOrte}{Orte: Edmund-Weiß-Gasse, Innsbruck, Kaltenleutgeben, Wien, XVIII., Währing}
         \newcommand{\erwaehnteWerke}{Werke: Der Jäger}
