\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Agramer Zeitung}
         \newcommand{\erwaehnteOrte}{Orte: Bad Ischl, Hotel und Pension Rudolfshöhe (Leopold Petter), Kopenhagen}
         \newcommand{\erwaehnteWerke}{Werke: William Shakespeare, [Krankheit von Georg Brandes]}
