...
\newline{}Handschrift Arthur Schnitzler: Bleistift, deutsche Kurrent\newline{}Handschrift Paul Goldmann: Bleistift, deutsche Kurrent\newline{}Versand: 1) Stempel: »\nobreak{}\oindex{Salzburg@\textbf{Salzburg}|pwk}{\pb}Salzburg
           ...
           \pstart
           Ich kann leider nicht nach Wien\oindex{Wien@\textbf{Wien}|pw}, aber Du mußt
                    nach \textsc{Paris}\oindex{Paris@\textbf{Paris}|pw}. Du wirſt mir darauf, wie gewöhnlich, nicht antworten. Das macht nichts.
                    Aber ich \strikeout{er} erwarte Dich in \textsc{Paris}\oindex{Paris@\textbf{Paris}|pw}, nächſtens, ſo nächſtens als möglich. Ja? Treuen Gruß!\pend
           \pstart
           Dein{\\[\baselineskip]}\spacefill\mbox{Paul Goldmann.}\pend
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Beer-Hofmann, Richard@\textsc{Beer-Hofmann, Richard}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1893-09-181@{18. 9. 1893}|)be}\briefempfaengerindex{Beer-Hofmann, Richard@\textsc{Beer-Hofmann, Richard}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1893-09-181@{18. 9. 1893}|)be}\mylabel{h}\end{ledgroupsized}  \newcommand{\dateiname}{L00264}\newcommand{\titel}{Arthur Schnitzler und Paul Goldmann an Richard Beer-Hofmann, 18. 9. 1893}\newcommand{\editorInnen}{Martin Anton Müller und Gerd-Hermann Susen}\input{../tex-inputs/latex-leseansicht-abspann}
