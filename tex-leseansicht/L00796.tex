\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Fritz Engel, Felix Salten, Emil Schiff}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Berliner Börsen-Courier, Freie Bühne}
         \newcommand{\erwaehnteOrte}{Orte: Berlin, Café Arkaden, Deutsches Theater Berlin, Wien}
         \newcommand{\erwaehnteWerke}{Werke: ?? [Rezension von Madonna Dianora], Berliner Tageblatt, Die Frau im Fenster}
