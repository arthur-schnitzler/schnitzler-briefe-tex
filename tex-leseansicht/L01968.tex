\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Josef Kainz, Karl Max Lichnowsky, Mechtilde Lichnowsky}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Burgtheater}
         \newcommand{\erwaehnteOrte}{Orte: Hradec nad Moravicí, Neubeuern, Rodaun, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Das weite Land. Tragikomödie in fünf Akten, Der Rosenkavalier, Der Thor und der Tod, Die Weissagung, Saul. Ein Tragödienfragment}
