...
\pstart
           \raggedleft{}{\pb}Wien\oindex{Wien@\textbf{Wien}, \emph{A.ADM2}|pw} d 23/IX 29\pend
           
\pstart
           \raggedleft{}{[}hs.:{]} I Stallburggasse 2\oindex{Stallburggasse@\textbf{Stallburggasse}, \emph{Straße (K.STR)}|pw}\pend
           \vspace{0.5em}
\pstart
           {[}ms.:{]} Lieber Arthur, darf ich Sie heute um einen Rat fragen in einer
               ...
               Tantiemenabgabe aus Eingängen aus Oest{[}e{]}rreich\oindex{Oesterreich@\textbf{Österreich}, \emph{A.PCLI}|pw} und C.S.R.\oindex{Tschechoslowakei@\textbf{Tschechoslowakei}, \emph{A.PCLH}|pw}\pend
           
\pstart
           Ich weiss dass auch Hugo\pwindex{Hofmannsthal, Hugo von 1874-02-01 – 1929-07-15@\textsc{Hofmannsthal, Hugo von} (1874-02-01 – 1929-07-15), \emph{Schriftsteller/Schriftstellerin}|pw} dies tat wenn es sich
               um ein Werk wie Jedermann\pwindex{Jedermann. Das Spiel vom Sterben des reichen Mannes@\emph{Jedermann. Das Spiel vom Sterben des reichen Mannes}|pw} gehandelt hat welches
               er für Oesterreich\oindex{Oesterreich@\textbf{Österreich}, \emph{A.PCLI}|pw} selbst zum Vertrieb hatte
               und ich weiss auch dass er voriges Jahr im Mai für die Aufführungen in
                  Salzburg\oindex{Salzburg@\textbf{Salzburg}, \emph{A.ADM2}|pw} dem Verein 120 \label{K_L02525-1v}\edtext{S.}{\lemma{\textnormal{\emph{S.}}}\Cendnote{\textnormal{Schilling}}}\label{K_L02525-1} anwies (was unter uns gesagt keine 3{\%} der Einnahmen war) Da die heurigen Einnahmen doch eine
               ziemliche Höhe hatten und auch die Josefstadt\orgindex{Theater in der Josefstadt@Theater in der Josefstadt|pw} den
                  Schwierigen\pwindex{Schwierige. Lustspiel in drei Akten@\emph{Der Schwierige. Lustspiel in drei Akten}|pw} direct mit mir abrechnete so
...
\pstart
           Nun habe ich bei Fischer\orgindex{S. Fischer Verlag@S. Fischer Verlag|pw} nachgesehen und gesehen
               dass er in Deutschland\oindex{Deutschland@\textbf{Deutschland}, \emph{A.PCLI}|pw} immer 2{\%} bei den \label{T_L02525-1v}\edtext{Abrechnungen}{\lemma{\textnormal{\emph{Abrechnungen}}}\Cendnote{\textnormal{Sie schreibt:
...
\pstart
           ...
           \leftskip=0em{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Gertrude von@\emph{von Gertrude von Hofmannsthal}!1929-11-231@{23. 11. 1929}|)be}\mylabel{L02525h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
