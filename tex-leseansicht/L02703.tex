...
\pstart
           {\pb}\textcolor{gray}{\textbf{Frankfurter Zeitung\orgindex{Frankfurter Zeitung@Frankfurter Zeitung|pw}.}}\hfill \textsc{Paris\oindex{Paris@\textbf{Paris}, \emph{P.PPLC}|pw}}, 2. November. \pend
...
\pstart
           Ich habe die mit ungeduldiger Spannung erwartete Sendung\pwindex{Anatol@\emph{Anatol}|pwv} erhalten. Habe mich zunächſt an dem äußeren Eindruck
               ...
               athemlos, athemlos an die Lectüre gemacht und die lieben Seiten\pwindex{Anatol@\emph{Anatol}|pwv} verſchlungen, was ich nicht kannte
               zuerſt – »Abſchiedsſouper\pwindex{Abschiedssouper@\emph{Abschiedssouper}|pw}«, »Agonie\pwindex{Agonie@\emph{Agonie}|pw}«, wo ich beſonders in letzterem {\pb}einfach göttliche Sachen gefunden habe – und was ich
               ...
               Freund geleſen und dann wieder als der Mann, der das Buch\pwindex{Anatol@\emph{Anatol}|pwv} des blauen Einbands wegen aufſchlägt
               ...
               war, nach alledem kann ich Dir nur Eines verſichern: So wie Dein Buch\pwindex{Anatol@\emph{Anatol}|pwv} Dich mir zeigt, biſt Du ein großes,
               herzerquickendes, gottbegnadetes, zukunftsreiches Talent. Ich drücke Dir
               glückwünſchend beide Hände angeſichts dieſes kleinen erſten Band\pwindex{Anatol@\emph{Anatol}|pwv}es, der mir die Kunde davon bringt, daß
...
\pstart
           So hab’ ich getreulich Alles erwogen, das Gute und das Schlimme. Und zuletzt kehre
               ich nochmals zum Guten zurück und danke Dir für die Freude, die das kleine blaue Buch\pwindex{Anatol@\emph{Anatol}|pwv} in mein Zimmer gebracht
...
\pstart
           \label{T_L02703-1v}\edtext{Und \textsc{Richard\pwindex{Beer-Hofmann, Richard 1866-07-11 – 1945-09-26@\textsc{Beer-Hofmann, Richard} (1866-07-11 – 1945-09-26), \emph{Schriftsteller/Schriftstellerin}|pw}} ſoll mir ſchreiben, bitte!}{\lemma{\textnormal{\emph{Und … bitte!}}}\Cendnote{\textnormal{seitlich entlang des Mittelfalzes}}}\label{T_L02703-1}\pend
           \selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1892-11-021@{2. 11. {[}1892{]}}|)be}\mylabel{L02703h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
