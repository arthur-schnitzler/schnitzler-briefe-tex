...
\correspDesc{Versand  durch Hugo von Hofmannsthal am [1. 6. 1905] in Rodaun
\newline{}Erhalt  durch Arthur Schnitzler im Zeitraum [2. 6. 1905
                  – 6. 6. 1905?] in Wien}\toendnotes[C]{\smallbreak}
...
\pstart
           ...
           \vspace{0.5em}
\pstart
           Müſſen ausgerechnet Samstag{ }\label{K_L01522-1v}\edtext{Sommernachtstraum\pwindex{\textcolor{red}{\textsuperscript{XXXX indx1}}!Sommernachtstraum. Komödie in fünf Aufzügen@\strich\emph{Ein Sommernachtstraum. Komödie in fünf Aufzügen}|pw}}{\lemma{\textnormal{\emph{Sommernachtstraum}}}\Cendnote{\textnormal{Sie besuchten ein Gastspiel des \emph{Kleinen}\orgindex{Kleines Theater@Kleines Theater|pwk} und des \emph{Neuen Theaters}\orgindex{Neues Theater@Neues Theater|pwk} im Theater an der Wien\oindex{Wien@\textbf{Wien}!VI., Mariahilf@\textbf{VI., Mariahilf}!Theater an der Wien@\textbf{Theater an der Wien}|pwk}
