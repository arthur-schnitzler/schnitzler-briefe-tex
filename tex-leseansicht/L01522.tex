...
\pstart
           ...
           \vspace{0.5em}
\pstart
           Müſſen ausgerechnet Samstag{ }\label{K_L01522-1v}\edtext{Sommernachtstraum\pwindex{\textcolor{red}{\textsuperscript{XXXX indx1}}!Sommernachtstraum. Komödie in fünf Aufzügen@\strich\emph{Ein Sommernachtstraum. Komödie in fünf Aufzügen}|pw}}{\lemma{\textnormal{\emph{Sommernachtstraum}}}\Cendnote{\textnormal{Sie besuchten ein Gastspiel des \emph{Kleinen}\orgindex{Kleines Theater@Kleines Theater|pwk} und des \emph{Neuen Theaters}\orgindex{Neues Theater@Neues Theater|pwk} im Theater an der Wien\oindex{Theater an der Wien@\textbf{Theater an der Wien}, \emph{Theater}|pwk}
