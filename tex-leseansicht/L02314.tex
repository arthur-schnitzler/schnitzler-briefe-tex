\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Rudolf von Hoyos, Alexander von Villers}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Carl Gerold’s Sohn, Privatbibliothek der Wiener Justizbeamten}
         \newcommand{\erwaehnteOrte}{Orte: Sachsen, Volkstheater, Wien, Österreich}
         \newcommand{\erwaehnteWerke}{Werke: Briefe eines Unbekannten, Der Fremde, Yppl. Idylle in fünf Akten}
