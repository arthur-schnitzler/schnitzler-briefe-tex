...
\physDesc{Brief, maschinenschriftliche Abschrift1 Blatt, 1 Seite, 3906 Zeichen
\newline{}Schreibmaschine}
\pstart
           \raggedleft{}{\pb}Wien\oindex{Wien@\textbf{Wien}, \emph{A.ADM2}|pw}, den 5. Nov. 1917\pend
           
\pstart\center{}Hochverehrter Herr Doktor!\pend\vspace{0.5em}
\pstart
           Ich bin, von der Amtsarbeit lange aufgehalten, endlich mit den Änderungen am »Juda\pwindex{Ende des Judas@\emph{Das Ende des Judas}|pw}« (dem man vielleicht auch den Titel: »Der
...
\pstart
           Die zweite Szene (in Oſtia\oindex{Ostia Antica@\textbf{Ostia Antica}, \emph{P.PPL}|pw}) und die ſechſte (die
...
\pstart
           Was die von Ihnen berührten Modernismen und Fremdworte betrifft, ſo laſſen ſich
               ...
               und ich möchte nur beifügen, daß ich es juſt bei einem in der römiſchen\oindex{Rom@\textbf{Rom}, \emph{P.PPLC}|pw} Kaiſerzeit ſpielenden Stücke für direkt ratſam halte,
               damit nicht zu kargen; es ſoll dadurch vermieden werden, daß die Römer\oindex{Rom@\textbf{Rom}, \emph{P.PPLC}|pw} der alten Römer\oindex{Rom@\textbf{Rom}, \emph{P.PPLC}|pw}-Stücke, Livius\pwindex{Livius, Titus .0059 – 17@\textsc{Livius, Titus} (.0059 – 17), \emph{Geschichtsschreiber/Geschichtsschreiberin}|pw}-gezeugte Puppen von
               ...
               das »gebildete« Lateiniſch mit griechiſchen\oindex{Griechenland@\textbf{Griechenland}, \emph{A.PCLI}|pw}
               Fachausdrücken und Modewörtern und das Griechiſch\oindex{Griechenland@\textbf{Griechenland}, \emph{A.PCLI}|pw} der Orientalen mit orientaliſchen Wendungen und Floſkeln
               durchſetzt war. Und daß ſchließlich meine alten Römer\oindex{Rom@\textbf{Rom}, \emph{P.PPLC}|pw} und Juden gute Wien\oindex{Wien@\textbf{Wien}, \emph{A.ADM2}|pw}er ſind, damit
...
\pstart
           ...
           \leftskip=0em{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzAdam, Robert@\emph{von Robert Adam}!1917-11-051@{5. 11. 1917}|)be}\mylabel{L02279h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
