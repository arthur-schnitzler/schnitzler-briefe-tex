\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Paula Beer-Hofmann, Oskar Beraun, Otto Julius Bierbaum, Gustav Charlé, Friedrich Digruber, Emmy Förster, Hilda Jenik, Marie Madeleine, Gustav Müller, Annie Neumann-Hofer, Arthur Pserhofer, Theodor Robert, Helene Robert, Olga Schnitzler, Friedrich Schönhof, Rosa Vennyer}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Kurtheater in Aussee}
         \newcommand{\erwaehnteOrte}{Orte: Bad Aussee, Berlin, Ischler Straße, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Am Theater und im Leben, Auf Kypros, Das Mädchen ohne Bräutigam, Frauentypen, Kollegen!, Literatur}
