...
\buchAbdrucke{\weitereDrucke{Albert Ehrenstein: \emph{Briefe}. München: \emph{Boer} 1989, S. 29–30.} }\toendnotes[C]{\smallbreak}
\pstart
...
\pstart
           Wenn ich keinen Zwicker trage (und aus Eitelkeit trage ich meiſtens keinen), ſo bin
               ...
               derartiges Malheur ſchon einmal Ihnen gegenüber, ſehr geehrter \introOben{}Herr\introOben{} Doktor, paſſiert, in einer Tramway nach der \label{K_L01840-1v}\edtext{Premiere}{\lemma{\textnormal{\emph{Premiere}}}\Cendnote{\textnormal{Am 29. 12. 1906 im Lustspieltheater\oindex{Lustspieltheater [Wien]@\textbf{Lustspieltheater [Wien]}, \emph{Theater (K.THE)}|pwk} in Wien\oindex{Wien@\textbf{Wien}, \emph{A.ADM2}|pwk}, Schnitzler war nicht bei der Premiere.}}}\label{K_L01840-1}
               der Donnay\pwindex{Donnay, Maurice 12.10.1859 – 31.03.1945@\textsc{Donnay, Maurice} (12.10.1859 – 31.03.1945), \emph{Schriftsteller/Schriftstellerin}|pw}’ſchen {\pb}Lyſiſtrata\pwindex{Lysistrata@\emph{Lysistrata}|pw}. Ein anderesmal nach einer \label{K_L01840-2v}\edtext{Vorleſung im Mariahilf\oindex{VI., Mariahilf@\textbf{VI., Mariahilf}, \emph{A.ADM3}|pw}er Arbeiterheim}{\lemma{\textnormal{\emph{Vorleſung … Arbeiterheim}}}\Cendnote{\textnormal{Gemeint
                  ist die Vorlesung am 16. 10. 1907 für die \emph{Wiener Freie Volksbühne}\orgindex{Wiener Freie Volksbuehne@Wiener Freie Volksbühne|pwk} im sozialdemokratischen Verbandsheim\oindex{Verbandsheim@\textbf{Verbandsheim}, \emph{Vereinslokal (K.VRN)}|pwk} in der Königseggasse 10\oindex{Koenigseggasse@\textbf{Königseggasse}, \emph{Straße (K.STR)}|pwk}.}}}\label{K_L01840-2} verſchlug mir die Befangenheit jeden
...
\pstart
           ...
           \leftskip=0em{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzEhrenstein, Albert@\emph{von Albert Ehrenstein}!1909-05-061@{6. 5. 1909}|)be}\mylabel{L01840h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
