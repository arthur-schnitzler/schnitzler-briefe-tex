\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Clemens von Franckenstein, Jakob Wassermann}
         \newcommand{\erwaehnteInstitutionen}{}
         \newcommand{\erwaehnteOrte}{Orte: Altaussee, Bad Ischl, Salzburg, Toblach}
         \newcommand{\erwaehnteWerke}{Werke: Das Bergwerk zu Falun, Der Schleier der Beatrice. Schauspiel in fünf Akten, Fortunatus. Oper in 3 Akten, op. 16, Lorenza Burgkmair. Karnevals-Stück in drei Akten}
