\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehntePersonen}{Personen: Hugo von Hofmannsthal, Gertrude von Hofmannsthal, Anton Pavlovič Čechov}
         \renewcommand{\erwaehnteOrte}{Orte: Bozen, Lueg am Wolfgangsee, Rosengartengruppe, Salzkammergut, St. Gilgen}
         \renewcommand{\erwaehnteWerke}{Werke: Die Göttinnen oder Die drei Romane der Herzogin von Assy}
...
\newline{}Ordnung: 1) mit Bleistift von unbekannter Hand nummeriert: »\strikeout{251}«  2) mit Bleistift von unbekannter Hand nummeriert:
           ...
           \pstart
           Viele Grüsse \spacefill\mbox{Hugo}{\\[\baselineskip]}\spacefill\mbox{{[}hs. Gertrude von Hofmannsthal:{]} Gerty}\pend
           \leftskip=0em{}
