\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Anton Pavlovič Čechov}
         \newcommand{\erwaehnteOrte}{Orte: Bozen, Lueg am Wolfgangsee, Rosengartengruppe, Salzkammergut, St. Gilgen}
         \newcommand{\erwaehnteWerke}{Werke: Die Göttinnen oder Die drei Romane der Herzogin von Assy}
