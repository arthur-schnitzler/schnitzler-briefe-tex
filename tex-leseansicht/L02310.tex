\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehnteOrte}{Orte: Meidlinger Hauptstraße, Sternwartestraße, Volkstheater, Wien, XII., Meidling}
         \newcommand{\erwaehnteWerke}{Werke: Der Fremde, Yppl. Idylle in fünf Akten}
               \section[Arthur Schnitzler an Robert Adam, 13. 11. 1918]{ Arthur Schnitzler an Robert Adam, 13. 11. 1918}\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]} \Standort{DLA, 96.34.2/15.}
