\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Hugo von Hofmannsthal, Hugo August von Hofmannsthal, Marie Reinhard, Carl Reinhard, Therese Reinhard, Felix Salten, Julius Schnitzler, Gustav Schwarzkopf}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: 28. Congress der deutschen Gesellschaft für Chirurgie}
         \newcommand{\erwaehnteOrte}{Orte: Berlin, Graz, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Der Abenteurer und die Sängerin oder Die Geschenke des Lebens, Der grüne Kakadu – Paracelsus – Die Gefährtin. Drei Einakter, Die Hochzeit der Sobeide}
