...
\newline{}Versand: Stempel: »\nobreak{}\oindex{Rodaun@\textbf{Rodaun}, \emph{A.ADM4}|pwk}Rodaun, 1\textcolor{gray}{7} 12 12, \textcolor{gray}{6}N\nobreak{}«.  
...
\pstart
           ...
           \pstart \spacefill\mbox{Hugo.}\pend{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Hugo von@\emph{von Hugo von Hofmannsthal}!1912-12-171@{1{[}7?{]}. 12. 1912}|)be}\mylabel{L02109h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
