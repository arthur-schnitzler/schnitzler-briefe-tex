\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Julius Schnitzler, Olga Schnitzler, Heinrich Schnitzler, Richard Strauss}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: S. Fischer Verlag}
         \newcommand{\erwaehnteOrte}{Orte: Dresden, Nizza, Ober Sankt Veit, Semmering, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Drut. Roman, Elektra (op. 58), Elektra. Tragödie in einem Aufzug}
