\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Arthur I. Kauffmann, Olga Schnitzler, Julie Wassermann}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Allgemeine elsässische Bankgesellschaft, Georg Müller Verlag}
         \newcommand{\erwaehnteOrte}{Orte: Berlin, Elisabethstraße, Hotel Schottenhamel, Mainz, München, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Casanovas Heimfahrt, Die Schwestern oder Casanova in Spa. Lustspiel in Versen, Gesammelte Werke}
...
\newline{}Schnitzler: 1) auf der ersten Seite mit Bleistift beschriftet: »\textsc{Braun}«  2) mit rotem Buntstift eine Unterstreichung}\toendnotes[C]{\smallbreak}\pstart
           ...
           Daß man ſich hier außerordentlich freuen würde, wenn es gelänge, Ihre neuen
                    Bücher zum Verlag\orgindex{Georg Mueller Verlag@Georg Müller Verlag|pwv} zu
