\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Peter Altenberg, Georg Brandes}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Erich-Reiss-Verlag}
         \newcommand{\erwaehnteOrte}{Orte: Hornbæk, Kopenhagen, Sternwartestraße, Villa Iris, Wien, XVIII., Währing}
         \newcommand{\erwaehnteWerke}{Werke: Fräulein Else, Hauptströmungen der Literatur des neunzehnten Jahrhunderts, Komödie der Verführung. In drei Akten, Michelangelo Buonarotti, Voltaire und sein Jahrhundert}
