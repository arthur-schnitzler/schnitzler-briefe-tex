\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehnteOrte}{Orte: Bad Aussee, Bad Ischl, Bade-Hotel Elisabeth, Erzherzog Johann, Gasthaus Post, Hackinger’s Hotel zum Kaiser von Österreich, Lueg am Wolfgangsee}
...
\newline{}Ordnung: mit Bleistift von unbekannter Hand nummeriert:
           ...
           \noindent{}Lieber Arthur! Wenn das Wetter nicht zu scheusslich ist, bin ich
               ...
               fahren Sie dann \strikeout{d} statt Donnerstag früh,
                  Mittwoch Nachmittag mit mir. In Aussee\oindex{Bad Aussee@\textbf{Bad Aussee}|pw} wohnen Sie nicht Elisabeth\oindex{Bade-Hotel Elisabeth@\textbf{Bade-Hotel Elisabeth}|pw}, das
               um diese Zeit im Veröden sein dürfte. Vielleicht »Post\oindex{Gasthaus Post@\textbf{Gasthaus Post}|pw}« (Ich glaube jetzt »Franz Carl\oindex{Gasthaus Post@\textbf{Gasthaus Post}|pw}«)
               wo Sie schon einmal \label{K_L01436_1v}\edtext{wohnten}{\lemma{\textnormal{\emph{wohnten}}}\Cendnote{\textnormal{vom 28. 7. 1900 bis zum 1. 8. 1900}}}\label{K_L01436_1h}. Oder »Hackinger\oindex{Hackinger s Hotel zum Kaiser von Oesterreich@\textbf{Hackinger’s Hotel zum Kaiser von Österreich}|pw}«, »Erzherz. Johann\oindex{Erzherzog Johann@\textbf{Erzherzog Johann}|pw}«?\pend
           \pstart
