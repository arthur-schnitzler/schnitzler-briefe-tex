...
\buchAbdrucke{\weitereDrucke{Hugo von Hofmannsthal, Arthur Schnitzler: \emph{Briefwechsel}. Herausgegeben von Therese Nickl und Heinrich Schnitzler. Frankfurt am Main: \emph{S. Fischer} 1964, S. 187.} }\pstart{}{\pb}\textsc{Austria\oindex{Österreich@\textbf{Österreich}|pw}}\pend{}\pstart{}Herrn \textsc{Dr Hugo v. Hofma{\geminationn}sthal}\pend{}\pstart{}\textsc{Rodaun bei Vienne\oindex{Wien@\textbf{Wien}!XXIII., Liesing@\textbf{XXIII., Liesing}!Rodaun@\textbf{Rodaun}|pw}.}\pend{}\pstart{}\textsc{Badgasse\oindex{Wien@\textbf{Wien}!XXIII., Liesing@\textbf{XXIII., Liesing}!Badgasse@\textbf{Badgasse}|pw}}\pend{}{\bigskip}\vspace{1em}
\pstart
           \centering{}\textcolor{gray}{\textbf{{\pb}MONREALE\oindex{Monreale@\textbf{Monreale}|pw}}}\pend
           
\pstart
           \centering{}\textcolor{gray}{\textbf{Convento dei Benedettini\oindex{Castellaccio di Monreale@\textbf{Castellaccio di Monreale}|pw}\hspace*{1em}Veduta del Chiostro col Campanile –
                     secolo XII.}}\pend
           \vspace{0.5em}
\pstart
