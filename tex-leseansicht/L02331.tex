\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Otto Brahm, Karl Ernst Henrici, Hermann von Keyserling, Frieda Pollak, Olga Schnitzler, Gustav Schwarzkopf}
         \newcommand{\erwaehnteOrte}{Orte: Bad Aussee, Gärtnergasse, Seidlgasse, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Das Märchen. Schauspiel in drei Aufzügen, Das Reisetagebuch eines Philosophen, Das Schicksal des Freiherrn von Leisenbohg. Novellette, Der Schwierige. Lustspiel in drei Akten, Die Frau ohne Schatten. Erzählung}
