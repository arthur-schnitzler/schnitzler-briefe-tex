...
\newline{}Schnitzler: mit Bleistift datiert: »März 98« \newline{}Ordnung: 1) mit Bleistift von unbekannter Hand nummeriert: »\strikeout{108}«  2) mit Bleistift von unbekannter Hand nummeriert:
           ...
           Am \label{K_L00782_1v}\edtext{zweiten Jänner}{\lemma{\textnormal{\emph{zweiten Jänner}}}\Cendnote{\textnormal{Das Gastspiel hatte bereits von
               ...
               Feiertag hat die \textsc{Réjane}\pwindex{\textcolor{red}{\textsuperscript{XXXX1 indx}}|pw} im Carltheater\oindex{XXXX Ortsangabe fehlt|pw}{ }\uline{nachmittag} die \textsc{Madame Sans Gêne}\textcolor{red}{\textsuperscript{XXXX indx}} geſpielt. Ich wär ſehr froh, wenn ich den {\pb}Theaterzettel von dieſer
               Vorſtellung haben könnt, den ſicher noch irgend ein Diener{[},{]}
               Beamter oder ſo jemand im Carltheater\oindex{XXXX Ortsangabe fehlt|pw} beſitzt.
               Vielleicht könnten Sie mir durch die \textsc{Glümer}\pwindex{\textcolor{red}{\textsuperscript{XXXX1 indx}}|pw} oder ſo mir einen verſchaffen. Das wäre sehr lieb.\pend
           \pstart
