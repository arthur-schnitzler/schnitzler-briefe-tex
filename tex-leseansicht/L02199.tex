...
\buchAbdrucke{\weitereDrucke{1) Georg Brandes, Arthur Schnitzler: \emph{Ein Briefwechsel}. Bern: \emph{Francke} 1956, S. 111–113.} \weitereDrucke{2) Arthur Schnitzler: \emph{Briefe 1913–1931}. Frankfurt am Main: \emph{S. Fischer} 1984, S. 49–51.} }\toendnotes[C]{\smallbreak}
\pstart
...
\pstart
           Erst heute danke ich Ihnen für Ihren Brief vom 23. August d.J., der
               ...
               muss Ihnen mein Schreiben aus Celerina\oindex{Celerina@\textbf{Celerina}, \emph{P.PPL}|pw}
               ...
               mittelbar, aufs Beste fördern könnten. Freilich ist \introOben{}es eine sehr
                  begreifliche\introOben{}\strikeout{die}{ }Sehnsucht von Vielen, die nicht gerade in der Front
...
\pstart
           Es ist sehr wahrscheinlich, dass {\pb}Dänemark\oindex{Daenemark@\textbf{Dänemark}, \emph{A.PCLI}|pw}, sowie die andern neutralen Staaten,
               mehr von dem für Deutschland\oindex{Deutschland@\textbf{Deutschland}, \emph{A.PCLI}|pw} und Oesterreich\oindex{Oesterreich@\textbf{Österreich}, \emph{A.PCLI}|pw} Ungünstigen als von dem Günstigen zu
               ...
               dass in Wien\oindex{Wien@\textbf{Wien}, \emph{A.ADM2}|pw}, im Gegensatz zu den Gerüchten von
...
\pstart
           Ich wünschte sehr zu erfahren, ob {\pb}Sie von Ihrem
               im Feld stehenden Schwiegersohn\pwindex{Philipp, Reinhold 15.08.1883 – 1968@\textsc{Philipp, Reinhold} (15.08.1883 – 1968), \emph{Fabrikant/Fabrikantin}|pwv} Gutes hören. Was uns bisher die Feldpost bisher
...
\pstart
           Bitte schreiben Sie mir bald wie es Ihnen geht. Meine Frau\pwindex{Schnitzler, Olga 17.01.1882 – 13.01.1970@\textsc{Schnitzler, Olga} (17.01.1882 – 13.01.1970), \emph{Schauspieler/Schauspielerin, Sänger/Sängerin}|pwv} und ich grüssen Sie herzlichst{\\[\baselineskip]}{[}hs.:{]} Ihr{\\[\baselineskip]}\spacefill\mbox{Arthur Schnitzler}\pend
           \leftskip=0em{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Brandes, Georg@\textsc{Brandes, Georg}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1914-10-201@{20. 10. 1914}|)be}\mylabel{L02199h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
