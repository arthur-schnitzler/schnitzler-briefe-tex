\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen:  ?? [Verfasser einer abgelehnten Erzählung, 1889], Fedor Mamroth}
         ...
         \newcommand{\erwaehnteWerke}{Werke: ?? [Abgelehnte Erzählung für An der schönen blauen Donau], An der schönen blauen Donau}
