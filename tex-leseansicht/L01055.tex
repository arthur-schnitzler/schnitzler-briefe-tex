\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Oskar Mayer, Hermine von Schaffgotsch}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Wenzel Swatek}
         \newcommand{\erwaehnteOrte}{Orte: Altaussee, Bad Aussee, Bad Ischl, Innsbruck, Klösterle, Levico Terme, Payerbach}
