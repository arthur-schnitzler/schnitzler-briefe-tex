\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Johann Wolfgang von Goethe, Leopold Sonnemann}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Frankfurter Zeitung}
         \newcommand{\erwaehnteOrte}{Orte: Alpen, Bad Ischl, Bad Tölz, Paris, Salzburg, Wien, rue Feydeau, Österreich}
         \newcommand{\erwaehnteWerke}{Werke: Faust. Eine Tragödie}
...
\newline{}Schnitzler: mit Bleistift das Jahr »95« vermerkt }\toendnotes[C]{\smallbreak}\pstart
           ...
           Das wäre ſchön, wenn Du ein wenig hieher kommen wollteſt! Freilich, es wäre ein
               ...
               Bade-Publicum iſt einfach unmöglich. Ich verkehre nur mit Bauern. {\pb}Endlich ich ſelbſt \strikeout{te\textcolor{gray}{ib}} treibe Selbſtpein und brüte Schwermuth. Wenn Du
