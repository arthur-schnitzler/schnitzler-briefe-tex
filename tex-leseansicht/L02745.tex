\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Lou Andreas-Salomé, Fedor Mamroth, Felix Salten, Leopold Sonnemann}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Frankfurter Zeitung}
         \newcommand{\erwaehnteOrte}{Orte: Bad Ischl, Bad Krankenheil, Bad Tölz, Paris, Villa Carlo, rue Feydeau}
