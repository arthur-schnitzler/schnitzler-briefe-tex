\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Carl Karlweis}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Carl Konegen}
         \newcommand{\erwaehnteOrte}{Orte: Wien}
         \newcommand{\erwaehnteWerke}{Werke: Wenn es euch gefällt. Wiener Revue in drei Bildern und einem Vorspiel}
...
\newline{}Handschrift: schwarze Tinte, deutsche Kurrent\newline{}Ordnung: bei der Enteignung des Exemplars 1938 von unbekannter Hand mit Bleistift ergänzte
           ...
           \pstart
           \noindent{}\centering{}\textcolor{gray}{\textbf{\textbf{Wien\oindex{Wien@\textbf{Wien}|pw}er
               Revue}}}\pend
           \pstart
           ...
           \pstart
           \noindent{}\centering{}\textcolor{gray}{\textbf{\textbf{Hermann Bahr} und \textbf{C.
                     Karlweis}\pwindex{Karlweis, Carl 23.11.1850 – 27.10.1901@\textsc{Karlweis, Carl} (23.11.1850 – 27.10.1901), \emph{Schriftsteller}|pw}.}}\pend
           {\bigskip}\pstart
