...
\pstart
           \raggedleft{}{\pb}Wien\oindex{Wien@\textbf{Wien}, \emph{Verwaltungsgebiet}|pw}, 8. Januar 1904.{\\}XVIII. Spöttelg. 7\oindex{Edmund-Weiß-Gasse 7@\textbf{Edmund-Weiß-Gasse 7}, \emph{Wohngebäude}|pw}.\pend
...
\pstart
           Mir hat es recht leid getan, Sie in Wien\oindex{Wien@\textbf{Wien}, \emph{Verwaltungsgebiet}|pw} nicht
               gesehen \damage{zu} haben; bei den \label{K_L01360-1v}\edtext{Scharfrichtern\orgindex{elf Scharfrichter@Die elf Scharfrichter|pw} im Savoy\oindex{Hotel Savoy [Wien]@\textbf{Hotel Savoy [Wien]}, \emph{Hotel}|pw}}{\lemma{\textnormal{\emph{Scharfrichtern im Savoy}}}\Cendnote{\textnormal{Schnitzler hatte mit seiner Gattin
                  ...
                  im Hotel Savoy\oindex{Hotel Savoy [Wien]@\textbf{Hotel Savoy [Wien]}, \emph{Hotel}|pwk} besucht.
