\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Georg Brandes, Olga Schnitzler, Heinrich Schnitzler}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Der Tag}
         \newcommand{\erwaehnteOrte}{Orte: Dänemark, Edmund-Weiß-Gasse, Russland, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Der Ruf des Lebens. Schauspiel in drei Akten, »Der Ruf des Lebens.« Schauspiel von Artur Schnitzler. Erste Aufführung im Lessingtheater}
