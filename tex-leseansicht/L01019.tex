\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Andrea Mantegna}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Accademia di belle arti di Venezia, Wiener Schachclub}
         \newcommand{\erwaehnteOrte}{Orte: Bahnhof, Florenz, Frankgasse, IX., Alsergrund, Venedig, Wien, Österreich}
         \newcommand{\erwaehnteWerke}{Werke: Sankt Georg}
