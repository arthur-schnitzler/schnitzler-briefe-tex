\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Ernst von Dohnányi, Heinrich Heine, Alfred Kerr}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Verein für Kunst und Kultur}
         \newcommand{\erwaehnteOrte}{Orte: Bösendorfer-Saal, Edmund-Weiß-Gasse, Meissl & Schadn, Semmering, Wien}
