\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Hugo von Hofmannsthal, Gertrude von Hofmannsthal, Josef Kainz, Heinrich Schnitzler, Olga Schnitzler, Christiane von Thun-Hohenstein-Salm-Reifferscheidt,  W. Fred, Jakob Wassermann}
         \newcommand{\erwaehnteOrte}{Orte: Die Wochein, Lido, Veldes, Villach, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Das Wort. Tragikomödie in fünf Akten, Der Weg ins Freie. Roman, Dämmerseelen. Novellen}
