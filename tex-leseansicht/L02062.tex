\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Anton Bulling, Bernhard von Bülow,  Franz Ferdinand von Österreich-Este,  Karl I. von Österreich-Ungarn,  Karl Stephan von Österreich, Franz Panhans}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Österreichischer Wintersport-Klub}
         \newcommand{\erwaehnteOrte}{Orte: Bad Gastein, Davos, Franzensbad, Grado, Hotel Erzherzog Johann, Hotel Panhans, Karlsbad, Kirche zur heiligen Familie, Marienbad, Opatija, Piešťany, Semmering, Teplice, Triest}
         \newcommand{\erwaehnteWerke}{Werke: Der Tod des Junggesellen, Masken und Wunder. Novellen, Tagebuch}
