\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehntePersonen}{Personen: Gertrude von Hofmannsthal, Gustav Schwarzkopf, Christiane Zimmer}
         \renewcommand{\erwaehnteOrte}{Orte: Bad Aussee, Obertressen, Wien}
         \renewcommand{\erwaehnteWerke}{}
               \section[Christiane von Hofmannsthal an Arthur Schnitzler, 5. 8. 1929]{ Christiane von Hofmannsthal an Arthur Schnitzler, 5. 8. 1929}\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzZimmer, Christiane@\emph{von Christiane Zimmer}!1929-08-051@{13. 8. 1929}|(be} \toendnotes[C]{\smallbreak\pagebreak[2]} \Standort{CUL, Schnitzler, B 43.}
...
\newline{}Schnitzler: mit rotem Buntstift vier Unterstreichungen sowie die
           ...
           \pstart
           Wir wären Ihnen für baldigste Uebersendung der Briefe sowohl an Sie als an Gustav Schwarzkopf\pwindex{Schwarzkopf, Gustav 07.11.1853 – 13.11.1939@\textsc{Schwarzkopf, Gustav} (07.11.1853 – 13.11.1939), \emph{Schriftsteller}|pw} und wenn Sie können auch der
