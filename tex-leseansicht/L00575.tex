\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehnteOrte}{Orte: Hotel König von Dänemark, Kopenhagen, Schweden, Stockholm, Trollhättan-Fälle}
         \renewcommand{\erwaehnteWerke}{}
               \section[Arthur Schnitzler an Richard Beer-Hofmann, 31. 7. 1896]{ Arthur Schnitzler an Richard Beer-Hofmann, 31. 7. 1896}\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]} \Standort{YCGL, MSS 31.}
...
\newline{}Versand: Stempel: »\nobreak{}\oindex{Schweden@\textbf{Schweden}|pwk}PKXPN \textcolor{gray}{354A}, 31 7 1896\nobreak{}«.  }\pstart{}{\pb}Herrn \textsc{Dr. Richard
           ...
           \noindent{}{\pb}Lieber Richard, i{\geminationm}erhin iſt es möglich, daſs ich ſchon So{\geminationn}tag{ }\uline{früh} in K.\oindex{Kopenhagen@\textbf{Kopenhagen}|pw} bin
               – \textcolor{gray}{ſoweit} ich nach den \textsc{Trollhetta} Fällen\oindex{Trollhaettan-Faelle@\textbf{Trollhättan-Fälle}|pw} nicht zu müd bin, gleich eine
