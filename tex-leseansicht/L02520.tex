\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehnteOrte}{Orte: Bad Aussee, IX., Alsergrund, Meidlinger Hauptstraße, Meran Haus, Sternwartestraße, Wien, XII., Meidling, XIII., Hietzing, XVIII., Währing}
         \newcommand{\erwaehnteWerke}{Werke: Zur Frage des Laienrichtertums beim Handelsgericht}
               \section[Arthur Schnitzler an Robert Adam, 14. 8. 1929]{ Arthur Schnitzler an Robert Adam, 14. 8. 1929}\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]} \Standort{DLA, 96.34.2/32.}
\physDesc{Postkarte
