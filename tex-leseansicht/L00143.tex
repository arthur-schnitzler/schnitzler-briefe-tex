\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Bertha Flegmann, Marie Singer, Alexander Singer}
         \newcommand{\erwaehnteOrte}{Orte: Volkstheater in Rudolphsheim, Wien, Wollzeile}
         \newcommand{\erwaehnteWerke}{Werke: Anatol, Die Jüdin von Toledo, Familie}
