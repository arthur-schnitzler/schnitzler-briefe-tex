...
\pstart
           \centering{}\textcolor{gray}{\textbf{\so{Wien}\oindex{Wien@\textbf{Wien}|pw}\hspace*{1em}\so{und}{ }\so{Leipzig}\oindex{Leipzig@\textbf{Leipzig}|pw}}}\pend
