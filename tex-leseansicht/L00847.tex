\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Otto Brahm, Felix Rappaport, Gustav Schönaich}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Deutsches Theater Berlin, Wiener Rundschau}
         \newcommand{\erwaehnteOrte}{Orte: Spiegelgasse, Wien}
