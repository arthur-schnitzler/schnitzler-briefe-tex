\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Alfred Deutsch-German, Markus Hajek, Felix Salten, Isidor Singer}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Die Zeit, Die Zeit. Wiener Wochenschrift, Neues Wiener Journal}
         \newcommand{\erwaehnteOrte}{Orte: Kuranstalt Dr. Konried, Reichenau an der Rax, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Die Zeit, Neues Wiener Journal, Reigen. Zehn Dialoge, Rezensionen. Wiener Theater 1901 bis 1903}
