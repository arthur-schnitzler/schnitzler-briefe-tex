\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Marie Glümer, Hugo von Hofmannsthal}
         \renewcommand{\erwaehnteOrte}{Orte: Tschortkiw, Wien}
