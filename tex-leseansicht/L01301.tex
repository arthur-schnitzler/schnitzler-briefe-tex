\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Johann Wolfgang von Goethe, Paul Goldmann, Harry von Kessler, Pauline Sachsen-Weimar, Lili Schalk, Olga Schnitzler, Heinrich Schnitzler, Elisabeth Steinrück}
         \newcommand{\erwaehnteOrte}{Orte: Archkogel, Belvedere, Berlin, Brenner, Gasthof Post, Grundlsee (Gemeinde), Italien, Matrei in Osttirol, Stubaital, Val Sugana, Valle d’Ampezzo, Vicenza, Weimar, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Der Tod des Tizian, Die drei Musketiere, Iphigenie auf Tauris}
