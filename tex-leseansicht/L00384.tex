\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Samuel Fischer,  Herodot, Hugo von Hofmannsthal, Karl Kraus, Felix Salten, Paul von Schönthan-Pernwald}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Saubermänner}
         \newcommand{\erwaehnteOrte}{Orte: Italien, Neapel, Rom, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Faust. Eine Tragödie, Moderner Musen-Almanach auf das Jahr 1894. Ein Jahrbuch deutscher Kunst, Moderner Musen-Almanach für das Jahr 1894, Neue Deutsche Rundschau}
