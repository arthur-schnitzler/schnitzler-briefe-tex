\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Georg Brandes, Alfred Forster}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Die Zeit. Wiener Wochenschrift, Siegismund u Volkening}
         \newcommand{\erwaehnteOrte}{Orte: Deutschland, Dänemark, Polen, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Censur in Polen, Eindrücke aus Russland}
