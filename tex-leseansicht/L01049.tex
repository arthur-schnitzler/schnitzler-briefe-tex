...
\toendnotes[C]{\smallbreak\pagebreak[2]}\Standort{TMW, HS Schn 4/27/1.}
...
\pstart
           \textcolor{gray}{\textbf{W., Lützowstr. 7\oindex{Luetzowstrasse@\textbf{Lützowstraße}, \emph{Straße (K.STR)}|pw}.}}\hfill \textcolor{gray}{\textbf{W., Margarethenstr. 1\oindex{Margaretenstrasse [Berlin]@\textbf{Margaretenstraße [Berlin]}, \emph{Straße (K.STR)}|pw}.}}\pend
           
\pstart
           \raggedleft{}\textbf{\textcolor{gray}{\textbf{Berlin W.\oindex{Berlin@\textbf{Berlin}, \emph{P.PPLC}|pw},}} den}{ }23. Juni 1900.\pend
...
\pstart
           Empfangen Sie meinen verbindlichſten Dank für Ihr freundliches Schreiben vom
               ...
               würde, endlich einmal eine Novelle\pwindex{Frau Bertha Garlan. Roman@\emph{Frau Bertha Garlan. Roman}|pwv} von Ihnen bringen zu können u. wie froh ich jede Hoffnung dazu
               ...
               ich kaum glauben, daß ich darin anderer Meinung ſein werde als Sie, u. wage deshalb
                  {\pb}gar nicht, Sie um
               Einſendung Ihrer Arbeit\pwindex{Frau Bertha Garlan. Roman@\emph{Frau Bertha Garlan. Roman}|pwv} zu
...
\pstart
           ...
           \leftskip=0em{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzRodenberg, Julius@\emph{von Julius Rodenberg}!1900-06-231@{23. 6. 1900}|)be}\mylabel{L01049h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
