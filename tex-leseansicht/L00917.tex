\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Georg Brandes, Ludwig Fulda}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Die Zukunft}
         \newcommand{\erwaehnteOrte}{Orte: Dänemark, Kopenhagen, Niederösterreich, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Samlede Skrifter [Gesammelte Werke], Ungdomsvers [Jugendgedichte]}
