\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Alfred von Berger, Emerich von Bukovics, Albert Gutmann, Josef Kainz}
         \newcommand{\erwaehnteInstitutionen}{}
         \newcommand{\erwaehnteOrte}{Orte: Bösendorfer-Saal, Deutsches Schauspielhaus in Hamburg, Hamburg, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Die Frau mit dem Dolche, Die letzten Masken, Lebendige Stunden, Lebendige Stunden. Vier Einakter, Lieutenant Gustl. Novelle, Literatur}
