\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Sandro Botticelli}
         \newcommand{\erwaehnteOrte}{Orte: Florenz, Frankgasse, IX., Alsergrund, Santa Maria Novella, Uffizien, Wien, Österreich}
         \newcommand{\erwaehnteWerke}{Werke: Die Krönung der Jungfrau}
