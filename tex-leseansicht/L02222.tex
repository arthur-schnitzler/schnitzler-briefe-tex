\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Napoleon Bonaparte, Georg Brandes, Johann Wolfgang von Goethe, Peter Nansen, Reinhold Philipp, Olga Schnitzler, Karl Schönherr}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Kölnische Zeitung, S. Fischer Verlag}
         \newcommand{\erwaehnteOrte}{Orte: Berlin, Deutschland, Dänemark, Sternwartestraße, Wien, Österreich}
         \newcommand{\erwaehnteWerke}{Werke: Der Querulant. Komödie in vier Akten, Der Weibsteufel, Der junge Medardus. Dramatische Historie in einem Vorspiel und fünf Aufzügen, Die Brüder Menthe, Hermann Bahrs Querulant, Komödie der Worte. Drei Einakter, Professor Bernhardi. Komödie in fünf Akten, Wolfgang Goethe}
