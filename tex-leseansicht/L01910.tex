\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehntePersonen}{Personen: Leo Blech, Lili Cappellini, Hugo von Hofmannsthal, Olga Schnitzler}
         \renewcommand{\erwaehnteInstitutionen}{Institutionen: Wiener Werkstätte}
         \renewcommand{\erwaehnteOrte}{Orte: Wien}
         \renewcommand{\erwaehnteWerke}{Werke: Versiegelt. Komische Oper}
