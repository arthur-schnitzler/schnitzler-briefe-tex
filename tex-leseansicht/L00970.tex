\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehntePersonen}{Personen: Hugo von Hofmannsthal, Ferdinand Miliczek}
         \renewcommand{\erwaehnteOrte}{Orte: Altaussee, Bad Ischl, Gasthaus Brunnthaler}
