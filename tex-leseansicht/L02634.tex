\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Ernest von Gréger-Jurco, Josef Kvasnicka, Karl Strecker}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Berliner Tageblatt, Rose-Theater, Tägliche Rundschau}
         \newcommand{\erwaehnteOrte}{Orte: Berlin, Frankgasse, Wien, Zimmerstraße}
         \newcommand{\erwaehnteWerke}{Werke: Die Kinder der Armen, Ein litterarisch-dramatisches Hochstapler-Stücklein}
