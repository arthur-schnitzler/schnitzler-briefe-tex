\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Hermine von Schaffgotsch}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Die Zeit. Wiener Wochenschrift}
         \newcommand{\erwaehnteOrte}{Orte: Deutschland, Marienbad, Salzburg, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Das Bergwerk zu Falun, Der Schleier der Beatrice. Schauspiel in fünf Akten, Die Nächste}
