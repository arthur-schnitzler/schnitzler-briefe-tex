\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Frieda Pollak, Berta Zuckerkandl}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Rikola  Verlag}
         \newcommand{\erwaehnteOrte}{Orte: Rodaun, Salzburg, Stallburggasse, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Tod und Verklärung op. 24}
