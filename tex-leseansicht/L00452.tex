...
\pstart
           ...
           \leftskip=0em{}
\pstart
           \textcolor{gray}{\textbf{\label{T_L00452-1v}\edtext{Alle für »Die Zeit\orgindex{Zeit. Wiener Wochenschrift [Redaktion]@Die Zeit. Wiener Wochenschrift [Redaktion]|pw}« beſtimmten Zuſchriften und Sendungen{ }ſind an die
                  Redaction der »Zeit\orgindex{Zeit. Wiener Wochenschrift [Redaktion]@Die Zeit. Wiener Wochenschrift [Redaktion]|pw}« und \textbf{nicht} an die Perſon eines der Herausgeber zu richten.}{\lemma{\textnormal{\emph{Alle … richten.}}}\Cendnote{\textnormal{am unteren Rand der Seite}}}\label{T_L00452-1}}}\pend
