...
\newline{}Erhalt  durch Richard Beer-Hofmann am 14. 8. 1906 in Liesingerstraße}\toendnotes[C]{\smallbreak}
\Standort{YCGL, MSS 31.}
\physDesc{Bildpostkarte, 106 Zeichen
\newline{}Handschrift: Bleistift, deutsche Kurrent
\newline{}Versand: 1) Stempel: »\nobreak{}\oindex{Weimar@\textbf{Weimar}|pwk}Wei{[}mar{]}, 13. \textcolor{gray}{8}. 0\textcolor{gray}{6}, 12\nobreak{}«.   2) Stempel: »\nobreak{}\oindex{Wien@\textbf{Wien}!XXIII., Liesing@\textbf{XXIII., Liesing}!Rodaun@\textbf{Rodaun}|pwk}{[}Ro{]}daun, 14{[}. 8. 1906{]}\nobreak{}«. 
\newline{}Ordnung: mit Bleistift von unbekannter Hand datiert: »13. 8.« }\toendnotes[C]{\smallbreak}\pstart{}{\pb}\textsc{Dr. Richard Beer-Hofmann}\pend{}\pstart{}\textsc{Rodaun bei Wien}\oindex{Wien@\textbf{Wien}!XXIII., Liesing@\textbf{XXIII., Liesing}!Rodaun@\textbf{Rodaun}|pw}\pend{}\pstart{}\textsc{Liesingerstraße 1}\oindex{Liesingerstraße@\textbf{Liesingerstraße}|pw}.\pend{}{\bigskip}
\pstart
           \noindent{}\centering{}{\pb}\textcolor{gray}{\textbf{WEIMAR, SCHLOSS BELVEDÈRE,{ }\label{K_L01623-1v}\edtext{\uline{NATUR}THEATER}{\lemma{\textnormal{\emph{Naturtheater}}}\Cendnote{\textnormal{Unterstreichung des Wortteiles
                        und Markierung des ganzen Wortes von Schnitzler.}}}\label{K_L01623-1}\oindex{Schloss Belvedere [Weimar]@\textbf{Schloss Belvedere [Weimar]}|pw}.}}\pend
           \vspace{1em}
\pstart
           \raggedleft{}{\pb}\textsc{Weimar}\oindex{Weimar@\textbf{Weimar}|pw}, 13. 8. 906.\pend
           \vspace{0.5em}
\pstart
