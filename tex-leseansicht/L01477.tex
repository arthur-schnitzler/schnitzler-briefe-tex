\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Fritz Oswald Bilse, Gustav Mahler, Olga Schnitzler, Katharina Streitmann, Karl Streitmann}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Berliner Tageblatt}
         \newcommand{\erwaehnteOrte}{Orte: Musikverein, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Aus einer kleinen Garnison, Der Bettelstudent, Der Puppenspieler, Der einsame Weg. Schauspiel in fünf Akten, Die Fledermaus, Lebendige Stunden. Vier Einakter, Symphonie Nr. 3 D-Moll}
