\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Hugo von Hofmannsthal, Anna Kupelwieser,  Tizian}
         \newcommand{\erwaehnteOrte}{Orte: Mähren, Pieve di Cadore, Pörtschach, Znaim}
         \newcommand{\erwaehnteWerke}{Werke: Das Kind, Der Tod des Tizian}
