\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Oskar Blumenthal, Richard Skowronnek, Leopold Sonnemann}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Frankfurter Zeitung, Lessing-Theater}
         \newcommand{\erwaehnteOrte}{Orte: Berlin, Paris, Pustertal, Salzburg, Schweiz, Wien, rue Richelieu}
         \newcommand{\erwaehnteWerke}{Werke: Das Märchen. Schauspiel in drei Aufzügen, Der erste seines Stammes. Lustspiel in vier Akten, Eine Palastrevolution}
