\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Paula Beer-Hofmann, Richard Beer-Hofmann, Gabriel Beer-Hofmann, Mirjam Beer-Hofmann, Naëmah Beer-Hofmann, Otto Carl Waldemar Benzon, Ernst von Dohnányi, Ernst von Schuch}
         \newcommand{\erwaehnteInstitutionen}{}
         \newcommand{\erwaehnteOrte}{Orte: Dresden, Dänemark, Hasenauerstraße, Hotel Bellevue, Wien, XIX., Döbling}
         \newcommand{\erwaehnteWerke}{Werke: Der Schleier der Pierrette}
