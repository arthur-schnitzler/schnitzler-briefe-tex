\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hans Pfitzner}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Oper Straßburg, Straßburger Philharmoniker, Städtisches Konservatorium}
         \newcommand{\erwaehnteOrte}{Orte: Schönburgstraße, Straßburg, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Palestrina. Musikalische Legende in drei Akten, Paracelsus. Versspiel in einem Akt}
