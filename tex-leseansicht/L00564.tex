\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, William Shakespeare}
         \newcommand{\erwaehnteOrte}{Orte: Altaussee, Bad Fusch, Dänemark, Japan, Salzburg, Trondheim}
         \newcommand{\erwaehnteWerke}{Werke: Anatol, Freiwild. Schauspiel in 3 Akten, Liebelei. Schauspiel in drei Akten}
