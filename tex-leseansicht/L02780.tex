\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen:  Gustav II. Adolf, Leopold Sonnemann}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Frankfurter Zeitung, Französische Nationalversammlung}
         \newcommand{\erwaehnteOrte}{Orte: Hamburg, Norwegen, Palais Bourbon, Paris, Schweden, Trondheim, rue Feydeau}
...
\newline{}Schnitzler: mit Bleistift das Jahr »96« vermerkt }\toendnotes[C]{\smallbreak}\pstart
           ...
           Gott befohlen, mein lieber Freund, und möge Dir der ſchwed\oindex{Schweden@\textbf{Schweden}|pwv}iſche Himmel hold ſein (wenn es
               ...
               das ſeit \label{K_L02780-4v}\edtext{Guſtav Adolph\pwindex{Gustav II. Adolf @\textsc{Gustav II. Adolf}, \emph{König}|pw}}{\lemma{\textnormal{\emph{Guſtav Adolph}}}\Cendnote{\textnormal{schwed\oindex{Schweden@\textbf{Schweden}|pwkv}ischer König\pwindex{Gustav II. Adolf @\textsc{Gustav II. Adolf}, \emph{König}|pwkv} zwischen 1611 und 1632}}}\label{K_L02780-4h} jede Exiſtenzberechtigung verloren hat, ſo etwas gibt, wie einen Himmel).\pend
           \pstart
