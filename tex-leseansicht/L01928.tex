\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehntePersonen}{Personen: Hugo von Hofmannsthal,  Sedlaček}
         \renewcommand{\erwaehnteOrte}{Orte: Budapest, Theater an der Wien, Wien}
