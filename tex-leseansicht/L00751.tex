...
\newline{}Schnitzler: mit Bleistift datiert: »25/XII 97« \newline{}Ordnung: mit Bleistift von unbekannter Hand nummeriert: »108« }\pstart
           \noindent{}{\pb}Lieber Arthur der
                  Hugo\pwindex{Hofmannsthal, Hugo von 01.02.1874 – 15.07.1929@\textsc{Hofmannsthal, Hugo von} (01.02.1874 – 15.07.1929), \emph{Schriftsteller}|pw} ko{\geminationm}t um
                  7 Uhr zu mir (Wollzeile\oindex{Wollzeile@\textbf{Wollzeile}|pw}.)
               Sie doch auch?\pend
           \pstart
           Jedenfalls bleiben wir bei mir bis Sie ko{\geminationm}en.\pend
           \pstart
           Herzlichst{\\[\baselineskip]}\spacefill\mbox{Richard}\pend
           \leftskip=0em{}          \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzBeer-Hofmann, Richard@\emph{von Richard Beer-Hofmann}!1897-12-251@{{[}25. 12. 1897{]}}|)be}\mylabel{h}\end{ledgroupsized}  \newcommand{\dateiname}{L00751}\newcommand{\titel}{Richard Beer-Hofmann an Arthur Schnitzler, [25. 12. 1897]}\newcommand{\editorInnen}{Martin Anton Müller und Gerd-Hermann Susen}\input{../tex-inputs/latex-leseansicht-abspann}
