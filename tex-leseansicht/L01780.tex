\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Katharina Selma Hartleben, Otto Erich Hartleben, Franz August Carl Maria Reisch}
         \newcommand{\erwaehnteOrte}{Orte: Meran, Ober Sankt Veit, Seis am Schlern, Veitlissengasse, Villa Heufler, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Moppchen, Neue Freie Presse, Partie in Seis am Schlern}
               \section[Olga und Arthur Schnitzler an Hermann Bahr, 6. 7. 1908]{ Olga und Arthur Schnitzler an Hermann Bahr, 6. 7. 1908}\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]} \Standort{TMW, HS AM 60163 Ba.}
