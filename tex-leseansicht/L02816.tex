\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Houston Stewart Chamberlain, Maxime Dethomas, Hugo von Hofmannsthal, Jeanne Marni, Marie Reinhard, Therese Reinhard, Louise Schnitzler, Leopold Sonnemann, Leo Van-Jung, Richard Wagner}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Bayreuther Festspiele, Frankfurter Zeitung}
         \newcommand{\erwaehnteOrte}{Orte: Andermatt, Bad Ischl, Bayreuth, Louveciennes, Paris, Schweiz, Wien, rue de la Bourse}
         \newcommand{\erwaehnteWerke}{Werke: Das Vermächtnis. Schauspiel in drei Akten, Der Tod Georgs, Parsifal, Richard Wagner, Tagebuch}
