...
\newline{}Handschrift: schwarze Tinte, deutsche Kurrent}\pstart
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzBurckhard, Max Eugen@\emph{von Max Eugen Burckhard}!1910-04-081@{8. 4. 1910}|)be}\mylabel{h}\end{ledgroupsized}  \newcommand{\dateiname}{L01922}\newcommand{\titel}{Max Burckhard an Arthur Schnitzler, 8. 4. 1910}\newcommand{\editorInnen}{Martin Anton Müller und Gerd-Hermann Susen}\input{../tex-inputs/latex-leseansicht-abspann}
