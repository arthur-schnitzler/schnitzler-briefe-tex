\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Heinrich Kadelburg}
         \newcommand{\erwaehnteOrte}{Orte: Berlin, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Der Puppenspieler, Die Frau mit dem Dolche, Die letzten Masken, Lebendige Stunden, Literatur}
