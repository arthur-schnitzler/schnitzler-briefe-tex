\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Gustav Charlé, Herbert Eulenberg, Samuel Fischer, Emil Heyse, Constance von Linden, Hans Ziegler}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Neue Wiener Bühne, Wiener Freie Volksbühne}
         \newcommand{\erwaehnteOrte}{Orte: Graben, I., Innere Stadt, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Der Puppenspieler, Die Frage an das Schicksal, Die letzten Masken, Ein halber Held. Tragödie, Literatur}
