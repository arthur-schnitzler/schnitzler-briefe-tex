\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Johann Wolfgang von Goethe, Maximilian Herz, Julius von Hochenegg, Ferdinand Onno, Johann Schnitzler}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Allgemeine Poliklinik}
         \newcommand{\erwaehnteOrte}{Orte: Berlin, Wien}
         \newcommand{\erwaehnteWerke}{Werke: An den Mond, Professor Bernhardi. Komödie in fünf Akten}
