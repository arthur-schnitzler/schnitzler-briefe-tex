\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehnteWerke}{Werke: Hermann Bahr}
               \section[Arthur Schnitzler an Hermann Bahr, 25. 5. 1912]{ Arthur Schnitzler an Hermann Bahr, 25. 5. 1912}\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]} \Standort{TMW, HS AM 60143 Ba.}
\physDesc{Briefkarte, 289 Zeichen (Trauerrand )
