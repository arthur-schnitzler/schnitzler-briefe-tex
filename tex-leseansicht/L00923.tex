\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: André Antoine, Georg Brandes, Émile Soutif}
         \newcommand{\erwaehnteOrte}{Orte: Paris, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Adreßbuch für Dresden und Vororte, Der grüne Kakadu. Groteske in einem Akt}
