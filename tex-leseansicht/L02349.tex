\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehnteOrte}{Orte: Gutenstein, Sternwartestraße 71, Wien}
...
\newline{}Handschrift: schwarze Tinte (\noindent{}Unterschrift)}\toendnotes[C]{\smallbreak}\pstart
           ...
           So viel ich weiss sind Sie zu allem andern auch ein Kenner der arabischen Sprache.
               Ich lege Ihnen hier \label{K_L02349-1v}\edtext{zwei Zettel}{\lemma{\textnormal{\emph{zwei Zettel}}}\Cendnote{\textnormal{Die Beilage ist nicht erhalten.}}}\label{K_L02349-1h} bei, die
