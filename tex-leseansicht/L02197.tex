\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Leopold von Berchtold, Sándor Hoyos, Olga Schnitzler}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Ministerium für Äußeres}
         \newcommand{\erwaehnteOrte}{Orte: Rodaun, Rumänien, Wien}
