\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Richard Beer-Hofmann, Alfred Gold, Heinrich Kanner, Isidor Singer, Jakob Wassermann}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Die Zeit. Wiener Wochenschrift}
         \newcommand{\erwaehnteOrte}{Orte: Bad Ischl, Günthergasse, Kärnten, Seeboden, Villa Platzer, Wien}
