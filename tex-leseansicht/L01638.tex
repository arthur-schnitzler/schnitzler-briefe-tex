\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Felix Paul Greve, Hugo von Hofmannsthal, Ruth Saint Denis, Jakob Wassermann}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Insel-Verlag}
         \newcommand{\erwaehnteOrte}{Orte: Berlin, Deutschland, Göttingen, München, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Der Tag, Die Schwestern. Drei Novellen, Die unvergleichliche Tänzerin, Tausendundeine Nacht, Unterhaltungen über ein neues Buch, Vorrede}
