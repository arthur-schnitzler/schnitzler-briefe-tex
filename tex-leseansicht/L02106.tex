...
\newline{}Schnitzler: mit Bleistift datiert: »1/12 912« \newline{}Ordnung: 1) mit Bleistift von unbekannter Hand nummeriert:
           ...
           \pstart \spacefill\mbox{Altenberg}\pend{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzAltenberg, Peter@\emph{von Peter Altenberg}!1912-12-011@{1. 12. 191{[}2{]}}|)be}\mylabel{h}\end{ledgroupsized}  \newcommand{\dateiname}{L02106}\newcommand{\titel}{Peter Altenberg an Arthur Schnitzler, 1. 12. 191[2]}\newcommand{\editorInnen}{Martin Anton Müller und Gerd-Hermann Susen}\input{../tex-inputs/latex-leseansicht-abspann}
