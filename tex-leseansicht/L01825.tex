...
\newline{}Handschrift: roter Buntstift, lateinische Kurrent (\noindent{}»Ehrenstein«)}\toendnotes[C]{\smallbreak}\pstart
           ...
           \endnumbering\briefempfaengerindex{Ehrenstein, Albert@\textsc{Ehrenstein, Albert}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1909-01-201@{20. 1. 1909}|)be}\mylabel{h}\end{ledgroupsized}  \newcommand{\dateiname}{L01825}\newcommand{\titel}{Arthur Schnitzler an Albert Ehrenstein, 20. 1. 1909}\newcommand{\editorInnen}{Martin Anton Müller und Gerd-Hermann Susen}\input{../tex-inputs/latex-pdf-abspann}
