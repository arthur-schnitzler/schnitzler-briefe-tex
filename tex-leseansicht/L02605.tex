...
\pstart
           \raggedleft{}{\pb}\textsc{Paris\oindex{Paris@\textbf{Paris}, \emph{P.PPLC}|pw},}{ }8. Januar.\pend
           
\pstart\center{}Mein lieber Freund,\pend\vspace{0.5em}
\pstart
           Ich bin heute ſo ganz verzweifelt ins Bureau\oindex{rue Richelieu@\textbf{rue Richelieu}, \emph{Straße (K.STR)}|pwv} gekommen und habe Deinen lieben Brief gefunden! Du
...
\pstart
           {\pb}Bitte, liebſter Freund, ſchick’ mir noch zwei \textsc{Anatol\pwindex{Anatol@\emph{Anatol}|pw}}-Exemplare. Ich brauche ſie hier in Deinem Intereſſe. Vielleicht kann ich Dir
               doch hier eine Beſprechung verſchaffen. In der Frankfurter Zeitg.\orgindex{Frankfurter Zeitung@Frankfurter Zeitung|pw} kommſt Du \label{K_L02605-1v}\edtext{demnächſt}{\lemma{\textnormal{\emph{demnächſt}}}\Cendnote{\textnormal{Eine Rezension erschien
                  nicht, siehe Paul Goldmann an Arthur Schnitzler, 29. 5. [1894].
               }}}\label{K_L02605-1} an die Reihe.\pend
           
\pstart
           Bitte, danke auch Herrn \textsc{Salten\pwindex{Salten, Felix 06.09.1869 – 08.10.1945@\textsc{Salten, Felix} (06.09.1869 – 08.10.1945), \emph{Schriftsteller/Schriftstellerin, Journalist/Journalistin, Chefredakteur/Chefredakteurin}|pw}} für ſeine freundlichen Worte, die mich ſehr bewegt haben, und verſichere ihn
               meiner aufrichtigen Ergebenheit. Er möchte mir auch einmal etwas {\pb}von ſich ſchicken, und er ſoll nach \textsc{Paris\oindex{Paris@\textbf{Paris}, \emph{P.PPLC}|pw}} kommen. Danke auch all’ den lieben \label{K_L02605-2v}\edtext{Leuten}{\lemma{\textnormal{\emph{Leuten}}}\Cendnote{\textnormal{nicht
...
\pstart
           ...
           \leftskip=0em{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1894-01-081@{8. 1. {[}1894{]}}|)be}\mylabel{L02605h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
