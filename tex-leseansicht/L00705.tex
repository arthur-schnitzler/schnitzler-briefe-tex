\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Peter Altenberg, Richard Beer-Hofmann, Georg Brandes, Paul Goldmann}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Frankfurter Zeitung}
         \newcommand{\erwaehnteOrte}{Orte: Bad Ischl, Dänemark, Kopenhagen, Paris, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Wie ich es sehe}
