\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Marie Reinhard}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Norddeutscher Lloyd, Preussen}
         \newcommand{\erwaehnteOrte}{Orte: Bad Ischl, Bremen, China, Deutsches Postamt in Shanghai, Indischer Ozean, Rotes Meer, Sri Lanka, Wien}
