...
\newline{}Ordnung: mit Bleistift von Schnitzler mutmaßlich während der Durchsicht der Briefe
           ...
           \noindent{}{\pb}Lieber Hugo, morgen So{\geminationn}tag bin ich Nachmittags in einem
                  \label{K_L00080_1v}\edtext{Concert}{\lemma{\textnormal{\emph{Concert}}}\Cendnote{\textnormal{Das einzige Konzert, das an einem Sonntagnachmittag Werke von
                  ...
                  Hinweis, dass er es besuchte, sondern es ist für den Tag nur ein Besuch in der \emph{Schauspielschule Otto}\orgindex{Schauspielschule Otto@Schauspielschule Otto|pwk} vermerkt. (\emph{Cambridge University Library} A 179a).}}}\label{K_L00080_1h}, wo
