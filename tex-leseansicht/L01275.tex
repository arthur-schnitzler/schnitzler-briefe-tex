...
\toendnotes[C]{\smallbreak\pagebreak[2]}\Standort{Staatsbibliothek Berlin – Preußischer Kulturbesitz, GHBrBl A:Schnitzler (8).}
...
\newline{}Ordnung: Lochung }\toendnotes[C]{\smallbreak}\pstart{}{\pb}Gerhart Hauptmann\pend{}\pstart{}Agnetendorf\oindex{Jagniątków@\textbf{Jagniątków}, \emph{P.PPL}|pw}\pend{}{\bigskip}\vspace{1em}
\pstart
           
\pstart
           {\pb}\textcolor{gray}{\textbf{Telegramm aus}}{ }Berlin 9\oindex{Berlin@\textbf{Berlin}, \emph{P.PPLC}|pw}\pend
...
\pstart
           ...
           \vspace{0.5em}
\pstart
           Hätten Ihre lieben Wünſche ſo viel Kraft gehabt als Sie mich erfreuten es\pwindex{Schleier der Beatrice. Schauspiel in fuenf Akten@\emph{Der Schleier der Beatrice. Schauspiel in fünf Akten}|pwv} wäre ein großer Erfolg
               geworden. Ich grüße Sie in herzlicher Freundſchaft\pend
           \pstart \spacefill\mbox{Arthur Schnitzler}\pend{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Hauptmann, Gerhart@\textsc{Hauptmann, Gerhart}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1903-03-081@{8. 3. 1903}|)be}\mylabel{L01275h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
