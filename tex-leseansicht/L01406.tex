\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Adolph Donath, Gertrude von Hofmannsthal, Hugo August von Hofmannsthal, Karl Kraus, Detlev von Liliencron}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Carl Konegen}
         \newcommand{\erwaehnteOrte}{Orte: Niederlande, Rodaun, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Die Fackel, Zur Liliencron-Feier, Österreichische Dichter zum 60. Geburtstage Detlev von Liliencrons}
