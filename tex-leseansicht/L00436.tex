...
\rehead{ }\normalsize\beginnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzAndreas-Salome, Lou@\emph{von Lou Andreas-Salomé}!1895-05-021@{{[}2. 5.? 1895{]}}|(be}
...
\pstart
           {\pb}\textsc{Hotel Royal}\oindex{Hotel Royal@\textbf{Hotel Royal}, \emph{Hotel (K.HTL)}|pw}{\\}\label{K_L00436-1v}\edtext{Donnerſtag}{\lemma{\textnormal{\emph{Donnerſtag}}}\Cendnote{\textnormal{Der Brief vom 28. 4. 1895
...
\pstart
           morgen bin ich um 6 Uhr noch nicht zu Hauſe, aber dafür in Ihrer
               nächſten Nähe, nämlich in der Univerſität\oindex{Universitaet Wien@\textbf{Universität Wien}, \emph{Universität (K.UNI)}|pw}
...
\pstart
           ...
           \leftskip=0em{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzAndreas-Salome, Lou@\emph{von Lou Andreas-Salomé}!1895-05-021@{{[}2. 5.? 1895{]}}|)be}\mylabel{L00436h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
