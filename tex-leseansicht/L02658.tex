\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehnteInstitutionen}{Institutionen: An der schönen blauen Donau, Burgtheater, Frankfurter Zeitung}
         \renewcommand{\erwaehnteOrte}{Orte: Berlin, Wien}
         \renewcommand{\erwaehnteWerke}{Werke: ?? [Rezension des Gastspiels von Anna Hochenburger, 7.1.1891], Romeo und Julia}
