...
\newline{}Versand: Stempel: »\nobreak{}\oindex{Steindorf am Ossiacher See@\textbf{Steindorf am Ossiacher See}, \emph{A.ADM3}|pwk}Stein\textcolor{gray}{dorf} am
...
\pstart
           \noindent{}{\pb}Sie entſchuldigen, lieber Richard aber es gibt überhaupt keine andern. Ich wollte
               ...
               ſchön wäre, we{\geminationn}{ }Sie zwiſchen 23. u 26. in
                  Salzburg\oindex{Salzburg@\textbf{Salzburg}, \emph{A.ADM2}|pw}{ }ſein könnten. – Nachrichten erwarte ich in \textsc{Bad Gastein, Villa Wassing}\oindex{Villa Dr. Wassing@\textbf{Villa Dr. Wassing}, \emph{Sanatorium (K.SAN)}|pw}.\pend
           \pstart Ihr \spacefill\mbox{Arth}\pend{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Beer-Hofmann, Richard@\textsc{Beer-Hofmann, Richard}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1898-07-181@{18. 7. 1898}|)be}\mylabel{L00822h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
