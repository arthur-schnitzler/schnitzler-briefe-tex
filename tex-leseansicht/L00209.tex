\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Johann Schnitzler, Bertha von Suttner}
         \newcommand{\erwaehnteOrte}{Orte: Eggenburg, Harmannsdorf, Schloss Harmannsdorf, Wien}
