\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Gertrude von Hofmannsthal}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Westbahnstrecke}
         \newcommand{\erwaehnteOrte}{Orte: Heiligenkreuz, Niederösterreich, Pressbaum, Rodaun, Sulz im Wienerwald, Tullnerbach, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Pompilia oder das Leben}
