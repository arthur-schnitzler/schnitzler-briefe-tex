\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehnteWerke}{Werke: Der Rosenkavalier, Der junge Medardus. Dramatische Historie in einem Vorspiel und fünf Aufzügen}
               \section[Arthur Schnitzler an Hugo von Hofmannsthal, 10. 11. 1910]{ Arthur Schnitzler an Hugo von Hofmannsthal, 10. 11. 1910}\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]} \Standort{FDH, Hs-30885,141.}
