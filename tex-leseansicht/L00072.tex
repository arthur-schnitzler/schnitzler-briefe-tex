\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Arnold Bauer, Ludwig Fulda, Eduard Michael Kafka, Rudolf Lothar, Maurice Maeterlinck, Ilka Pálmay, Sigmund Schlesinger}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Wiener Literatur-Zeitung}
         \newcommand{\erwaehnteOrte}{Orte: Wien}
         \newcommand{\erwaehnteWerke}{Werke: Derby, Die Sklavin. Schauspiel in vier Aufzügen, Grisélidis. Oper in drei Akten und einem Prolog}
