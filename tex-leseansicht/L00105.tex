\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Richard Beer-Hofmann, Johann Wolfgang von Goethe, Friedrich Hebbel, Hugo August von Hofmannsthal, Felix Salten, Johann Schnitzler}
         \newcommand{\erwaehnteInstitutionen}{}
         \newcommand{\erwaehnteOrte}{Orte: Bad Fusch, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Anatol, Ascanio und Gioconda, Das Kind, Familie, Romeo und Julia, Urworte. Orphisch}
