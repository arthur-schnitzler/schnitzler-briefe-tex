...
\toendnotes[C]{\smallbreak\pagebreak[2]}\Standort{DLA, A:Schnitzler, HS.NZ85.1.4230,20.}
...
\physDesc{Brief, maschinenschriftliche Abschrift1 Blatt, 1 Seite, 2889 Zeichen
\newline{}Schreibmaschine}\toendnotes[C]{\smallbreak}
\pstart
           \raggedleft{}{\pb}Wien\oindex{Wien@\textbf{Wien}, \emph{A.ADM2}|pw}, am 23. August 1917\pend
           
\pstart{}Hochverehrter Herr Doktor!\pend\vspace{0.5em}
\pstart
           Ich habe heute früh zu meiner freudigen Überraſchung Ihren \textsc{D\textsuperscript{r}{ }Gräsler}\pwindex{Doktor Graesler, Badearzt@\emph{Doktor Gräsler, Badearzt}|pw} zugeſtellt erhalten und beeile mich, Ihnen, obwohl ich nur erſt wenige Seiten
...
\pstart
           Ich wollte in den nächſten Tagen bei Ihnen anfragen, ob Ihnen ein Beſuch angelegen
               ...
               ſollte nämlich eine lange Komödie\pwindex{Ende des Judas@\emph{Das Ende des Judas}|pwv} – wenn man’s ſo \strikeout{d} nennen darf – im
...
\pstart
           Über meine jetzige amtliche Tätigkeit läßt der \damage{Gerich}tsſaalberichterſtatter manchmal etwas \damage{ve}rlauten: ich kämpfe tagaus tagein mit der Preistreiberei, von Arbeit
               ...
               der Don Quixoterie\pwindex{Don Quijote@\emph{Don Quijote}|pwv}, \strikeout{aber} (denn es handelt ſich weder um Windmühlen noch um
...
\pstart
           ...
           \leftskip=0em{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzAdam, Robert@\emph{von Robert Adam}!1917-08-231@{23. 8. 1917}|)be}\mylabel{L02268h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
