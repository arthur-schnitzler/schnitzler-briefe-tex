\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Gerhart Hauptmann, Hans Bernhard Schlesinger, Olga Schnitzler, Christiane von Thun-Hohenstein-Salm-Reifferscheidt}
         \newcommand{\erwaehnteOrte}{Orte: Burgtheater, Rodaun, Venedig, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Das gerettete Venedig. Trauerspiel in fünf Aufzügen, Der arme Heinrich – Eine deutsche Sage}
