...
\newline{}Schnitzler: 1) mit Bleistift datiert: »25/8 16« und beschriftet: »\textsc{Aussee\oindex{Bad Aussee@\textbf{Bad Aussee}, \emph{P.PPLA3}|pw}}« und »Hugo«  2) mit rotem Buntstift eine Unterstreichung
...
\pstart
           ich will Sie nicht bedrängen u. beläſtigen aber ich fühle wie woltätig mir – ſo oder
               ſo – die Möglichkeit Ihnen dieſe problematiſchen Fragmente\pwindex{Sohn des Geisterkoenigs@\emph{Der Sohn des Geisterkönigs}|pwv} vorzuleſen ſein wird. Ich werde dieſe vielleicht
...
\pstart
           ...
           \pstart Herzlich Ihr\spacefill\mbox{Hugo.}\pend{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Hugo von@\emph{von Hugo von Hofmannsthal}!1916-08-251@{{[}25. 8. 1916{]}}|)be}\mylabel{L02240h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
