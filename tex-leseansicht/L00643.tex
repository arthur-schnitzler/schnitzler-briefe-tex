\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Otto Brahm, Georg Brandes}
         \newcommand{\erwaehnteOrte}{Orte: Kopenhagen, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Anatol, Der Weg ins Freie. Roman, Freiwild. Schauspiel in 3 Akten, Reigen. Zehn Dialoge, William Shakespeare}
