\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Felix Hollaender}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: S. Fischer Verlag}
         \newcommand{\erwaehnteOrte}{Orte: Wien, Österreich}
         \newcommand{\erwaehnteWerke}{Werke: Die Räuber, Dora, Freie Bühne für den Entwickelungskampf der Zeit, Von Hermann Bahr und seiner Bücherei}
