...
\pstart
           \textcolor{gray}{\textbf{BERLIN\oindex{Berlin@\textbf{Berlin}|pw}}}\hfill \textcolor{gray}{\textbf{WIEN\oindex{Wien@\textbf{Wien}|pw}}}\pend
           \vspace{0.5em}
\pstart
           Frau Hofrätin Bertha Zuckerkandl\pend
           \pstart in herzlicher Verehrung \spacefill\mbox{ArthurSchnitzler}\pend{}
\pstart
           Wien\oindex{Wien@\textbf{Wien}|pw}, \label{K_L03990-1v}\edtext{Januar 1919}{\lemma{\textnormal{\emph{Januar 1919}}}\Cendnote{\textnormal{Weil Papiermangel herrschte, betreute in den Monaten nach
                     der Erstausgabe die Wiener\oindex{Wien@\textbf{Wien}|pwk} Filiale des \emph{S.-Fischer-Verlags}\orgindex{S. Fischer Verlag – Filiale Wien@S. Fischer Verlag – Filiale Wien|pwk} die weiteren
