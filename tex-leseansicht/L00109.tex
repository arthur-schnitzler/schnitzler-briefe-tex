\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Oskar Blumenthal, Hugo von Hofmannsthal, Emanuel Reicher}
         \newcommand{\erwaehnteOrte}{Orte: Wien}
         \newcommand{\erwaehnteWerke}{Werke: Ascanio und Gioconda, Einleitung, Liebelei. Schauspiel in drei Akten, Mein Freund Ypsilon, Sterben. Novelle}
