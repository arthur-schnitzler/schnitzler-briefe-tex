\input{../tex-inputs/latex-leseansicht-vorspann}
           ...
           \leftskip=0em{}          \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Hugo von@\emph{von Hugo von Hofmannsthal}!1928-07-311@{31. 7. 1928}|)be}\mylabel{h}\end{ledgroupsized}  \newcommand{\dateiname}{L02505}\newcommand{\titel}{Hugo Hofmannsthal an Arthur Schnitzler, 31. 7. 1928}\newcommand{\editorInnen}{Martin Anton Müller und Gerd-Hermann Susen}\input{../tex-inputs/latex-leseansicht-abspann}
