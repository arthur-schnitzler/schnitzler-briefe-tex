\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Johann Wolfgang von Goethe, Friedrich Maximilian von Klinger, Friedrich von Schiller, William Shakespeare}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Manz’sche Verlags- und Universitätsbuchhandlung}
         \newcommand{\erwaehnteOrte}{Orte: Bad Fusch, Bad Ischl, Karlsbad, Kohlmarkt}
         \newcommand{\erwaehnteWerke}{Werke: Anatol, Briefwechsel zwischen Schiller und Goethe, Gestern. Dramatische Studie in einem Akt in Versen}
