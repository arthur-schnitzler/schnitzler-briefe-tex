\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hugo von Hofmannsthal, Gertrude von Hofmannsthal, Olga Schnitzler, Christiane von Thun-Hohenstein-Salm-Reifferscheidt}
         \newcommand{\erwaehnteInstitutionen}{}
         \newcommand{\erwaehnteOrte}{Orte: Edmund-Weiß-Gasse, Hotel Radetzky, Wien}
         \newcommand{\erwaehnteWerke}{
               \section[Arthur Schnitzler an Gerty von Hofmannsthal, 26. 5. 1907]{ Arthur Schnitzler an Gerty von Hofmannsthal, 26. 5. 1907}\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]} \Standort{FDH, Hs-30997,127.}
\physDesc{Briefkarte
