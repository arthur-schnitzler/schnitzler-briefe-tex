...
\newline{}Handschrift: Bleistift (\noindent{}Unterschrift)\newline{}Ordnung: mit Bleistift von unbekannter Hand Nummerierungen angebracht:
           ...
           \pstart Herzlichchst Ihr\spacefill\mbox{{[}hs.:{]} Hugo}\pend{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Hugo von@\emph{von Hugo von Hofmannsthal}!1907-04-291@{29. 4. 1907}|)be}\mylabel{h}\end{ledgroupsized}  \newcommand{\dateiname}{L01672}\newcommand{\titel}{Hugo von Hofmannsthal an Arthur Schnitzler, 29. 4. 1907}\newcommand{\editorInnen}{Martin Anton Müller und Gerd-Hermann Susen}\input{../tex-inputs/latex-leseansicht-abspann}
