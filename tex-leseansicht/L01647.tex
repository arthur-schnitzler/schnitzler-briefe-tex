...
\pstart
           erhalten anbei ein Exemplar meiner »Verwandlungen der
                  Venus\pwindex{Verwandlungen der Venus@\emph{Die Verwandlungen der Venus}|pw}« im \uline{vollständigen} Wortlaut. Ich sende
...
\pstart
           ...
           \leftskip=0em{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzDehmel, Richard@\emph{von Richard Dehmel}!1907-01-012@{{[}1907{]}}|)be}\mylabel{L01647h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
