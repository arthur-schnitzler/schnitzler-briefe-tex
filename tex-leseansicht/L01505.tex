\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehnteOrte}{Orte: Ajaccio, Maison Bonaparte, Ober Sankt Veit, Veitlissengasse, Wien, XIII., Hietzing, Österreich}
         \renewcommand{\erwaehnteWerke}{}
               \section[Arthur Schnitzler an Hermann Bahr, 7. 3. 1905]{ Arthur Schnitzler an Hermann Bahr, 7. 3. 1905}\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]} \Standort{TMW, HS AM 60178 Ba.}
...
\newline{}Ordnung: Lochung }\buchAbdrucke{\weitereDrucke{1) \emph{7. 3. 1905, Abschrift.} In: Arthur Schnitzler: \emph{The Letters of Arthur Schnitzler to Hermann Bahr}. Edited, annotated, and with an introduction, by Donald G.
           ...
           \noindent{}\centering{}\textcolor{gray}{\textbf{{\pb}Ajaccio\oindex{Ajaccio@\textbf{Ajaccio}|pw} – Salon Napoléon\oindex{Maison Bonaparte@\textbf{Maison Bonaparte}|pw} avec Piano.}}\pend
           \pstart
           7. 3. 905\pend
           \pstart
           \label{T_L01505_1v}\edtext{Sei herzlich gegrüßt!}{\lemma{\textnormal{\emph{Sei herzlich gegrüßt!}}}\Cendnote{\textnormal{Grußformel und Unterschrift quer am rechten
                  Rand}}}\label{T_L01505_1h}\pend
           \pstart
