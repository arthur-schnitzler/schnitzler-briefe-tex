\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Lucie Höflich, Olga Schnitzler, Agnes Sorma}
         \renewcommand{\erwaehnteOrte}{Orte: Wien}
         \renewcommand{\erwaehnteWerke}{Werke: Sanna. Schauspiel in fünf Aufzügen}
               \section[Arthur Schnitzler an Hermann Bahr, 6. 6. 1905]{ Arthur Schnitzler an Hermann Bahr, 6. 6. 1905}\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]} \Standort{TMW, HS AM 23374 Ba.}
