...
\pstart
           Ich werde bei Leopold\oindex{Hotel und Pension Rudolfshoehe (Leopold Petter)@\textbf{Hotel und Pension Rudolfshöhe (Leopold Petter)}, \emph{Hotel (K.HTL)}|pw} wohnen u. täglich{ }ſtundenlang Bicycle fahren – was ein {\pb}wirkliches
...
\pstart
           ...
           \pstart Herzlich der Ihre \spacefill\mbox{Arth}\pend{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Beer-Hofmann, Richard@\textsc{Beer-Hofmann, Richard}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1893-06-301@{30. 6. 1893}|)be}\mylabel{L00228h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
