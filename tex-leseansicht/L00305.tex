\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Henri Albert, Richard Beer-Hofmann, Paul Goldmann, Hugo von Hofmannsthal, Carl Karlweis}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Nouvelle Revue}
         \newcommand{\erwaehnteOrte}{Orte: Arsenal, Café Central, Wien, rue Jacob, rue Richelieu}
         \newcommand{\erwaehnteWerke}{Werke: Der Thor und der Tod, Der Tod des Tizian, Le nouvel almanach de M. Bierbaum, Mercure de France, Moderner Musen-Almanach auf das Jahr 1894. Ein Jahrbuch deutscher Kunst}
