...
\newline{}Handschrift: roter Buntstift, deutsche Kurrent (\noindent{}Korrektur eines Satzzeichens, eine Unterstreichung)}\toendnotes[C]{\smallbreak}\pstart
           ...
           Ihre freundliche Einladun\textcolor{gray}{g} an einem Abend vor Mitgliedern der freien Volksbühne\orgindex{Wiener Freie Volksbuehne@Wiener Freie Volksbühne|pw} zu lesen nehme ich gern an. Nur
               ...
               einen Abend allein bestreiten kann, wenigstens einen, der länger \label{T_L01712-1v}\edtext{währte}{\lemma{\textnormal{\emph{währte}}}\Cendnote{\textnormal{geschrieben: »wehrte«}}}\label{T_L01712-1h}, als eine Stunde.
