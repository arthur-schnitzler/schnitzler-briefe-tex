...
\pstart
           nicht wahr, Sie ko{\geminationm}en morgen \label{K_L00272-1v}\edtext{Sonntag}{\lemma{\textnormal{\emph{Sonntag}}}\Cendnote{\textnormal{Sofern es zu dem Treffen kam, dürfte das
                  ...
                  Sonntage im Trauerjahr nach dem Tod des Vaters\pwindex{Schnitzler, Johann 10.04.1835 – 02.05.1893@\textsc{Schnitzler, Johann} (10.04.1835 – 02.05.1893), \emph{Laryngologe/Laryngologin}|pwkv} schließen einen Kaffeehausbesuch am Samstag aus,
                  während es an diesem Tag nach dem Besuch der Aufführung von \emph{Eine Palastrevolution}\pwindex{Eine Palastrevolution@\emph{Eine Palastrevolution}|pwk} möglich scheint. Alternativ wäre noch
...
\pstart
           ...
           \leftskip=0em{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Beer-Hofmann, Richard@\textsc{Beer-Hofmann, Richard}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1893-10-141@{{[}14. 10. 1893?{]}}|)be}\mylabel{L00272h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
