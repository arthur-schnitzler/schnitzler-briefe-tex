\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Lisa Clarus, Willi Handl, Henrik Ibsen, Margarethe Kainz, Felix Salten, Olga Schnitzler,  W. Fred}
         \newcommand{\erwaehnteOrte}{Orte: Ober Sankt Veit, Semmering, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Brief an Arthur Schnitzler, Die gelbe Nachtigall, Grotesken. Der Klub der Erlöser (Schauspiel in einem Akt) – Der  Faun – Die tiefe Natur (Ein Akt), Hedda Gabler}
