\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehntePersonen}{Personen: Max Eugen Burckhard, Gerhart Hauptmann, Franz Stelzhamer}
         \renewcommand{\erwaehnteInstitutionen}{Institutionen: Wiener Verlag}
         \renewcommand{\erwaehnteOrte}{Orte: Leipzig, Wien}
         \renewcommand{\erwaehnteWerke}{Werke: Börsenblatt für den Deutschen Buchhandel, Charakterbilder aus Oberösterreich}
               \section[Max Burckhard: Widmungsexemplar Franz Stelzhamer Charakterbilder für Arthur Schnitzler, 27. 10. 1905]{ Max Burckhard: Widmungsexemplar Franz Stelzhamer Charakterbilder für
