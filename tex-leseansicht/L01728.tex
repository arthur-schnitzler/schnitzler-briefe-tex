...
\physDesc{maschinelle Abschrift}\toendnotes[C]{\smallbreak}\pstart
           ...
           Mit vielen Empfehlungen{\\[\baselineskip]}Ihr stets ergebener{\\[\baselineskip]}\spacefill\mbox{Max
                        Mell}\pend
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzMell, Max@\emph{von Max Mell}!1907-11-041@{4. 11. 1907}|)be}\mylabel{h}\end{ledgroupsized}  \newcommand{\dateiname}{L01728}\newcommand{\titel}{Max Mell an Arthur Schnitzler, 4. 11. 1907}\newcommand{\editorInnen}{Martin Anton Müller und Gerd-Hermann Susen}
            \footnotesize
