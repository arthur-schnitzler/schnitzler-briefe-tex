\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Clementine Goldmann, Vally Rosengart}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Heilsarmee}
         \newcommand{\erwaehnteOrte}{Orte: Belgien, Brüssel, Bösendorferstraße, Lüttich, Wien, Österreich}
...
\newline{}Schnitzler: mit Bleistift das Datum »11/ 5. 91« vermerkt }\toendnotes[C]{\smallbreak}\pstart{}{\pb}\begin{otherlanguage}{french}Autriche\end{otherlanguage}\oindex{Oesterreich@\textbf{Österreich}|pw}! \pend{}\pstart{}\begin{otherlanguage}{french}\textcolor{gray}{\textbf{M}}onsieur le docteur\end{otherlanguage} Arthur
                  Schnitzler\pend{}\pstart{}\begin{otherlanguage}{french}Vienne\end{otherlanguage}\oindex{Wien@\textbf{Wien}|pw}\pend{}\pstart{}I. Giselastraße 11.\oindex{Boesendorferstrasse@\textbf{Bösendorferstraße}|pw}\pend{}{\bigskip}\pstart
