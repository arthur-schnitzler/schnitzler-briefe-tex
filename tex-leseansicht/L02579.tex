\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Arthur Kaufmann, Olga Schnitzler,  Tizian, Isabella Vengerova}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Accademia di belle arti di Venezia}
         \newcommand{\erwaehnteOrte}{Orte: Bozen, Edmund-Weiß-Gasse, Grand Hotel des Bains, Lido, Rodaun, Venedig, Wien, Österreich}
         \newcommand{\erwaehnteWerke}{Werke: Der Ruf des Lebens. Schauspiel in drei Akten, La presentazione della Vergine al Tempio, Zwischenspiel. Komödie in drei Akten}
