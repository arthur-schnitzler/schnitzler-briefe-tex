...
\newline{}Schnitzler: mit Bleistift datiert: »8. 3« \newline{}Ordnung: mit Bleistift von unbekannter Hand nummeriert:
           ...
           \pstart Herzlichſt\hspace*{1.5em}Dein\spacefill\mbox{H.}\pend{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzBahr, Hermann@\emph{von Hermann Bahr}!1904-03-051@{{[}5.{]} 3. 1904}|)be}\mylabel{h}\end{ledgroupsized}  \newcommand{\dateiname}{L01377}\newcommand{\titel}{Hermann Bahr an Arthur Schnitzler, [5.] 3. 1904}\newcommand{\editorInnen}{ Kurt Ifkovits,  Martin Anton Müller}\input{../tex-inputs/latex-leseansicht-abspann}
