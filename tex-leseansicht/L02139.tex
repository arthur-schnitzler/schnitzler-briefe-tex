\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Alfred Kerr, Olga Schnitzler}
         \newcommand{\erwaehnteOrte}{Orte: Bad Tölz, Thomas Mann Villa, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Der Tod in Venedig, Frau Beate und ihr Sohn. Novelle, Tagebuch}
