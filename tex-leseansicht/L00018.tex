\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Wilhelm Bölsche, Eduard Michael Kafka}
         \newcommand{\erwaehnteInstitutionen}{}
         \newcommand{\erwaehnteOrte}{Orte: Brünn, Hotel Neuhauser, Mähren, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Aus der Kaffeehausecke}
