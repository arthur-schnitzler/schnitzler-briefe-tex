\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Alice Barbi, Hugo Knepler, Georg von Seybel}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Gutmann (Konzertdirektion)}
         \newcommand{\erwaehnteOrte}{Orte: Bösendorfer-Saal, Lichtenauergasse, Oper, Schellinggasse, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Abschiedskonzerte im Bösendorfer-Saale, Neues Wiener Tagblatt, [Einige der bekanntesten Persönlichkeiten der Wiener Musikwelt]}
