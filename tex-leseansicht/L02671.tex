...
\pstart
           \raggedleft{}Brüſſel\oindex{Bruessel@\textbf{Brüssel}, \emph{P.PPLC}|pw}, 22. November.\pend
           
\pstart\center{}Mein lieber Arthur!\pend\vspace{0.5em}
\pstart
           Im Fluge: vielen, vielen, vielen Dank für den lieben Brief und die heutige Sendung.
               Ich ſchleppe das \label{K_L02671-1v}\edtext{Büchlein\pwindex{Maerchen. Schauspiel in drei Aufzuegen@\emph{Das Märchen. Schauspiel in drei Aufzügen}|pwv}}{\lemma{\textnormal{\emph{Büchlein}}}\Cendnote{\textnormal{Es dürfte sich noch nicht um das
                  Bühnenmanuskript von \emph{Das Märchen}\pwindex{Maerchen. Schauspiel in drei Aufzuegen@\emph{Das Märchen. Schauspiel in drei Aufzügen}|pwk} handeln, das
               ...
               herum, getraue mich aber nicht hineinzublicken, weil \strikeout{h\textcolor{gray}{eut}}{ }heut wieder einmal die Wien\oindex{Wien@\textbf{Wien}, \emph{A.ADM2}|pw}-Wunde offen iſt und mir jede Beſchäftigung mit dem, was mir dort lieb
...
\pstart
           {\pb}Dein nächſtjähriger \label{K_L02671-3v}\edtext{Reiſeplan}{\lemma{\textnormal{\emph{Reiſeplan}}}\Cendnote{\textnormal{Schnitzler kam das nächste Mal erst am 12. 4. 1897 nach Paris\oindex{Paris@\textbf{Paris}, \emph{P.PPLC}|pwk}.}}}\label{K_L02671-3} enthält doch Paris\oindex{Paris@\textbf{Paris}, \emph{P.PPLC}|pw}? Ich
...
\pstart
           ...
           \selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1891-11-221@{22. 11. {[}1891{]}}|)be}\mylabel{L02671h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
