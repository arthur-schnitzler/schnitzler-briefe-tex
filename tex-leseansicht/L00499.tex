\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Jakob Julius David, Carl Anton Dreher, Karl Friedrich Henckell, Robert Hirschfeld, Hugo von Hofmannsthal, John Henry Mackay,  Meichl, Heinrich Osten, Julius Ott, Anna Elisabetha Ott, Edmund Wengraf}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Die Presse}
         \newcommand{\erwaehnteOrte}{Orte: Amerika, Deutschland, Schifflände, Schwechat, Schweiz, Wien, Zürich}
         \newcommand{\erwaehnteWerke}{Werke: Albert Schnell’s Untergang. Eine Geschichte ohne Handlung, Die Presse, Die Volkslieder der Bulgaren, Ein Regentag. Charakterbild, Liebelei. Schauspiel in drei Akten}
