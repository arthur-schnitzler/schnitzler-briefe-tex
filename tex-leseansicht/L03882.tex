...
\pstart
           \begin{otherlanguage}{french}\textcolor{gray}{\textbf{R. SANTO\pwindex{Santo, R. @\textsc{Santo, R.}|pw}, DIR.}}\end{otherlanguage}\pend
           
\pstart
           \begin{otherlanguage}{french}\textcolor{gray}{\textbf{\textbf{GENÈVE-CHAMPEL\oindex{Champel@\textbf{Champel}|pw}}}}\end{otherlanguage}\pend
           
\pstart
           \begin{otherlanguage}{french}\textcolor{gray}{\textbf{Adr. Télégr.: Beauséjour, Genève-Champel\oindex{Hôtel Beau-Séjour@\textbf{Hôtel Beau-Séjour}|pw}}}\end{otherlanguage}\pend
           
\pstart
           \begin{otherlanguage}{french}\textcolor{gray}{\textbf{ÉTABLISSEMENT HYDROTHÉRAPIQUE}}\end{otherlanguage}\pend
           
\pstart
           \begin{otherlanguage}{french}\textcolor{gray}{\textbf{»CHAMPEL-LES-BAINS\oindex{Champel@\textbf{Champel}|pw}«}}\end{otherlanguage}\pend
