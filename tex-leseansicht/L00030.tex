\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehnteOrte}{Orte: Bad Ischl, Hotel und Pension Rudolfshöhe (Leopold Petter), Strobl, Wien}
         \newcommand{\erwaehnteWerke}{
               \section[Arthur Schnitzler an Hugo von Hofmannsthal, {[}11. 8. 1891{]}]{ Arthur Schnitzler an Hugo von Hofmannsthal, {[}11. 8. 1891{]}}\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering \toendnotes[C]{\smallbreak\pagebreak[2]} \Standort{FDH, Hs-30885,14.}
\physDesc{Briefkarte
