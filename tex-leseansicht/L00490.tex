\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Gaspard Vallette}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: Burgtheater, La Semaine Littéraire, Éditions Perrin}
         \newcommand{\erwaehnteOrte}{Orte: Gardone Riviera, IX., Alsergrund, Italien, Lago di Garda, Paris, Riva del Garda, Wien}
         \newcommand{\erwaehnteWerke}{Werke: Mourir. Roman, Sterben. Novelle}
