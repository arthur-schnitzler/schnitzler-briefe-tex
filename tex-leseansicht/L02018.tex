\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehnteOrte}{Orte: Boulevard Raspail, Garmisch-Partenkirchen, Hôtel Lutetia, Menton, Paris, Wettersteingebirge}
...
\newline{}Ordnung: 1) die linke Ecke abgerissen, eine Briefmarke entfernt  2) mit Bleistift von unbekannter Hand nummeriert:
           ...
           \noindent{}\centering{}\textcolor{gray}{\textbf{{\pb}Garmisch\oindex{Garmisch-Partenkirchen@\textbf{Garmisch-Partenkirchen}|pw} geg. Wetterstein\oindex{Wettersteingebirge@\textbf{Wettersteingebirge}|pw}}}\pend
           \pstart
