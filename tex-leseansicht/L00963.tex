\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Richard Beer-Hofmann, Isidor Singer}
         \newcommand{\erwaehnteOrte}{Orte: Bad Ischl, Kaltenbach, Seeboden, Villa Platzer}
         \newcommand{\erwaehnteWerke}{Werke: Der Tod Georgs. Fragment}
