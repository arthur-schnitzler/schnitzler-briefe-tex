...
\newline{}Schreibmaschine}\toendnotes[C]{\smallbreak}\pstart
           ...
           \pstart \spacefill\mbox{D\textsuperscript{r}RAdam}\pend{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzAdam, Robert@\emph{von Robert Adam}!1920-02-131@{13. 2. 1920}|)be}\mylabel{h}\end{ledgroupsized}  \newcommand{\dateiname}{L02335}\newcommand{\titel}{Robert Adam an Arthur Schnitzler, 13. 2. 1920}\newcommand{\editorInnen}{Martin Anton Müller und Gerd-Hermann Susen}\input{../tex-inputs/latex-leseansicht-abspann}
