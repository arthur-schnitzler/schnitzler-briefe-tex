...
\newline{}Handschrift: schwarze Tinte, lateinische Kurrent}\toendnotes[C]{\smallbreak}\pstart
           ...
           \pstart Ihr\spacefill\mbox{Arthur Schnitzler}\pend{}\endnumbering\briefempfaengerindex{Dehmel, Ida@\textsc{Dehmel, Ida}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1920-02-251@{25. 2. 1920}|)be}\mylabel{h}\end{ledgroupsized}  \newcommand{\dateiname}{L02337}\newcommand{\titel}{Arthur Schnitzler an Ida Dehmel, 25. 2. 1920}\newcommand{\editorInnen}{ Martin Anton Müller und Gerd-Hermann Susen}\input{../tex-inputs/latex-pdf-abspann}
