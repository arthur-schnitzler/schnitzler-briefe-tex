\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehnteWerke}{Werke: ?? [Journalistenstück], Der Schrei der Liebe. Novelle, Die Zeit, Studie, Unser Geburtstag}
               \section[ Arthur Schnitzler an Felix Salten, 28. {[}9.{]} 1903]{ Arthur Schnitzler an Felix Salten, 28. {[}9.{]} 1903}\nopagebreak\mylabel{v}\rehead{ }\begin{ledgroupsized}[t]{13cm}\normalsize\beginnumbering\briefempfaengerindex{Salten, Felix@\textsc{Salten, Felix}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1903-09-281@{28. {[}9.{]} 1903}|(be} \toendnotes[C]{\smallbreak\pagebreak[2]} \Standort{Wienbibliothek im Rathaus, ZPH 1681, 2.1.516.}
...
\newline{}Ordnung: mit Bleistift von unbekannter Hand nummeriert: »21« }\toendnotes[C]{\smallbreak}\pstart
           ...
           lieber, Ihrer freundlichen \label{K_L02982-1v}\edtext{Zuſage}{\lemma{\textnormal{\emph{Zuſage}}}\Cendnote{\textnormal{Siehe Felix Salten an Arthur Schnitzler, 11. 8. 1903.
               }}}\label{K_L02982-1h} vertrauend hatte ich an Frau B.\pwindex{Mewes-Beha, Emilie @\textsc{Mewes-Béha, Emilie}, \emph{Schriftstellerin, Übersetzerin}|pw}
