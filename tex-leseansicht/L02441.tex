...
\newline{}Ordnung: mit Bleistift von unbekannter Hand nummeriert:
                                    »58« }
\buchAbdrucke{\weitereDrucke{Georg Brandes, Arthur Schnitzler: \emph{Ein Briefwechsel}. Bern: \emph{Francke} 1956, S. 146.} }
\pstart
           \raggedleft{}{\pb}Oesterreichischer Hof, Salzburg\oindex{Oesterreichischer Hof@\textbf{Österreichischer Hof}, \emph{Hotel (K.HTL)}|pw}{\\}24/5. 25\pend
...
\pstart
           Mit Ausnahme der ersten Woche hat die Sonne jeden Tag von einem wolkenlosen Himmel
               niedergeschienen, und Salzburg\oindex{Salzburg@\textbf{Salzburg}, \emph{A.ADM2}|pw} hat sich in aller
...
\pstart
           Dr Brandes beauftragt mich Sie {\pb}zu
               ...
               würde sich sehr freuen wenn Sie, wie Sie andeuteten, im Herbst nach Kopenhagen\oindex{Kopenhagen@\textbf{Kopenhagen}, \emph{P.PPLC}|pw} kämen.\pend
...
\pstart
           ...
           \leftskip=0em{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzRung, Gertrud@\emph{von Gertrud Rung}!1925-05-241@{24. 5. 1925}|)be}\mylabel{L02441h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
