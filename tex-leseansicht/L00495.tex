\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehntePersonen}{Personen: Hugo Bettauer, Friedrich Michael Fels}
         \renewcommand{\erwaehnteInstitutionen}{Institutionen: Burgtheater}
         \renewcommand{\erwaehnteOrte}{Orte: Rämistrasse, Wien, Zürich}
...
\newline{}Schnitzler: mit Bleistift nummeriert: »25« }\toendnotes[C]{\smallbreak}\pstart
           ...
           Brief und Karte habe ich erhalten; meinen besten Dank für die Einlage, ich ko{\geminationn}te das Geld wirklich nötig brauchen. Aber nicht wahr?
               ...
               wenden; de{\geminationn} we{\geminationn} ich nicht
                  \introOben{}schleunigst\introOben{} noch etwas beko{\geminationm}e, ka{\geminationn} ich die Kiste nicht ordnen. Adreſse\oindex{Raemistrasse@\textbf{Rämistrasse}|pwv} i{\geminationm}er
               noch: Bettauer\pwindex{Bettauer, Hugo 18.08.1872 – 26.03.1925@\textsc{Bettauer, Hugo} (18.08.1872 – 26.03.1925), \emph{Schriftsteller, Journalist}|pw}.\pend
           \pstart
