...
\pstart
           am liebſten wäre es mir, wenn \introOben{}am Dienstag\introOben{} Jemand von Ihnen
                  \uline{nach} Ihrem Theaterbeſuch mich vom \textsc{Hôtel Royal}\oindex{Hotel Royal@\textbf{Hotel Royal}, \emph{Hotel}|pw} zum Nachtmahl im \textsc{Griensteidl}\oindex{Café Griensteidl@\textbf{Café Griensteidl}, \emph{Kaffeehaus}|pw} abholen könnte. Aber ich habe keine Ahnung ob das ein großer Umweg für Sie
               wäre, in dem Fall wage ich mich auch allein in’s \textsc{Griensteidl}\oindex{Café Griensteidl@\textbf{Café Griensteidl}, \emph{Kaffeehaus}|pw}, \strikeout{f} wenn Sie mich wiſſen laſſen wollen um welche
