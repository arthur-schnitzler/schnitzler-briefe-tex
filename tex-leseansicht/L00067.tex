\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Bahr, Marie Herzfeld, Maurice Maeterlinck}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: E. Pierson’s Verlag}
         \newcommand{\erwaehnteOrte}{Orte: Wien}
         \newcommand{\erwaehnteWerke}{Werke: Der Garten der Bérenice, Die Blinden, Die sieben Prinzessinnen, Die Überwindung des Naturalismus, Magazin für die Literatur des Auslandes, Maurice Maeterlinck}
