\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Hermann Beer, Paula Beer-Hofmann, Ludwig Engelhardt, Paul Goldmann, Hugo von Hofmannsthal, Oskar Mayer, Hermine von Schaffgotsch}
         \newcommand{\erwaehnteOrte}{Orte: Altaussee, Bad Fusch, Bad Ischl, Innsbruck, Levico Terme, Marienbad, Reichenau an der Rax}
