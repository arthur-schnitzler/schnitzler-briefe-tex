...
\physDesc{handschriftliche Abschrift2 Blätter, 2 Seiten, 2318 Zeichen
...
\physDesc{maschinenschriftliche Abschrift2 Blätter, 2 Seiten, 2318 Zeichen
\newline{}Schreibmaschine}\toendnotes[C]{\smallbreak}
\pstart
           \raggedleft{}{\pb}Wien\oindex{Wien@\textbf{Wien}, \emph{A.ADM2}|pw}, am 1. November{\\}1920\pend
...
\pstart
           Ich werde in den nächſten Tagen im Ausſchuß der Richtervereinigung\orgindex{Vereinigung der oesterreichischen Richterinnen und Richter@Vereinigung der österreichischen Richterinnen und Richter|pw} anregen, daß unter die anläßlich der Beſoldungsreform von
               ...
               ziemlich ſicher, mit meiner Anregung durchzudringen: \label{K_L02357-1v}\edtext{ob aber die Streichung ſo bald erfolgen wird}{\lemma{\textnormal{\emph{ob … wird}}}\Cendnote{\textnormal{§ 578 der Zivilprozessordnung vom 1. 1. 1898 blieb bis zum 30. 6. 2006 in Kraft.}}}\label{K_L02357-1}, daß für den VereinXXXX ORGangabe fehlt meine Perſon noch in Betracht kommen
...
\pstart
           ...
           \leftskip=0em{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzAdam, Robert@\emph{von Robert Adam}!1@{1. – 3. 11. 1920}|)be}\mylabel{L02357h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
