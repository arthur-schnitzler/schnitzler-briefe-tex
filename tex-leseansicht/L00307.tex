\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \renewcommand{\erwaehntePersonen}{Personen: Oskar Blumenthal, Gerhard Wiese}
         \renewcommand{\erwaehnteInstitutionen}{Institutionen: Lessing-Theater}
         \renewcommand{\erwaehnteOrte}{Orte: Berlin, Kapelle-Ufer, Moskau, Wien}
         \renewcommand{\erwaehnteWerke}{Werke: Der Eisenfresser, Niobe}
