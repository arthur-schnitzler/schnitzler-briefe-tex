...
\pstart
           \raggedleft{}{\pb}Bernried/Starnbergerseee\oindex{Bernried@\textbf{Bernried}, \emph{P.PPLA4}|pw}\pend
           
\pstart
           \raggedleft{}Oberbayern\oindex{Oberbayern@\textbf{Oberbayern}, \emph{A.ADM2}|pw}\pend
           
\pstart
           \raggedleft{}Altwirt\oindex{Hotel Seeblick@\textbf{Hotel Seeblick}, \emph{Hotel (K.HTL)}|pw}\pend
...
\pstart
           Dieser Ort iſt so lieb, ſtill und schön, daſs ich Ihnen von da einen Gruß schicken
               ...
               wollte: »Sö san do ka Ausländer, sö reden do wie mir; a Saupreuß\oindex{Deutschland@\textbf{Deutschland}, \emph{A.PCLI}|pw}, \uline{des} is a
               Ausländer!!«\pend
           
\pstart
           Und als ich diesmal sagte, ich käme jetzt selten ins Reich\oindex{Deutschland@\textbf{Deutschland}, \emph{A.PCLI}|pw}, meinte er: »Ja ja, ich ko{\geminationm} auch selten
               hin!« – – Und das alles gibts \uline{wirklich} und es ist
               nicht von Ludwig Thoma\pwindex{Thoma, Ludwig 21.01.1867 – 26.08.1921@\textsc{Thoma, Ludwig} (21.01.1867 – 26.08.1921), \emph{Schriftsteller/Schriftstellerin}|pw} und es iſt eine Stunde
               von München\oindex{Muenchen@\textbf{München}, \emph{P.PPLA}|pw}, wo {\pb}es so
...
\pstart
           ...
           \leftskip=0em{}\selectlanguage{ngerman}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzRie, Therese@\emph{von Therese Rie}!1923-07-011@{{[}Anfang Juli 1923{]}}|)be}\mylabel{L02573h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
