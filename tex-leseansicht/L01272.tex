\input{../tex-inputs/latex-leseansicht-vorspann}
         ...
         \newcommand{\erwaehntePersonen}{Personen: Otto Brahm, Julius Schnitzler, Siegfried Trebitsch}
         \newcommand{\erwaehnteInstitutionen}{Institutionen: S. Fischer Verlag}
         \newcommand{\erwaehnteOrte}{Orte: Berlin, Palasthotel Berlin, Wien, XIII., Hietzing}
         \newcommand{\erwaehnteWerke}{Werke: Genesung. Roman}
