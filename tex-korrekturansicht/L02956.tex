...
\pstart
           es wäre mir ſehr angenehm, Sie beim \textcolor{pink}{Schneider}{}\ledrightnote{\textcolor{pink}{Café Schneider}}{ }heut{ }Abend zu ſehen (ich habe einen \label{K_L02956-2v}\edtext{Sitz ins \textcolor{pink}{Theater}{}\ledrightnote{{$\rightarrow$}\textcolor{pink}{Internationales Ausstellungstheater im k.k. Prater}}}{\lemma{\textnormal{\emph{Sitz ins Theater}}}\Cendnote{\textnormal{siehe A. S.: \emph{Tagebuch}, 21. 5. 1892}}}\label{K_L02956-2h}.)\pend
           
\pstart
           – Ich werde wahrſcheinlich \uline{morgen}{ }Nachmttg frei ſein.\pend
           
\pstart
           {\pb}– Eben den \label{K_L02956-3v}\edtext{\textcolor{green}{Artikel}{}\ledrightnote{{$\rightarrow$}\textcolor{green}{Theater-Briefe. Wien}}}{\lemma{\textnormal{\emph{Artikel}}}\Cendnote{\textnormal{\textcolor{blue}{Hermann Bahr}: \emph{\textcolor{green}{Theater-Briefe. Wien}}. In: \emph{\textcolor{green}{Allgemeine Theater-Revue für Bühne und Welt}}, Jg. 1,
...
\pstart
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Salten, Felix@\textsc{Salten, Felix}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1892-05-211@{{[}21. 5. 1892?{]}}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
