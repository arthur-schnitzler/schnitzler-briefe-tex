...
\newline{}Schnitzler: mit Bleistift das Jahr »92« vermerkt }\toendnotes[C]{\smallbreak}\pstart
           \raggedleft{}{\pb}\textsc{\textcolor{pink}{Paris}{}\ledrightnote{\textcolor{pink}{Paris}}}, 24. December.\pend
           \pstart
           ...
           \pstart
           Und nun Du. Vielen Dank für die Kritiken. Werth hat nur \label{K_L02704-3v}\edtext{die von Dr. \textsc{\textcolor{blue}{Meyer}{}\ledrightnote{\textcolor{blue}{Friedrich Michael Fels}}}}{\lemma{\textnormal{\emph{die von Dr. Meyer}}}\Cendnote{\textnormal{\textcolor{blue}{f. m.} [=\textcolor{blue}{Friedrich M. Fels}]: \emph{\textcolor{green}{[Mit unſerer
                        öſterreichiſchen Literatur]}}. In: \emph{\textcolor{green}{Berliner Neueste Nachrichten}}, Jg. 12, Nr. 563, 6. 11. 1892, S. [3]. Die »Entschlüsselung« des Kürzels
                  erfolgt einerseits durch \textcolor{blue}{Goldmann} selbst,
                  indem er ihn als »Dr. Meyer« und Freund von \textcolor{blue}{Jakob Julius David} identifiziert. Andererseits weist die
                  ausführlichere – und kritische – Rezension von \emph{\textcolor{green}{Anatol}} durch \textcolor{blue}{Friedrich M. Fels}
                  einige sprachliche Gemeinsamkeiten auf (»graziöse«, »feinsinnige Plaudereien«),
                  die die gleiche Quelle erkennbar machen. (\textcolor{blue}{F. M. F.}: \emph{\textcolor{green}{»Anatol.« Von Arthur Schnitzler}}. In: \emph{\textcolor{green}{Allgemeine Kunst-Chronik}}, Bd. 16, Nr. 24, 2. November-Heft
                        1892, S. 614.)}}}\label{K_L02704-3h}. Es erhöht meinen {\pb}Reſpekt vor dem \textcolor{blue}{Mann}{}\ledrightnote{→\textcolor{blue}{Friedrich Michael Fels}} beträchtlich, daß er einem \textcolor{blue}{Freunde}{}\ledrightnote{→\textcolor{blue}{Jakob Julius David}} ſo derb ſeine \label{K_L02704-4v}\edtext{Meinung}{\lemma{\textnormal{\emph{Meinung}}}\Cendnote{\textnormal{\textcolor{blue}{Fels} kritisierte in seiner kurzen \textcolor{green}{Besprechung} den Stil der
                  Erzählsammlung { }\emph{\textcolor{green}{Probleme}} von \textcolor{blue}{Jakob Julius David} (»Seine Probleme und Charaktere sind einfach,
               ...
               Alle übrigen verſtehen Dich nicht, außer etwa \textsc{\label{K_L02704-5v}\edtext{\textcolor{blue}{Ludassy}{}\ledrightnote{\textcolor{blue}{Julius von Gans-Ludassy}}}{\lemma{\textnormal{\emph{Ludassy}}}\Cendnote{\textnormal{\textcolor{blue}{Julius von Gans-Ludassy}: \emph{\textcolor{green}{Bücher}}. In: \emph{\textcolor{green}{Fremden-Blatt}}, Jg. 46, Nr. 351, 19. 12. 1892, S. XXXX.}}}\label{K_L02704-5h}}. \label{K_L02704-6v}\edtext{\textsc{\textcolor{blue}{Bauer}{}\ledrightnote{\textcolor{blue}{Julius Bauer}}}}{\lemma{\textnormal{\emph{Bauer}}}\Cendnote{\textnormal{[O. V. = \textcolor{blue}{Julius Bauer}?]: \emph{\textcolor{green}{* [Im Verlage von Freund und Jeckel…]}}. In:
                        \emph{\textcolor{green}{Illustrirtes Wiener Extrablatt}}, Jg. 21,
                     Nr. 335, 3. 12. 1892, S. 5.}}}\label{K_L02704-6h}: eine lobende \textcolor{green}{Notiz}{}\ledrightnote{→\textcolor{green}{* [Im Verlage von Freund und Jeckel…]}} mit Rückſicht darauf, daß
               man in dem Hauſe dinirt und ſich die Beziehung zu Deinem \label{K_L02704-7v}\edtext{\textcolor{blue}{Papa-Regierungsrath}{}\ledrightnote{→\textcolor{blue}{Johann Schnitzler}}}{\lemma{\textnormal{\emph{Papa-Regierungsrath}}}\Cendnote{\textnormal{Die \textcolor{green}{Rezension} ist knapp: »Anatol ist ein sentimentaler
                     ...
                     willkommene Gabe sein.« Die Zuschreibung an \textcolor{blue}{Julius Bauer} stützt \textcolor{blue}{Schnitzler}s \emph{\textcolor{green}{Tagebuch}}, das am 19. 12. 1892 vier Rezensenten und vier Publikationsorgane nennt. Die
                  Reihung der beiden Listen dürfte übereinstimmen, zumindest trifft es für die
                  beiden nachweisbaren Rezensionen auf den Plätzen 2 und 3 zu.}}}\label{K_L02704-7h} erhalten will.
                  \label{K_L02704-88v}\edtext{\textsc{\textcolor{blue}{Nossig}{}\ledrightnote{\textcolor{blue}{Alfred Nossig}}}}{\lemma{\textnormal{\emph{Nossig}}}\Cendnote{\textnormal{[O. V. = \textcolor{blue}{Alfred Nossig}? oder \textcolor{blue}{Clemens Sokal}?]: \emph{\textcolor{green}{Vom Lesetische. Österreichische Literatur}}. In: \emph{\textcolor{green}{Neues Wiener Abendblatt}}, Jg. 26, Nr. 351,
                        19. 12. 1892, S. 3–4, hier: S. 3.
                  Darin wird \textcolor{blue}{Arthur Schnitzler} als
                     »Sohn des bekannten \textcolor{blue}{Professors} Dr. \textcolor{blue}{Schnitzler}« eingeführt. Im erwähnten \emph{\textcolor{green}{Tagebuch}}-Eintrag hat die Rezension \textcolor{blue}{Clemens
                     Sokal} geschrieben, hingegen geht \textcolor{blue}{Goldmann} von \textcolor{blue}{Alfred Nossig}
               ...
               Soll alſo inzwiſchen der \label{K_L02704-12v}\edtext{\textcolor{blue}{Andere}{}\ledrightnote{→\textcolor{blue}{Kurt Eisner}{\newline}→\textcolor{blue}{August Stein}}}{\lemma{\textnormal{\emph{Andere}}}\Cendnote{\textnormal{Eventuell ist \textcolor{blue}{August Stein} oder \textcolor{blue}{Kurt
                     Eisner} gemeint?}}}\label{K_L02704-12h} ſchreiben – der \textcolor{pink}{Berlin}{}\ledrightnote{\textcolor{pink}{Berlin}}er – ein ganz braver Menſch, \strikeout{b\textcolor{gray}{o}} bornirt, aber nach der guten Richtung bornirt, d. h. mit einem dummen
               Vorurtheil für das Moderne be{\pb}haftet, was Dir
               zuſtatten kommen wird. Er wird wohl bald \label{K_L02704-13v}\edtext{losſchießen}{\lemma{\textnormal{\emph{losſchießen}}}\Cendnote{\textnormal{Nicht nachgewiesen. Da \textcolor{blue}{Goldmann} eine
                  solche Anfang 1894 (vgl. Paul Goldmann an Arthur Schnitzler, 8. 1. [1894]) ankündigt, ist eine zeitnahe Besprechung
                  unwahrscheinlich.}}}\label{K_L02704-13h}. Und dann kann ich ja immer noch das Wort nehmen, wie es
               ...
               konnte, ohne Dich bloszuſtellen. (»Wenn er mir ſein \textcolor{green}{Buch}{}\ledrightnote{→\textcolor{green}{Anatol}} deshalb geſchickt hat, damit ich darüber ſchreibe \textsc{etc}« {\dotsfour})\pend
           \pstart
           Und nun Dein \textcolor{green}{Stück}{}\ledrightnote{→\textcolor{green}{Das Märchen. Schauspiel in drei Aufzügen}}? Auf wann
               die \label{K_L02704-9v}\edtext{Aufführung}{\lemma{\textnormal{\emph{Aufführung}}}\Cendnote{\textnormal{Erst ein knappes Jahr später, am 1. 12. 1893, kam es zur Uraufführung des \emph{\textcolor{green}{Märchen}}s am \emph{\textcolor{brown}{Deutschen
                     ...
                     \emph{\textcolor{brown}{Burgtheater}} das \emph{\textcolor{green}{Märchen}} ab, wie Schnitzler am 19. 11. 1892 im \emph{\textcolor{green}{Tagebuch}} notierte. Außerdem war eine Aufführung in der
                  zweiten Hälfte des Januars 1893 am \emph{\textcolor{brown}{Neuen Deutschen Theater}} in \textcolor{pink}{Prag} geplant, die jedoch ebenso nicht stattfand Siehe Paul Goldmann an Arthur Schnitzler, 27. 6. [1892] wie Bemühungen um eine Aufführung am
                     \textcolor{pink}{Berlin}er \emph{\textcolor{brown}{Lessing-Theater}} gelingen wollten Siehe A. S.: \emph{Tagebuch}, 18. 3. 1893.}}}\label{K_L02704-9h}? Und das neue \label{K_L02704-77v}\edtext{\textcolor{green}{Stück}{}\ledrightnote{→\textcolor{green}{Liebelei. Schauspiel in drei Akten}}}{\lemma{\textnormal{\emph{Stück}}}\Cendnote{\textnormal{vermutlich \emph{\textcolor{green}{Liebelei}}, das aber erst im Herbst 1893 in die
                  Schreibphase trat}}}\label{K_L02704-77h}? Und Deine Novellen? Und, ſag’ mir nur, warum {\pb}biſt Du ein ſo elender Menſch und ich \label{K_L02704-56v}\edtext{ſchreibſt mir nichts Perſönliches
                  mehr}{\lemma{\textnormal{\emph{ſchreibſt … mehr}}}\Cendnote{\textnormal{Eine mögliche Antwort findet
                  sich in \textcolor{blue}{Schnitzler}s \emph{\textcolor{green}{Tagebuch}} vom 15. 9. 1892: »\textcolor{blue}{Paul Goldmann} zu weit – in Briefen
                     theil’ ich mich nicht gern mit.«}}}\label{K_L02704-56h}? Weißt Du, daß Du mich
           ...
           Ich habe \textcolor{blue}{Jemanden}{}\ledrightnote{→\textcolor{blue}{Heinrich Kanner}} für Euren
               lieben Kreis. {\pb}Das ſympathiſcheſte \textcolor{blue}{Mitglied}{}\ledrightnote{→\textcolor{blue}{Heinrich Kanner}} hat ſich aus unſerer \textcolor{brown}{Redaktion}{}\ledrightnote{→\textcolor{brown}{Frankfurter Zeitung}} losgelöſt, weil es von
               ...
               ſetz’ Dich mit ihm in \label{K_L02704-10v}\edtext{Verbindung}{\lemma{\textnormal{\emph{Verbindung}}}\Cendnote{\textnormal{Es sind keine Briefe zwischen Schnitzler
                  und \textcolor{blue}{Heinrich Kanner}, der außerdem erst am
                     24. 9. 1896 im
                     \emph{\textcolor{green}{Tagebuch}} erwähnt wurde, bekannt.}}}\label{K_L02704-10h}.
           ...
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1892-12-241@{24. 12. {[}1892{]}}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
