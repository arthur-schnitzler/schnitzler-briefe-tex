...
\pstart
           Hoffentlich sind Sie bald wieder ganz \label{K_L03398-1v}\edtext{gesund}{\lemma{\textnormal{\emph{gesund}}}\Cendnote{\textnormal{vgl. Hugo von Hofmannsthal an Arthur Schnitzler, 28. 6. 1904. Ein Besuch \textcolor{blue}{Salten}s bei ihm ist für
                  die darauffolgenden Tage nicht nachweisbar.}}}\label{K_L03398-1h}, ich
...
\pstart
           ...
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzSalten, Felix@\emph{von Felix Salten}!1904-07-022@{2. 7. 1904}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
