...
\pstart
           Die \label{K_L03375-3v}\edtext{»\textcolor{green}{Komödie}{}\ledrightnote{{$\rightarrow$}\textcolor{green}{Fink und Fliederbusch. Komödie in drei Akten}}«}{\lemma{\textnormal{\emph{»Komödie«}}}\Cendnote{\textnormal{\emph{\textcolor{green}{Flink und Fliederbusch}}, vgl. Paul Goldmann an Arthur Schnitzler, 22. 5. [1903]. }}}\label{K_L03375-3h} wird
...
\pstart
           Der \label{K_L03375-4v}\edtext{\textsc{\textcolor{blue}{Goldmann}{}\ledrightnote{\textcolor{blue}{Karl Goldmann}}} von der »\textcolor{green}{Tragödie des Triumphes}{}\ledrightnote{\textcolor{green}{Die Tragödie des Triumphes}}}{\lemma{\textnormal{\emph{Goldmann … Triumphes}}}\Cendnote{\textnormal{\emph{\textcolor{green}{Die
                     Tragödie des Triumphes}} von \textcolor{blue}{Karl
                     Goldmann} wurde am 25. 6. 1903 gemeinsam mit
                  einzelnen Szenen aus \emph{\textcolor{green}{Reigen}} in \textcolor{pink}{München} in einer geschlossenen Aufführung vom
                     \emph{\textcolor{brown}{Akademisch-dramatischen Verein}} gegeben.
                  Unmittelbare Folge der Aufführung von \emph{\textcolor{green}{Reigen}}-Szenen war die Auflösung des seit 1890 bestehenden
                  Vereins.}}}\label{K_L03375-4h}« bin nicht ich. Wie man Deinen »\textcolor{green}{Reigen}{}\ledrightnote{\textcolor{green}{Reigen. Zehn Dialoge}}« aufführen will, – namentlich die \strikeout{\textcolor{gray}{r}}{ }\label{K_L03375-66v}\edtext{Gedankenſtriche}{\lemma{\textnormal{\emph{Gedankenſtriche}}}\Cendnote{\textnormal{Jede der zehn Szenen von \emph{\textcolor{green}{Reigen}} besteht aus
                  der Kommunikation vor und nach dem Geschlechtsverkehr der Dialogpartner. Der
                  Geschlechtsverkehr selbst ist in der gedruckten Ausgabe mit Gedankenstrichen
                  markiert.}}}\label{K_L03375-66h} – darauf bin ich ſehr neugierig. Das \textcolor{green}{Buch}{}\ledrightnote{{$\rightarrow$}\textcolor{green}{Reigen. Zehn Dialoge}} wird auch hier allgemein geleſen und
               erregt großes Entzücken.\pend
...
\pstart
           Vielleicht komme ich Anfang Auguſt nach \textcolor{pink}{Wien}{}\ledrightnote{\textcolor{pink}{Wien}} und fahre mit Dir nach \label{K_L03375-7v}\edtext{\textcolor{pink}{Südtirol}{}\ledrightnote{\textcolor{pink}{Südtirol}}}{\lemma{\textnormal{\emph{Südtirol}}}\Cendnote{\textnormal{\textcolor{blue}{Goldmann} war von 8. 8. 1903 bis 11. 8. 1903 in \textcolor{pink}{Wien} (vgl. Paul Goldmann an Arthur Schnitzler, 7. 8. [1903] und 11. 8. 1903). \textcolor{blue}{Schnitzler} traf er am 9. 8. 1903 und 11. 8. 1903. An diesem Tag reiste \textcolor{blue}{Goldmann} nach \textcolor{pink}{Südtirol} und \textcolor{pink}{Italien}. In Begleitung von \textcolor{blue}{Theodore Rottenberg}, mit der es zur Versöhnung gekommen
                  war (vgl. Paul Goldmann an Arthur Schnitzler, 19. 7. [1903]), trafen er und
                     \textcolor{blue}{Schnitzler} zwischen 18. 8. 1903 und 20. 8. 1903 zuerst in
                     \textcolor{pink}{Riva del Garda}, dann in \textcolor{pink}{Trient}. Am letzten Abend war \textcolor{blue}{Rottenberg} wohl nicht mehr dabei. }}}\label{K_L03375-7h}.\pend
           
\pstart
           Die \label{K_L03375-9v}\edtext{\textsc{\textcolor{blue}{Fulda}{}\ledrightnote{\textcolor{blue}{Ludwig Fulda}{\newline}\textcolor{blue}{Ida d’Albert}}}’ſche Eheſcheidung}{\lemma{\textnormal{\emph{Fulda’ſche Eheſcheidung}}}\Cendnote{\textnormal{siehe Paul Goldmann an Arthur Schnitzler, 15. 6. [1903]}}}\label{K_L03375-9h} geht ihren Gang. \textcolor{blue}{Sie}{}\ledrightnote{{$\rightarrow$}\textcolor{blue}{Ida d’Albert}}
...
\pstart
           Lies: \label{K_L03375-45v}\edtext{»\textcolor{green}{Briefe, die ihn nicht erreichten}{}\ledrightnote{\textcolor{green}{Briefe, die ihn nicht erreichten}}«}{\lemma{\textnormal{\emph{»Briefe, … erreichten«}}}\Cendnote{\textnormal{[\textcolor{blue}{Elisabeth von Heyking}:] \emph{\textcolor{green}{Briefe, die ihn nicht erreichten}}. \textcolor{pink}{Berlin}: \emph{\textcolor{brown}{Gebrüder Paetel}}{ }1903, Vorabdruck in der \emph{\textcolor{green}{Täglichen Rundschau}}{ }1902. Eine Lektüre durch \textcolor{blue}{Schnitzler} ist
                  nicht bekannt. Am 14. 10. 1925 sah er jedoch die gleichnamige \textcolor{green}{Verfilmung} des \textcolor{green}{Briefroman}s von \textcolor{blue}{Friedrich Zelnik}.}}}\label{K_L03375-45h}. Verfaſſerin iſt die Baronin \textsc{\textcolor{blue}{Heyking}{}\ledrightnote{\textcolor{blue}{Elisabeth von Heyking}}}, die Frau des ehemaligen \textcolor{pink}{deutſch}{}\ledrightnote{{$\rightarrow$}\textcolor{pink}{Deutschland}}en \textcolor{blue}{Geſandten}{}\ledrightnote{{$\rightarrow$}\textcolor{blue}{Edmund Friedrich Gustav von Heyking}} in \textcolor{pink}{China}{}\ledrightnote{\textcolor{pink}{China}}.\pend
