...
\newline{}Handschrift: Bleistift, deutsche Kurrent}\buchAbdrucke{\weitereDrucke{1) \emph{24. 2. 1897.} In: Arthur Schnitzler: \emph{The Letters of Arthur Schnitzler to Hermann Bahr}. Edited, annotated, and with an introduction, by Donald G.
           ...
           \noindent{}{\pb}Lieber Hermann, auf regulärem Weg beko{\geminationm} ich an der Kaſſe nichts
               ordentliches mehr fürs \textcolor{green}{Tſchapperl}{}\ledrightnote{\textcolor{green}{Das Tschaperl}}. Ka{\geminationn} ich
           ...
           \endnumbering\briefempfaengerindex{Bahr, Hermann@\textsc{Bahr, Hermann}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1897-02-261@{26. 2. 1897}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
