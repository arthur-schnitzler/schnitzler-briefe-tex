...
\newline{}Schnitzler: mit Bleistift nummeriert: »\strikeout{70}« und umseitig datiert: »19/1\textcolor{gray}{0} 95« \newline{}Ordnung: 1) mit Bleistift von unbekannter Hand nummeriert: »\strikeout{70}« 2) mit Bleistift von unbekannter Hand nummeriert:
           ...
           \noindent{}{\pb}Lieber Arthur! Zwischen 6 und 7 bin ich im
               Caffée \textcolor{pink}{Griensteidl}{}\ledrightnote{\textcolor{pink}{Café Griensteidl}}. Nach dem Nachtmahl kaum. Ich bin
               etwas erkältet und mag nicht so spät ins Freie. Hier auch der {\pb}\textcolor{pink}{Salzburg}{}\ledrightnote{\textcolor{pink}{Salzburg}}er Gürtel. Seither wurde er nicht getragen.
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzBeer-Hofmann, Richard@\emph{von Richard Beer-Hofmann}!1895-10-191@{{[}19. 10.? 1895{]}}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
