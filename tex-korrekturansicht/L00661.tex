...
\newline{}Schnitzler: mit Bleistift datiert: »24/3 97« \newline{}Ordnung: mit Bleistift von unbekannter Hand nummeriert: »5« }\toendnotes[C]{\smallbreak}\pstart{}{\pb}Lieber \textsc{D\textsuperscript{r}} Arthur Schnitzler:\pend\pstart
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzAltenberg, Peter@\emph{von Peter Altenberg}!1897-03-241@{{[}24. 3. 1897{]}}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
