...
\newline{}Schnitzler: 1) mit Bleistift die Antwortskizze (?) »\textcolor{gray}{Woran ſchuld {\dots} daſs einmal
...
\pstart
           Ich hoffe, Du \label{K_L03362-2v}\edtext{kommſt bald}{\lemma{\textnormal{\emph{kommſt bald}}}\Cendnote{\textnormal{siehe Paul Goldmann an Arthur Schnitzler, 27. 1. [1903]}}}\label{K_L03362-2h}. Ich ſehne mich ſchon ſehr danach, mit Dir zu ſprechen. Ich leide {\pb}ganz unbeſchreiblich, weil zu dem Bewußtſein der
               ...
               ich verloren habe. Wie ſoll ich da einen Erſatz finden? In der nüchternen, \label{K_L03362-4v}\edtext{kalten \textcolor{pink}{Stadt}{}\ledrightnote{{$\rightarrow$}\textcolor{pink}{Berlin}}}{\lemma{\textnormal{\emph{kalten Stadt}}}\Cendnote{\textnormal{Siehe dazu auch \textcolor{blue}{Schnitzler}s Kommentar im \emph{\textcolor{green}{Tagebuch}}: »\textcolor{blue}{P. Goldmann} wie
...
\pstart
           Viele treue Grüße, auch an \textcolor{blue}{\textsc{Olga}}{}\ledrightnote{\textcolor{blue}{Olga Schnitzler}}! Dein {\\[\baselineskip]}\spacefill\mbox{Paul Goldmn}\pend
