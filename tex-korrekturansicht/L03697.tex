...
\rehead{ }\normalsize\beginnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzPlessner, Elsa@\emph{von Elsa Plessner}!1897-08-071@{7. 8. {[}1897{]}}|(be}
...
\buchAbdrucke{\weitereDrucke{Hermann Bahr, Arthur Schnitzler: \emph{Briefwechsel, Aufzeichnungen, Dokumente (1891–1931)}. Hg. Kurt Ifkovits und Martin Anton Müller. Göttingen: \emph{Wallstein} 2018, S. 151–152.} }\toendnotes[C]{\smallbreak}
\pstart
...
\pstart
           In ganz unsagbarer Aufregung richte ich diese Zeilen an Sie, über die Sie ja
                    ...
                    der »\label{K_L03697-1v}\edtext{grausamen Fülle}{\lemma{\textnormal{\emph{grausamen Fülle}}}\Cendnote{\textnormal{Im \textcolor{green}{Erstdruck} (\emph{\textcolor{brown}{Die Zeit}}, Bd. 12, Nr. 149, 7. 8. 1897,
                                S. 95–96) lautet der Satz: »Ermattet von dem ziellosen
                                Wünschen und der grausamen Fülle ruhte sie nun unbeweglich mit
                                geschlossenen Augen – wie schlafend.« Für die Erstausgabe
                                    (\emph{\textcolor{green}{Der gläserne Käfig.
                                    Skizzen und Novellen}}. \textcolor{pink}{Wien}, \textcolor{pink}{Leipzig}: \emph{\textcolor{brown}{Leopold Weiss}}{ }1901) wurde er nicht
                            geändert.}}}\label{}«. Aber insbesondere das künstlerisch geradezu
                    unsühnbare Verbrechen, meine Arbeit auf eigene Hand und \uline{ohne mein Wissen} »\label{K_L03697-2v}\edtext{eine Parabel}{\lemma{\textnormal{\emph{eine Parabel}}}\Cendnote{\textnormal{Nicht in der \textcolor{green}{Erstausgabe}.}}}\label{}« zu nennen, wo ich mit {\pb}\uline{wohlerwogener Absicht}
...
\pstart
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzPlessner, Elsa@\emph{von Elsa Plessner}!1897-08-071@{7. 8. {[}1897{]}}|)be}\mylabel{h}
\begin{anhang}
