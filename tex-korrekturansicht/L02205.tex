...
\newline{}Schnitzler: 1) mit Bleistift beschriftet: »\textsc{Hugo}« und eine Jahreszahl ergänzt: »19\textcolor{gray}{1}5« 2) mit rotem Buntstift eine Unterstreichung\newline{}Ordnung: mit Bleistift von unbekannter Hand nummeriert:
           ...
           Wenn es endlich jemand wäre mit dem Sie \strikeout{und} oder
                        \textcolor{blue}{Julius}{}\ledrightnote{\textcolor{blue}{Julius Schnitzler}} in irgendwelcher Beziehung ſind
                    wäre es umſo beſſer, doch iſt dies minder wichtig. Bitte ſprechen Sie allenfalls
                    mit \textcolor{blue}{Julius}{}\ledrightnote{\textcolor{blue}{Julius Schnitzler}} und ſchreiben mir den Namen
                    möglichſt bald expreſs {\pb}nach
                        \textcolor{pink}{Rodaun}{}\ledrightnote{\textcolor{pink}{Rodaun}}.\pend
           \pstart
           \textcolor{blue}{Papa}{}\ledrightnote{\textcolor{blue}{Hugo August von Hofmannsthal}} hat ſich mit Ihrem \label{K_L02205_1v}\edtext{Beſuch}{\lemma{\textnormal{\emph{Beſuch}}}\Cendnote{\textnormal{am 16. 3. 1915; \textcolor{blue}{Schnitzler} wiederholte ihn am
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Hugo von@\emph{von Hugo von Hofmannsthal}!1915-03-311@{31. 3. {[}1915{]}}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
