...
\physDesc{Brief, 3 Blätter, 11 Seiten, 5139 Zeichen
\newline{}Handschrift: lila Tinte, deutsche Kurrent
\newline{}Schnitzler: mit rotem Buntstift siebzehn Unterstreichungen }\toendnotes[C]{\smallbreak}
\pstart
...
\pstart
           Unſere Wege haben ſich vor Jahren getrennt. {\pb}Es
               ...
               zwiſchen uns. Du hatteſt mir vorgeworfen, daß ich über \label{K_L03478-4v}\edtext{\textcolor{green}{eines}{}\ledrightnote{{$\rightarrow$}\textcolor{green}{Der Schleier der Beatrice. Schauspiel in fünf Akten}} Deiner Stücke}{\lemma{\textnormal{\emph{eines Deiner Stücke}}}\Cendnote{\textnormal{In dem Streit war es um \emph{\textcolor{green}{Der Schleier der Beatrice}} und \emph{\textcolor{green}{Lebendige Stunden}} gegangen. Hier bezog sich \textcolor{blue}{Goldmann} auf die \emph{\textcolor{green}{Beatrice}} und seine \textcolor{green}{Kritik} darüber: \textcolor{blue}{Paul Goldmann}: \emph{\textcolor{green}{Berliner Theater. (»Der Schleier der Beatrice« von Arthur
                        Schnitzler.)}}. In: \emph{\textcolor{green}{Neue Freie
                        Presse}}, Nr. 13.851, 19. 3. 1903,
                     Morgenblatt, S. 1–5.}}}\label{K_L03478-4h} in der \textcolor{green}{Öffentlichkeit}{}\ledrightnote{{$\rightarrow$}\textcolor{green}{Berliner Theater. (»Der Schleier der Beatrice« von Arthur Schnitzler.)}} anders geurteilt hätte, als ich dies vorher
...
\pstart
           Was mich von Dir ferngehalten hat, war etwas anderes. In \label{K_L03478-6v}\edtext{einem Deiner Briefe}{\lemma{\textnormal{\emph{einem Deiner Briefe}}}\Cendnote{\textnormal{Der Brief ist nicht erhalten. Auffällig ist vielleicht die
                  Verwendung des Wortes »unkünstlerisch«, das in \textcolor{blue}{Schnitzler}s \emph{\textcolor{green}{Tagebuch}}
                  kein einziges Mal verwendet wird, in \textcolor{blue}{Goldmann}s Briefen aber (einschließlich der vorliegenden Stelle) fünf
               ...
               Journaliſten die Rede iſt, einem »\label{K_L03478-7v}\edtext{\textsc{\begin{otherlanguage}{french}raté\end{otherlanguage}}}{\lemma{\textnormal{\emph{raté}}}\Cendnote{\textnormal{französisch: Versager; vgl. Paul Goldmann an Arthur Schnitzler, 6. 7. [1895]}}}\label{K_L03478-7h}«, der »\label{K_L03478-8v}\edtext{\textcolor{green}{zu den Menſchen gehört, die eine
                  poetiſche Seele, aber kein poetiſches Talent haben.}{}\ledrightnote{{$\rightarrow$}\textcolor{green}{Stunde des Erkennens}}}{\lemma{\textnormal{\emph{zu … haben.}}}\Cendnote{\textnormal{\textcolor{blue}{Goldmann} dürfte sich durch diese Stelle im Einakter \emph{\textcolor{green}{Stunde des Erkennens}} angesprochen gefühlt
                     haben: »Und vergiß nicht, mir \textcolor{green}{Flöding} zu grüßen. Du kannſt ihm auch ſagen, daß es
                     ...
                     zu ſein.« (\emph{\textcolor{green}{Komödie der Worte.
                        Drei Einakter}}. Berlin: \emph{\textcolor{brown}{S. Fischer Verlag}} 1915, S. 21.) Wenige
                  Zeilen später wird \textcolor{green}{Flöding}
                  als »ein wenig hinkend geschildert (\textcolor{blue}{Goldmann} hatte einen Buckel.) Und dann folgt die von \textcolor{blue}{Goldmann} zitierte Stelle: »Schlimmer
                     find’ ich, daß er eine ſo poetiſche Seele beſitzt und kein poetiſches Talent.
                     Das verdirbt den Charakter, wie es ſcheint.«
                     (S. 21–22). Ob \textcolor{blue}{Schnitzler} hier tatsächlich an \textcolor{blue}{Goldmann} gedacht hat, ist zweifelhaft.}}}\label{K_L03478-8h}« \pend
...
\pstart
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1925-02-161@{16. 2. 1925}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
