...
\newline{}Schnitzler: mit Bleistift das Jahr »98« vermerkt }\toendnotes[C]{\smallbreak}\pstart
           ...
           \pstart
           In einem \label{K_L02861-56v}\edtext{\textcolor{pink}{fran}{}\ledrightnote{→\textcolor{pink}{Frankreich}}zöſiſchen Blatte}{\lemma{\textnormal{\emph{franzöſiſchen Blatte}}}\Cendnote{\textnormal{nicht ermittelt}}}\label{K_L02861-56h} las ich Berichte
           ...
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1898-10-161@{16. 10. {[}1898{]}}|)be}\mylabel{h}\begin{anhang}\end{anhang}\input{../tex-inputs/latex-korrekturansicht-abspann}
