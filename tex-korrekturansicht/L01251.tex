...
\newline{}Schnitzler: mit Bleistift datiert: »23/11 902« \newline{}Ordnung: mit Bleistift von unbekannter Hand nummeriert:
           ...
           \raggedleft{}{\pb}\textcolor{pink}{Rodaun}{}\ledrightnote{\textcolor{pink}{Rodaun}}{ }\label{K_L01251_1v}\edtext{Montg}{\lemma{\textnormal{\emph{Montg}}}\Cendnote{\textnormal{\textcolor{blue}{Schnitzler}s Datierung – 23. –
                     weist auf einen Sonntag. Hier unter Annahme, dass er sich um einen Tag vertut,
                     auf 24. datiert.}}}\label{K_L01251_1h}\pend
           \pstart
           lieber, ich muſste \textcolor{pink}{Venedig}{}\ledrightnote{\textcolor{pink}{Venedig}} wegen
               unerträglicher Kälte in unheizbarem Zimmer \label{K_L01251_2v}\edtext{aufgeben}{\lemma{\textnormal{\emph{aufgeben}}}\Cendnote{\textnormal{Er kam am
                     19. 11. 1902 retour.}}}\label{K_L01251_2h}. Ich bringe mit I und II \textcolor{green}{Act}{}\ledrightnote{→\textcolor{green}{Das gerettete Venedig. Trauerspiel in fünf Aufzügen}} definitiv fertig (beide ſehr
           ...
           \pstart
           \label{K_L01251_3v}\edtext{Beiliegendes}{\lemma{\textnormal{\emph{Beiliegendes}}}\Cendnote{\textnormal{Das betreffende Korrespondenzstück, worin \textcolor{blue}{Hofmannsthal} zu einem Besuch in \textcolor{pink}{Rodaun} lädt, ist abgedruckt in: \emph{Hofmannsthal-Blätter}, H. 37/38 (1988).}}}\label{K_L01251_3h} an \textcolor{blue}{Hauptmann}{}\ledrightnote{\textcolor{blue}{Gerhart Hauptmann}} bitte ich Sie
           ...
           Ein baldiges anderes Mal dann hoffe ich ſehr, Sie kommen nachmittag oder abends
               gemütlich mit \textcolor{blue}{Olga}{}\ledrightnote{\textcolor{blue}{Olga Schnitzler}}. Ich dürfte wegen Arbeit nicht
                  ...
                  Uraufführung von \emph{\textcolor{green}{Der arme Heinrich – Eine deutsche
                     Sage}} am \textcolor{pink}{Burgtheater}}}}\label{K_L01251_4h} (\textcolor{green}{armer Heinrich}{}\ledrightnote{\textcolor{green}{Der arme Heinrich – Eine deutsche Sage}}) nach \textcolor{pink}{Wien}{}\ledrightnote{\textcolor{pink}{Wien}} ko{\geminationm}en. Von Herzen \spacefill\mbox{Hugo.}\pend
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Hugo von@\emph{von Hugo von Hofmannsthal}!1902-11-241@{{[}24?. 11. 1902{]}}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
