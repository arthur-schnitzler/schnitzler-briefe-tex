...
\newline{}Editorischer Hinweis: mit Bleistift auf der Fotografie die handschriftliche Signatur
                                 »\textcolor{blue}{\textsc{A Hertwig}}« und »1903« }\toendnotes[C]{\smallbreak}\pstart{[}Abbildung{]}\pend\begin{figure}[H]\centering\includegraphics[width=10cm]{../tex-inputs/img/ZPH1681_Box_17_3_11_11_40_2_0001_1.jpg}\end{figure}
\pstart
...
\pstart
           ...
           \endnumbering\briefempfaengerindex{Salten, Felix@\textsc{Salten, Felix}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1903-11-122@{12. 11. 1903}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
