...
\newline{}Schnitzler: mit Bleistift das Jahr »93« vermerkt }\toendnotes[C]{\smallbreak}\pstart
           ...
           Soeben erfahre ich von dem traurigen \label{K_L02706-v}\edtext{\textcolor{blue}{Ereigniß}{}\ledrightnote{→\textcolor{blue}{Johann Schnitzler}}}{\lemma{\textnormal{\emph{Ereigniß}}}\Cendnote{\textnormal{Am 2. 5. 1893 verstarb \textcolor{blue}{Schnitzler}s \textcolor{blue}{Vater}{ }\textcolor{blue}{Johann Schnitzler} an einer
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1893-05-042@{4. 5. {[}1893{]}}|)be}\mylabel{h}\begin{anhang}\end{anhang}\input{../tex-inputs/latex-korrekturansicht-abspann}
