...
\newline{}Handschrift: schwarze Tinte, deutsche Kurrent\newline{}Ordnung: mit Bleistift von unbekannter Hand nummeriert: »21. \textsc{Schnitzler}«, die Datierung auf der ersten Seite des zweiten Blattes
           ...
           \label{K_L01114-56v}\edtext{\textcolor{blue}{\textsc{Paul Goldmann}}{}\ledrightnote{\textcolor{blue}{Paul Goldmann}}}{\lemma{\textnormal{\emph{Paul Goldmann}}}\Cendnote{\textnormal{Paul Goldmann an Arthur Schnitzler, 26. 4. [1901]}}}\label{K_L01114-56h} hat mir \textcolor{green}{\textsc{Politiken}}{}\ledrightnote{\textcolor{green}{Politiken}} mit Ihrem \label{K_L01114_1v}\edtext{\textcolor{green}{Artikel}{}\ledrightnote{{$\rightarrow$}\textcolor{green}{Skikkelser og Tanker. Arthur Schnitzler}}}{\lemma{\textnormal{\emph{Artikel}}}\Cendnote{\textnormal{\textcolor{blue}{Georg Brandes}: \emph{\textcolor{green}{Skikkelser og Tanker. Arthur Schnitzler}}. In: \emph{\textcolor{green}{Politiken}}, Nr. 98, 9. 4. 1901, S. 1.
                  Parallel dazu kam es zu einem zweiten Abdruck, der sich in \textcolor{blue}{Schnitzler}s Zeitungsausschnitten (Exeter, box 37/2) findet und aus \emph{\textcolor{brown}{Göteborgs Handels- och Sjöfartstidning}} vom
                     9. 4. 1901 stammt.}}}\label{K_L01114_1h} über mich geſandt und ich verſuchte \textcolor{pink}{däniſch}{}\ledrightnote{\textcolor{pink}{Dänemark}} zu verſtehen, was mir nur zum Theil
               gelang; die \textcolor{green}{Neue Freie Preſſe}{}\ledrightnote{\textcolor{green}{Neue Freie Presse}} kam mir zu \label{K_L01114-66v}\edtext{\textcolor{green}{Hilfe}{}\ledrightnote{{$\rightarrow$}\textcolor{green}{Arthur Schnitzler}}}{\lemma{\textnormal{\emph{Hilfe}}}\Cendnote{\textnormal{\textcolor{blue}{Georg Brandes}: \emph{\textcolor{green}{Arthur Schnitzler}}. In: \emph{\textcolor{green}{Neue Freie Presse}},
           ...
           Sie waren – oder ſind noch? – in \textcolor{pink}{Berlin}{}\ledrightnote{\textcolor{pink}{Berlin}}, wie mir
               ...
               Sie wieder zu uns? Sie würden nicht viel verändert finden – \textcolor{blue}{\textsc{Beer Hofmann}}{}\ledrightnote{\textcolor{blue}{Richard Beer-Hofmann}} hat nun auch zu ſeinen \textcolor{blue}{Töchtern}{}\ledrightnote{{$\rightarrow$}\textcolor{blue}{Mirjam Beer-Hofmann}{\newline}{$\rightarrow$}\textcolor{blue}{Naëmah Beer-Hofmann}} einen \textcolor{blue}{Sohn}{}\ledrightnote{{$\rightarrow$}\textcolor{blue}{Gabriel Beer-Hofmann}} beko{\geminationm}en, aber von dem iſt
           ...
           \endnumbering\briefempfaengerindex{Brandes, Georg@\textsc{Brandes, Georg}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1901-04-251@{25. 4. 1901}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
