...
\renewcommand{\erwaehnteOrte}{Orte: Berlin, Deutschland, San Marco, Stauffenbergstraße, Stazione di Venezia Santa Lucia, Sternwartestraße, Venedig, Wien, XVIII., Währing}
...
\newline{}Zusatz: Von den Korrespondenzstücken \textcolor{blue}{Schnitzler}s an \textcolor{blue}{Goldmann} fehlt weitgehend jede Spur. In der Edition von
                                 ...
                                 werden. Die vorliegende Schwarz-Weiß-Fotokopie wird im Nachlass \textcolor{blue}{Schnitzler}s zusammen mit
                                 ...
                                 einem bestimmten Zeitpunkt im Besitz \textcolor{blue}{Reckford}s gewesen ist. }\toendnotes[C]{\smallbreak}\pstart{}{\pb}\label{T_L02687-1v}\edtext{\textcolor{gray}{\textbf{A. S.}}}{\lemma{\textnormal{\emph{A. S.}}}\Cendnote{\textnormal{ovaler Absenderkleber}}}\label{T_L02687-1h}\pend{}\pstart{}\textcolor{pink}{\textcolor{gray}{\textbf{WIEN, XVIII.}}}{}\ledrightnote{\textcolor{pink}{XVIII., Währing}}\pend{}\pstart{}\textcolor{pink}{\textcolor{gray}{\textbf{STERNWARTESTR. 71}}}{}\ledrightnote{\textcolor{pink}{Sternwartestraße}}\pend{}
{\bigskip}\pstart{}{\pb}\textcolor{pink}{Germania}{}\ledrightnote{\textcolor{pink}{Deutschland}}\pend{}\pstart{}Hn Dr Paul Goldmann\pend{}\pstart{}\textcolor{pink}{Berlin W}{}\ledrightnote{\textcolor{pink}{Berlin}}\pend{}\pstart{}\textcolor{pink}{Bendlerstr 36}{}\ledrightnote{\textcolor{pink}{Stauffenbergstraße}}\pend{}
{\bigskip}
\pstart
...
\pstart
           Auf ein gutes Wiedersehen, sei’s in \textcolor{pink}{Berlin}{}\ledrightnote{\textcolor{pink}{Berlin}}, in
                  \textcolor{pink}{Wien}{}\ledrightnote{\textcolor{pink}{Wien}} oder vielleicht einmal im \label{K_L02687-1v}\edtext{So\damage{\textcolor{gray}{mmer}}}{\lemma{\textnormal{\emph{Sommer}}}\Cendnote{\textnormal{\textcolor{blue}{Goldmann} und \textcolor{blue}{Schnitzler} sahen sich erst am 7. 10. 1927
                  wieder.}}}\label{K_L02687-1h}?\pend
           
\pstart
           Ich dürfte bis Anfang Au\damage{gus}t zu Hause bleiben.\pend
           \pstart Dein \spacefill\mbox{Arthur}\pend{}\endnumbering\briefempfaengerindex{Goldmann, Paul@\textsc{Goldmann, Paul}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1927-04-251@{25. 4. 1927}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
