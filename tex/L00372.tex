...
\newline{}Schnitzler: mit Bleistift datiert: »25/9 94« und nummeriert: »68« }\buchAbdrucke{\weitereDrucke{Hugo von Hofmannsthal, Arthur Schnitzler: \emph{Briefwechsel}. Hg. Therese Nickl und Heinrich Schnitzler. Frankfurt am Main: \emph{S. Fischer} 1964, S. 52.} }\pstart{}{\pb}\textsc{Herrn D\textsuperscript{r} Arthur
           ...
           \pstart \spacefill\mbox{Hugo}\pend{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Hugo von@\emph{von Hugo von Hofmannsthal}!1894-09-251@{25. 9. 1894}|)be}\mylabel{h}  
         \normalsize
