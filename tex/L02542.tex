...
\newline{}Schnitzler: mit rotem Buntstift beschriftet »\textsc{Hugo}« und mehrere Unterstreichungen }\toendnotes[C]{\smallbreak}\pstart
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Gertrude von@\emph{von Gertrude von Hofmannsthal}!1931-02-161@{16. 2. 1931}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
