...
\newline{}Schnitzler: 1) mit Bleistift das Jahr »93« vermerkt 2) mit rotem Buntstift vier Unterstreichungen}\toendnotes[C]{\smallbreak}\pstart
           ...
           \pstart
           Nachdem ich bisher vergeblich auf die verſprochenen Kritiken oder we nigſtens auf
               eine briefliche Mitthei lung über die \textsc{Premièren}-Ein drücke
               gewartet, habe ich mir das Nöthige von Frankfurt\textcolor{red}{\textsuperscript{\textbf{KEY}}} kommen
               laſſen und bitte Dich, Dich nun nicht mehr zu bemühen. \pend
           \pstart
           Wenn ich aus der Samm lung der Kritiken, die mir vor liegt, die dummen \textcolor{gray}{Junger\textcolor{red}{\textsuperscript{\textbf{KEY}}}s\textcolor{red}{\textsuperscript{\textbf{KEY}}}}Neue Freie Preſſe\textcolor{red}{\textsuperscript{\textbf{KEY}}} weglaſſe – Neues Wien\textcolor{red}{\textsuperscript{\textbf{KEY}}}er\textcolor{red}{\textsuperscript{\textbf{KEY}}}\textcolor{red}{\textsuperscript{\textbf{KEY}}}Tagblatt\textcolor{red}{\textsuperscript{\textbf{KEY}}}\textcolor{red}{\textsuperscript{\textbf{KEY}}}, Volksblatt\textcolor{red}{\textsuperscript{\textbf{KEY}}}\textcolor{red}{\textsuperscript{\textbf{KEY}}}, Vaterland\textcolor{red}{\textsuperscript{\textbf{KEY}}}\textcolor{red}{\textsuperscript{\textbf{KEY}}}\textsc{etc}. – und mich nur an {\pb}
               die Zurechnungsfähigen\textcolor{red}{\textsuperscript{\textbf{KEY}}} halte, wie \textsc{Uhl\textcolor{red}{\textsuperscript{\textbf{KEY}}}}, \textsc{Bahr\textcolor{red}{\textsuperscript{\textbf{KEY}}}} und \textsc{Brociner\textcolor{red}{\textsuperscript{\textbf{KEY}}}}, ſo finde ich, daß man Dich hier auch mehrfach mißverſteht, daß man Dir aber
               auch vielerlei Richtiges und Beherzigenswer thes ſagt. Beſonders \textsc{Uhl\textcolor{red}{\textsuperscript{\textbf{KEY}}}} halte ich für im Weſentlichen richtig urtheilend. Du erinnerſt Dich, wir haben
               ...
               falſch. Ich komme immer mehr dahinter, daß das Produ ciren ein Streben nach möglich
               ſter Objectivirung ſein muß, am allermeiſten aber das dra matiſche Produciren. Ich
               habe das in \textsc{Paris\textcolor{red}{\textsuperscript{\textbf{KEY}}}} noch mehr gelernt, habe daraufhin das »Märchen\textcolor{red}{\textsuperscript{\textbf{KEY}}}«
               nochmals geleſen und meine Ausſtellungen von früher noch mehr beſtätigt gefunden.
               Erinnere Dich auch, was ich Dir ſtets über den dritten Act geſagt! Im Allgemeinen
               aber denke ich, daß Du mit Deinem Debüt nicht unzu frieden ſein darfſt. Du biſt den
               Kennern ſignali ſirt; alle Leute, die es ver ſtehen, haben Dein großes {\pb} Talent erkannt; die dummen Bande Publicum wirſt Du
               jetzt raſch gewinnen. Aber jetzt ſofort weiter ſchreiben! Vieles lernren aus den drei
               zurechnungsfähigen Kritiken\textcolor{red}{\textsuperscript{\textbf{KEY}}}. Und ein Drama machen, keine
               Beichte, kein Tagebuch! Das koſtet mir eine Willensanſtrengung. Denn Du biſt, ich
               weiß es genau, ein Dramatiker aller erſten Ranges. Mach’ auch einen neuen Verſuch mit
               dem \textsc{Alkandi\textcolor{red}{\textsuperscript{\textbf{KEY}}}}, nachdem Du vorher den Schluß verſtärk\strikeout{t}end
               umgearbeitet haſt. An \textsc{Uhl\textcolor{red}{\textsuperscript{\textbf{KEY}}}} hatte ich geſchrieben, damit er Dich nicht in der Frkf.
                  Ztg.\textcolor{red}{\textsuperscript{\textbf{KEY}}} etwas ſchlecht behandle. Ich glaube, er wer ganz anſtändig? \pend
           \pstart
           Treue Grüße! Dein P. G.\pend
