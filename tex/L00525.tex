...
\newline{}Handschrift: Bleistift, deutsche Kurrent}\toendnotes[C]{\smallbreak}\pstart
           ...
           \noindent{}\centering{}Ziemlich ſchlechte \label{K_L00525_1v}\edtext{Loge}{\lemma{\textnormal{\emph{Loge}}}\Cendnote{\textnormal{undatiert, unter den
               ...
               Gruſs.\pend
           \endnumbering\briefempfaengerindex{Beer-Hofmann, Richard@\textsc{Beer-Hofmann, Richard}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1896-01-011@{{[}1896?{]}}|)be}\mylabel{h}  
         \normalsize
