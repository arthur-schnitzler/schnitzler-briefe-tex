...
\newline{}Schnitzler: mit Bleistift datiert: »März 99« \newline{}Ordnung: beschnitten }\toendnotes[C]{\smallbreak}\pstart
           ...
           \pstart grusz \spacefill\mbox{goldmann +}\pend{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1899-03-211@{{[}21. 3. 1899?{]}}|)be}\mylabel{h}\begin{anhang}\end{anhang}\input{latex-korrekturansicht-abspann}
