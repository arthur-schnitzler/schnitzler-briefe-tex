...
\newline{}Handschrift: 1) schwarze Tinte, deutsche Kurrent\hspace{1em}2) schwarze Tinte, lateinische Kurrent (\noindent{}Anschrift)\hspace{1em}\newline{}Versand: Stempel: »\nobreak{}\oindex{XVIII., Waehring@\textbf{XVIII., Währing}, \emph{Bezirk (A.BZK)}|pwk}18/\textcolor{gray}{1} Wien, \textcolor{gray}{9. }X. 16\nobreak{}«.  \newline{}Zusatz: Postkartenmotiv mit \textcolor{blue}{Olga} und
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Adam, Robert@\textsc{Adam, Robert}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1916-10-091@{9. 10. 1916}|)be}\mylabel{h}  
         \normalsize
