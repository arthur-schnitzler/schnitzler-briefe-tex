...
\physDesc{Telegramm
\newline{}Handschrift einer Schreibkraft: blauer Buntstift, deutsche Kurrent\newline{}Versand: »\noindent{}\textcolor{pink}{Roda\damage{\textcolor{gray}{un}}}{ }\textcolor{gray}{\textbf{Nr.{\dots} Taxw.{\dots} (W.{\dots}
...
\newline{}Schnitzler: mit Bleistift datiert: »2\substVorne{}\textsuperscript{6}\substDazwischen{}7\substHinten{}/X 09« und beschriftet: »Hofm« \newline{}Ordnung: 1) beschnitten 2) mit Bleistift von unbekannter Hand nummeriert: »310«}\buchAbdrucke{\weitereDrucke{Hugo von Hofmannsthal, Arthur Schnitzler: \emph{Briefwechsel}. Hg. Therese Nickl und Heinrich Schnitzler. Frankfurt am Main: \emph{S. Fischer} 1964, S. 246.} }\toendnotes[C]{\smallbreak}\pstart
           \noindent{}{\pb}= Freue mich rieſig auf \label{K_L01882_1v}\edtext{\textcolor{green}{montag}{}\ledrightnote{→\textcolor{green}{Der junge Medardus. Dramatische Historie in einem Vorspiel und fünf Aufzügen}}}{\lemma{\textnormal{\emph{montag}}}\Cendnote{\textnormal{vgl. A. S.: \emph{Tagebuch}, 1. 11. 1909}}}\label{K_L01882_1h} = \pend
           \pstart \spacefill\mbox{Hugo +}\pend{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Hugo von@\emph{von Hugo von Hofmannsthal}!1909-10-272@{27. 10. 1909}|)be}\mylabel{h}  
         \normalsize
