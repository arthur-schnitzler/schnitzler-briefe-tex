...
\newline{}Schnitzler: mit Bleistift datiert: »\textsc{Mai} 99« und am Ende des Texts »mettre a
           ...
           Die \textsc{replique} des \textcolor{green}{\textsc{Prosper}}{}\ledrightnote{→\textcolor{green}{Der grüne Kakadu. Groteske in einem Akt}} müſste lauten: \label{K_L00914_4v}\edtext{\textsc{si au moins tu ne faisais que leur tenir compagnie!}}{\lemma{\textnormal{\emph{si … compagnie!}}}\Cendnote{\textnormal{Im Stück heißt es: »– wenn du
                  ...
                  Schärfe)\pend
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Hugo von@\emph{von Hugo von Hofmannsthal}!1899-05-011@{{[}Mai 1899{]}}|)be}\mylabel{h}  
         \normalsize
