...
\newline{}Schnitzler: mit Bleistift die Jahreszahl »95.« ergänzt }\toendnotes[C]{\smallbreak}\pstart
           ...
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Hugo August von@\emph{von Hugo August von Hofmannsthal}!1895-06-021@{2. 6. 1895}|)be}\mylabel{h}  
         \normalsize
