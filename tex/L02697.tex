...
\newline{}Schnitzler: mit Bleistift zwei Mal das Jahr »92« vermerkt }\toendnotes[C]{\smallbreak}\pstart
           ...
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1892-04-231@{23. 4. {[}1892{]}}|)be}\mylabel{h}\begin{anhang}\end{anhang}
         \normalsize
