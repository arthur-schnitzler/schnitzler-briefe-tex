...
\newline{}Schnitzler: mit Bleistift beschriftet: »\textsc{Ehrenstein}« }\toendnotes[C]{\smallbreak}\pstart
           ...
           von den bei Ihnen liegenden Manuſkripten ſind, wie ich bereits im
                    ...
                    genannten \textcolor{green}{Skizzen}{}\ledrightnote{→\textcolor{green}{Saccumum}{\newline}→\textcolor{green}{Mitgefühl}} zu
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzEhrenstein, Albert@\emph{von Albert Ehrenstein}!1909-11-251@{25. 11. 1909}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
