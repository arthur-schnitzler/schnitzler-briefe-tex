...
\newcommand{\symaddr}{\includegraphics[height=6pt]{*}}
\newcommand{\symweiteredrucke}{\includegraphics[height=6pt]{*}}
\newcommand{\symdruckvorlage}{\includegraphics[height=6pt]{*}}
\newcommand{\symstandort}{\includegraphics[height=6pt]{*}}
\newcommand{\symhead}{\includegraphics[height=6pt]{*}}
...
\newline{}Schnitzler: mit Bleistift datiert: »Jann 96« \newline{}Ordnung: beschnitten }\toendnotes[C]{\smallbreak}\pstart
           \centering{}{\pb}\textcolor{pink}{w}{}\ledrightnote{\textcolor{pink}{Wien}} de { }\textcolor{pink}{paris}{}\ledrightnote{\textcolor{pink}{Paris}} 18798 \label{K_L02690-1v}\edtext{30}{\lemma{\textnormal{\emph{30}}}\Cendnote{\textnormal{Das dürfte den Kalendertag bezeichnen, an dem das
                     Telegramm versandt wurde.}}}\label{K_L02690-1h}{ }12 =\pend
           \pstart
           vielen dank fuer liebes \label{K_L02690-11v}\edtext{anerbieten}{\lemma{\textnormal{\emph{anerbieten}}}\Cendnote{\textnormal{Unter der Voraussetzung,
                  dass die Datierung stimmt, könnte es sich um eine Einladung nach \textcolor{pink}{Berlin} gehandelt haben, wo am 4. 2. 1896 die Premiere von \emph{\textcolor{green}{Liebelei}} am \emph{\textcolor{brown}{Deutschen
                     Theater}} bevorstand.}}}\label{K_L02690-11h} aber leider unmoeglich aus zahlreichen gruenden
               hauptsaechlich geldmangel und schwierigkeit inmitten saison ohne zwingendsten grund
               urlaub zu bekommen\pend
           \pstart gruss ? \spacefill\mbox{goldmann}\pend{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1896-01-301@{{[}30.? 1. 1896{]}}|)be}\mylabel{h}\begin{anhang}\end{anhang}
         \normalsize
