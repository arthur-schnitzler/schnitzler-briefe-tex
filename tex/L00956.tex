...
\newline{}Handschrift: Bleistift, deutsche Kurrent\newline{}Versand: 1) Stempel: »\nobreak{}\oindex{Toblach@\textbf{Toblach}, \emph{Besiedelter Ort (A.BSO)}|pwk}Toblach Bhf., 1. 8. 99\nobreak{}«.  2) Stempel: »\nobreak{}\oindex{Seeboden@\textbf{Seeboden}, \emph{http://www.geonames.org/ontologyA.ADM3}|pwk}{[}Seeboden{]}, \textcolor{gray}{2}. 8. {[}1899{]}\nobreak{}«. }\pstart{}{\pb}Herrn \textsc{Dr. Rich.
           ...
           \pstart Herzlichen Gruß Ihr \spacefill\mbox{Arthur}\pend{}\endnumbering\briefempfaengerindex{Beer-Hofmann, Richard@\textsc{Beer-Hofmann, Richard}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1899-08-011@{1. 8. 1899}|)be}\mylabel{h}  
         \normalsize
