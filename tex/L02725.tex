...
\thispagestyle{empty} 
               ...
               \section[Paul Goldmann an Arthur Schnitzler, {[}31. 12. 1893{]}]{ Paul Goldmann an Arthur Schnitzler, {[}31. 12. 1893{]}}\nopagebreak\mylabel{v}\rehead{ }\normalsize\beginnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1893-12-312@{{[}31. 12. 1893{]}}|(be} \toendnotes[C]{\smallbreak\pagebreak[2]} \Standort{DLA, A:Schnitzler, HS.NZ85.1.3163.}
\physDesc{Postkarte
\newline{}Handschrift: 1) schwarze Tinte, deutsche Kurrent\hspace{1em}2) schwarze Tinte, lateinische Kurrent (\noindent{}Adresse)\hspace{1em}\newline{}Versand: 1) Stempel: »\nobreak{}\oindex{Place de la Bourse@\textbf{Place de la Bourse}, \emph{Platz (K.PLT)}|pwk}Par{[}is{]} Pl. de la
                                          Bour{[}se{]}, \textcolor{gray}{×}\-\textcolor{gray}{×}\-\textcolor{gray}{×}\begin{otherlanguage}{french}Dec\end{otherlanguage}{[}.{]} 93, 4\textcolor{gray}{×}\-\textcolor{gray}{×}\nobreak{}«.  2) Stempel: »\nobreak{}Wien 9/3, 31. 23. 93, 8.V, 72 Bestellt\nobreak{}«. }\pstart{}{\pb}\textsc{\textcolor{pink}{Autriche}{}\ledrightnote{\textcolor{pink}{Österreich}}}.\pend{}\pstart{}\textsc{Herrn Dr. Arthur Schnitzler}\pend{}\pstart{}\textsc{\textcolor{pink}{IX. Frankgaße 1}{}\ledrightnote{\textcolor{pink}{Frankgasse}}}\pend{}\pstart{}\textsc{\textcolor{pink}{Wien}{}\ledrightnote{\textcolor{pink}{Wien}}. }\pend{}{\bigskip}\pstart
           \noindent{}{\pb}1.) Leſen. \textsc{Albrecht Dürer\textcolor{red}{\textsuperscript{\textbf{KEY}}}s} Briefe\textcolor{red}{\textsuperscript{\textbf{KEY}}}und Tagebücher\textcolor{red}{\textsuperscript{\textbf{KEY}}} (\textsc{Braumueller\textcolor{red}{\textsuperscript{\textbf{KEY}}}, Wien\textcolor{red}{\textsuperscript{\textbf{KEY}}}}, 1872). \pend
           \pstart
           ...
           \pstart
           P. G. \pend
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1893-12-312@{{[}31. 12. 1893{]}}|)be}\mylabel{h}\begin{anhang}\end{anhang}
         \normalsize
