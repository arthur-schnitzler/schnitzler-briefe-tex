...
\newline{}Schnitzler: mit Bleistift nummeriert: »48« und datiert: »27/5 93« }\buchAbdrucke{\weitereDrucke{Hugo von Hofmannsthal, Arthur Schnitzler: \emph{Briefwechsel}. Hg. Therese Nickl und Heinrich Schnitzler. Frankfurt am Main: \emph{S. Fischer} 1964, S. 39.} }\pstart{}{\pb}\textsc{Herrn D\textsuperscript{r} Arthur
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Hugo von@\emph{von Hugo von Hofmannsthal}!1893-05-271@{27. 5. 1893}|)be}\mylabel{h}  
         \normalsize
