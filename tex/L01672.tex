...
\newline{}Handschrift: Bleistift (\noindent{}Unterschrift)\newline{}Ordnung: mit Bleistift von unbekannter Hand Nummerierungen angebracht:
           ...
           \pstart Herzlichchst Ihr\spacefill\mbox{{[}hs.:{]} Hugo}\pend{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Hugo von@\emph{von Hugo von Hofmannsthal}!1907-04-291@{29. 4. 1907}|)be}\mylabel{h}  \input{latex-korrekturansicht-abspann}
