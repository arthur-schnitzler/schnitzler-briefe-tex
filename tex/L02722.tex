...
\newline{}Schnitzler: mit Bleistift das Jahr »93« vermerkt }\toendnotes[C]{\smallbreak}\pstart
           ...
           \pstart
           Beilegend eine Zuſchrift \textsc{Uhl\textcolor{red}{\textsuperscript{\textbf{KEY}}}s}, die ich heut erhielt. Bitte; ſende ſie
               mir ſofort zurück. \pend
           \pstart
           Und ſchreib mir doch endlich einmal zwei Worte. \pend
           \pstart
           Iſt es wahr, daß das Volkstheater\textcolor{red}{\textsuperscript{\textbf{KEY}}} Dich gleich nach der
               zweiten Vorſtellung ab geſetzt? Das ſieht der feigen und gemeinen Bande\textcolor{red}{\textsuperscript{\textbf{KEY}}} ganz ähnlich. Wahrſcheinlich haben die Frauen der Actionäre {\pb} proteſtirt. Die Verherrlichung einer Gefallenen!
                  \textsc{Pensez donc}! \pend
           \pstart
           Weiter ſchreiben, liebſter Freund, weiter ſchreiben! \pend
           \pstart
           Dein treuer Paul Goldmann\pend
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1893-12-061@{6. 12. {[}1893{]}}|)be}\mylabel{h}\begin{anhang}\end{anhang}
         \normalsize
