...
\newline{}Handschrift einer Schreibkraft: schwarze Tinte, deutsche Kurrent\newline{}Versand: »\noindent{}\textcolor{gray}{\textbf{Von }}\textcolor{pink}{Kaltenbach Ischl}{ / }\textcolor{gray}{\textbf{Aufgabe-Nr.}} 544 \textcolor{gray}{\textbf{mit
           ...
           \pstart \spacefill\mbox{Arthur}\pend{}\endnumbering\briefempfaengerindex{Beer-Hofmann, Richard@\textsc{Beer-Hofmann, Richard}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1899-08-231@{23. 8. 1899}|)be}\mylabel{h}  
         \normalsize
