...
\newline{}Handschrift: Bleistift, deutsche Kurrent\newline{}Versand: 1) Stempel: »\nobreak{}\oindex{IX., Alsergrund@\textbf{IX., Alsergrund}, \emph{Bezirk (A.BZK)}|pwk}Wien 9/3 72, 5. 1. 99, 3–4 N\nobreak{}«.  2) Stempel: »\nobreak{}{\pb}Wien, 5. 1. 99, 6½–8N, Bestellt\nobreak{}«. \newline{}Ordnung: mit Bleistift von unbekannter Hand
           ...
           \pstart Herzlichen
               Gruss. Ihr
               \spacefill\mbox{Arthur}\pend{}\endnumbering\briefempfaengerindex{Beer-Hofmann, Richard@\textsc{Beer-Hofmann, Richard}!zzzSchnitzler, Arthur@\emph{von Arthur Schnitzler}!1899-01-051@{5. 1. 1899}|)be}\mylabel{h}  
         \normalsize
