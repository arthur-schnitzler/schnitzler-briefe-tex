...
\newline{}Schnitzler: mit Bleistift beschriftet: »\textsc{Ehrenst\textcolor{gray}{e}i\textcolor{gray}{n}}« }\toendnotes[C]{\smallbreak}\pstart
           ...
           Am 10. Oktober, um ½ 5\textsuperscript{h} nachmittags war ich so rücksichtslos, bei Ihnen, sehr geehrter Herr
                    Doktor, ein in braunes Packpapier geschlagenes \textcolor{green}{Manuscript}{}\ledrightnote{→\textcolor{green}{Seltene Gäste}} nebst inliegendem Briefe zu
           ...
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzEhrenstein, Albert@\emph{von Albert Ehrenstein}!1908-10-201@{20. 10. 1908}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
