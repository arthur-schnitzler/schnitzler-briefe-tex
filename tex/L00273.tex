...
\newline{}Schnitzler: mit Bleistift nummeriert: »1« }\toendnotes[C]{\smallbreak}\pstart
           ...
           Ihrem, Ihnen{\\[\baselineskip]}in wahrer Hochachtung{\\[\baselineskip]}ergebenen{\\[\baselineskip]}\spacefill\mbox{Ferdinand
                        von Saar}.\pend
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzSaar, Ferdinand von@\emph{von Ferdinand von Saar}!1893-10-151@{15. 10. 1893}|)be}\mylabel{h}  
         \normalsize
