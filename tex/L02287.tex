...
\newline{}Schreibmaschine}\toendnotes[C]{\smallbreak}\pstart
           ...
           Darf ich alſo wieder einmal bei Ihnen erſcheinen? Ich möchte Sie gerne der Mühe
                    ...
                    Tag telephoniſch (82202) mitteilen. (Telephon meiner \textcolor{blue}{Eltern}{}\ledrightnote{→\textcolor{blue}{Emil Pollak}{\newline}→\textcolor{blue}{Sidonie Pollak}}).\pend
           \pstart
           Mit beſtem Dank und ergebenſten Grüßen Ihr\pend
           \pstart \spacefill\mbox{Robert Adam}\pend{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzAdam, Robert@\emph{von Robert Adam}!1918-06-121@{12. 6. 1918}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
