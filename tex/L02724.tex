...
\newline{}Schnitzler: 1) mit Bleistift das Jahr »93« vermerkt 2) mit rotem Buntstift zwei Unterstreichungen}\toendnotes[C]{\smallbreak}\pstart
           \centering{}{\pb}\textsc{\textcolor{pink}{Paris}{}\ledrightnote{\textcolor{pink}{Paris}}}, 23. December.\pend
           \pstart\center{}Mein lieber Freund!\pend\pstart
           Dein letzter Brief und die ſich daran ſchließenden Zeilen der Freunde\textcolor{red}{\textsuperscript{\textbf{KEY}}} haben mir eine unendliche Freude bereitet. Mir ſind die
               Thränen in die Augen gekommen, als ich all’ das las. Und ich war einen ganzen Tag
               lang glücklich, ſo viel Freundſchaft und Treue verdient zu haben. Gern hätte ich Dir,
               dem lieben Anſtifter der Freudengabe, und allen Betheiligten ſofort gedankt. Da kam
               die Bombe in der Kammer\textcolor{red}{\textsuperscript{\textbf{KEY}}} und ſonſt Allerlei und warf mich
               weit ab von Euch und all den frohen Gedanken. {\pb}
               Inzwiſchen kam auch Dein liebes Bild. Dank, innigen Dank für die Sendung. Ich habe es
               auf meinem Schreib tiſch aufgeſtellt und tauſche mit Dir manch einen Blick und
               verſinke in manch’ eine Träumerei während irgend eines politiſchen Artikels. Es iſt
               eine vorzügliche Aufnahme – wenngleich Du freilich in Wirklichkeit nie ſo hübſch
               geweſen. Auch zeige ich Dich Allen, die mich beſuchen kom men, und Du haſt viel
               Erfolg. Neulich war \textsc{Jean\textcolor{red}{\textsuperscript{\textbf{KEY}}}}\textsc{Thorel\textcolor{red}{\textsuperscript{\textbf{KEY}}}} bei mir und ſagte: »\label{XXXXv}\edtext{Je jurerais, que
                  c’est un[Kommentar:
                  französisch\u003a\u0020Ich\u0020könnte\u0020schwören,\u0020dass\u0020das\u0020ein\u0020Herr\u0020ist,\u0020der\u0020XXXX\u0020schreibt.]}{\lemma{\textnormal{\emph{XXXX Lemmafehler}}}\Cendnote{\textnormal{}}}\label{XXXX}\label{XXXXv}\edtext{monsieur, qui écrit des[Kommentar:
                  französisch\u003a\u0020Ich\u0020könnte\u0020schwören,\u0020dass\u0020das\u0020ein\u0020Herr\u0020ist,\u0020der\u0020XXXX\u0020schreibt.]}{\lemma{\textnormal{\emph{XXXX Lemmafehler}}}\Cendnote{\textnormal{}}}\label{XXXX}\label{XXXXv}\edtext{XXXXcarnéchis.[Kommentar:
                  französisch\u003a\u0020Ich\u0020könnte\u0020schwören,\u0020dass\u0020das\u0020ein\u0020Herr\u0020ist,\u0020der\u0020XXXX\u0020schreibt.]}{\lemma{\textnormal{\emph{XXXX Lemmafehler}}}\Cendnote{\textnormal{}}}\label{XXXX}« Wenn Du jetzt {\pb}\strikeout{X} noch keine Luſtſpiele ſchreiben willſt....! \pend
           \pstart
           Bitte liebſter Freund, ſchreib’ mir ein ausführlicheres Wort über Deine Pläne. Die
               Idee mit dem ſüßen Wien\textcolor{red}{\textsuperscript{\textbf{KEY}}}er Stück\textcolor{red}{\textsuperscript{\textbf{KEY}}} gefällt mir ſehr. Das müßte Dir ganz ausnehmend liegen. Und ſchreib
               vor allen Dingen ein Stück ohne Dich. Was macht dein Roman\textcolor{red}{\textsuperscript{\textbf{KEY}}}? Brinſgt Du ihn nirgends an? Sende mir auch, wenn möglich, ein oder
               zwei Exemplare \textsc{Anatol\textcolor{red}{\textsuperscript{\textbf{KEY}}}} zu Progaganda- Zwecken. In Paris\textcolor{red}{\textsuperscript{\textbf{KEY}}} bekommt man
               nämlich nie ein Buch wieder, wenn man es wegborgt. Ich hoffe doch {\pb} noch etwas für Dich hier durch zuſetzen. Die
               Übergabe Deiner Novellen\textcolor{red}{\textsuperscript{\textbf{KEY}}} an eine Mitarbeiterin\textcolor{red}{\textsuperscript{\textbf{KEY}}} der \textsc{Vie Parisienne\textcolor{red}{\textsuperscript{\textbf{KEY}}}} habe ich doch nicht in’s Werk ſetzen wollen. Gewiſſe Erfahrungen der letzten
               Zeit haben mich gelehrt, daß möglicher Weiſe Deine Novelle\textcolor{red}{\textsuperscript{\textbf{KEY}}} Aufnahme gefunden hätte, aber nicht unter Deinem Namen, – Du
               verſtehſt? \pend
           \pstart
           Schreib’ mir auch, was mit \textsc{Bahr\textcolor{red}{\textsuperscript{\textbf{KEY}}}} vorgegangen iſt? Warum der Austritt aus der »deutſchen
                  Ztg\textcolor{red}{\textsuperscript{\textbf{KEY}}}«? Wird das Blatt\textcolor{red}{\textsuperscript{\textbf{KEY}}} eingehen? \pend
           \pstart
           Fröhliche Feiertage, mein lieber Freund, und nochmals Dank Dir und den Andern und
               viele treue Grüße an Euch Alle. \pend
           \pstart
           Dein Paul Goldm\pend
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1893-12-231@{23. 12. {[}1893{]}}|)be}\mylabel{h}\begin{anhang}\end{anhang}
         \normalsize
