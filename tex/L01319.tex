...
\newline{}Schnitzler: mit Bleistift die Jahreszahl »903« ergänzt \newline{}Ordnung: 1) mit Bleistift von unbekannter Hand nummeriert:
           ...
           \pstart
           \label{OL444-1v}\label{OL444-1h}lieber, ich vergeſſe nun ſchon 6mal, \strikeout{daſs} Sie zu erinnern, daß Sie mir die \textcolor{green}{Photographie}{}\ledrightnote{→\textcolor{green}{Arthur Schnitzler}} (die gleiche wie der \textcolor{blue}{Bahr}{}\ledrightnote{\textcolor{blue}{Hermann Bahr}}{ }\label{T_L01319_1v}\edtext{hat)}{\lemma{\textnormal{\emph{hat)}}}\Cendnote{\textnormal{An dieser
                        Stelle ein senkrechter Strich, mutmaßlich als Erinnerung von \textcolor{blue}{Schnitzler} gemacht, um das nicht zu
                    ...
                    Zimmern, das \textcolor{blue}{Kind}{}\ledrightnote{→\textcolor{blue}{Heinrich Schnitzler}}, das
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzHofmannsthal, Hugo von@\emph{von Hugo von Hofmannsthal}!1903-09-271@{27. 9. {[}1903{]}}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
