...
\newline{}Schnitzler: 1) mit Bleistift das erste Blatt mit »1.«
           ...
           \noindent{}{\pb}\footnote{}\textcolor{brown}{\textcolor{gray}{\textbf{\textbf{Frankfurter Zeitung}}}}{}\ledrightnote{\textcolor{brown}{Frankfurter Zeitung}}\pend
           \pstart
           ...
           \pstart
           \noindent{}Ich bin für wenige Tage zum Beſuch in \textcolor{pink}{Frankfurt}{}\ledrightnote{\textcolor{pink}{Frankfurt am Main}},
               um der \label{K_L02709-1v}\edtext{Hochzeit meiner \textcolor{blue}{Schweſter}{}\ledrightnote{→\textcolor{blue}{Vally Rosengart}}}{\lemma{\textnormal{\emph{Hochzeit … Schweſter}}}\Cendnote{\textnormal{\textcolor{blue}{Vally Rosengart}, vormals \textcolor{blue}{Goldmann}, heiratete den in \textcolor{pink}{Laupheim} geborenen \textcolor{blue}{Arzt}{ }\textcolor{blue}{Josef Rosengart}.}}}\label{K_L02709-1h} beizuwohnen. Mein
               ...
               ſchließlich Deinen \label{K_L02709-2v}\edtext{Brief}{\lemma{\textnormal{\emph{Brief}}}\Cendnote{\textnormal{In seinen Antwortbriefen vom 4. 6. 1893 und 17. 11. 1892 lobte \textcolor{blue}{Fedor Mamroth} ausdrücklich \textcolor{blue}{Schnitzler}s \textcolor{green}{Novelle}{ }\emph{\textcolor{green}{Sterben}} – ihm unter dem Titel »\textcolor{green}{Der sterbende Herr}« bekannt:
                     »Ich habe Ihren \textcolor{green}{Roman} »\textcolor{green}{Der sterbende
                        Herr}« mit einer Theilnahme gelesen, die mir noch selten eine
                  ...
                  Änderung des Titels. Vgl. Fedor Mamroth an Arthur Schnitzler, 5. 3. 1893 Gedruckt wurde
                     \emph{\textcolor{green}{Sterben}}, das erste Mal am 25. 9. 1893 unter diesem
                  Titel im \emph{\textcolor{green}{Tagebuch}} notiert, in Heft 10–12
                     (1894) der \emph{\textcolor{green}{Neuen
                     Deutschen Rundschau}}.}}}\label{K_L02709-2h}, es tief beklagend, daß \label{K_L02709-3v}\edtext{zwiſchen Dich und ihn etwas getreten}{\lemma{\textnormal{\emph{zwiſchen … getreten}}}\Cendnote{\textnormal{Möglich ist, dass \textcolor{blue}{Schnitzler} nicht nur wegen der ausbleibenden Besprechung
                  des \emph{\textcolor{green}{Anatol}}, sondern auch aufgrund der
                  wiederholten Ablehnungen seiner Werke durch \textcolor{blue}{Fedor
                     Mamroth} – zuletzt \emph{\textcolor{green}{Das Märchen}} und \emph{\textcolor{green}{Sterben}} – gekränkt war. Insbesondere der Brief
                     \textcolor{blue}{Mamroth}s an \textcolor{blue}{Schnitzler} vom 17. 11. 1892 lässt vermuten, dass \textcolor{blue}{Schnitzler} zudem den ausbleibenden Kontakt nach der Ablehnung des \emph{\textcolor{green}{Märchen}}s als unhöflich empfunden haben
                  dürfte.}}}\label{K_L02709-3h} iſt, das beſſer nicht da wäre. Dein Brief, mein lieber Freund, iſt
                  {\pb}ebenſo an mich gerichtet, wie an meinen \textcolor{blue}{Onkel}{}\ledrightnote{→\textcolor{blue}{Fedor Mamroth}}. Vieles von dem, was Du
               ...
               Menſch auf der Welt verpflichtet war, über »\textcolor{green}{Anatol}{}\ledrightnote{\textcolor{green}{Anatol}}« zu ſchreiben, ſo war ich es. Das \textcolor{green}{Buch}{}\ledrightnote{→\textcolor{green}{Anatol}} kam bei mir an in einer meiner ſchwerſten Arbeitszeiten
               ...
               Arbeit heraus zugehen und \strikeout{\textcolor{gray}{×}} ein \textcolor{green}{Werk}{}\ledrightnote{→\textcolor{green}{Anatol}} von Dir in
               ...
               Dich nicht warten zu laſſen, ſandte mein \textcolor{blue}{Onkel}{}\ledrightnote{→\textcolor{blue}{Fedor Mamroth}} ſofort Dein \textcolor{green}{Buch}{}\ledrightnote{→\textcolor{green}{Anatol}} unſerem \label{K_L02709-5v}\edtext{\textcolor{pink}{Berlin}{}\ledrightnote{\textcolor{pink}{Berlin}}er \textcolor{blue}{Berichterſtatter}{}\ledrightnote{→\textcolor{blue}{August Stein}}}{\lemma{\textnormal{\emph{Berliner Berichterſtatter}}}\Cendnote{\textnormal{Es könnte sich hierbei um \textcolor{blue}{August Stein} handeln, der das \textcolor{pink}{Berlin}er Büro der \emph{\textcolor{brown}{Frankfurter Zeitung}} seit 1883
                  leitete.}}}\label{K_L02709-5h}. Der \textcolor{blue}{Herr}{}\ledrightnote{→\textcolor{blue}{August Stein}} hat einfach nicht darüber geſchrieben. Und wie {\pb}bei unſerem \textcolor{brown}{Blatte}{}\ledrightnote{→\textcolor{brown}{Frankfurter Zeitung}} die Verhältniſſe liegen, iſt mein \textcolor{blue}{Onkel}{}\ledrightnote{→\textcolor{blue}{Fedor Mamroth}} machtlos, ihn dazu zu zwingen. Mein
                  \textcolor{blue}{Onkel}{}\ledrightnote{→\textcolor{blue}{Fedor Mamroth}} ſelbſt hat ſich dann
               ...
               gehe nach \textcolor{pink}{\textsc{Paris}}{}\ledrightnote{\textcolor{pink}{Paris}} zurück, mit dem feſten Vorſatz, doch über Dein \textcolor{green}{Werk}{}\ledrightnote{→\textcolor{green}{Anatol}} zu \label{K_L02709-7v}\edtext{ſchreiben}{\lemma{\textnormal{\emph{ſchreiben}}}\Cendnote{\textnormal{nicht
                  geschehen}}}\label{K_L02709-7h}, kann aber bei meinem ſchwachen Character für nichts einſtehen.
               Das Geſcheiteſte, im Intereſſe einer raſchen Erledigung, wäre, wenn einer von den \textcolor{pink}{Wien}{}\ledrightnote{\textcolor{pink}{Wien}}er Freunden, \textsc{\textcolor{blue}{Richard}{}\ledrightnote{\textcolor{blue}{Richard Beer-Hofmann}}} oder \textsc{\textcolor{blue}{Loris}{}\ledrightnote{\textcolor{blue}{Hugo von Hofmannsthal}}}, uns ein kleines \introOben{}\label{K_L02709-8v}\edtext{Artikelchen}{\lemma{\textnormal{\emph{Artikelchen}}}\Cendnote{\textnormal{nicht geschehen}}}\label{K_L02709-8h}\introOben{}{ }\strikeout{\textcolor{gray}{×}\-\textcolor{gray}{×}\-\textcolor{gray}{×}\-\textcolor{gray}{×}\-\textcolor{gray}{×}\-\textcolor{gray}{×}} darüber machen wollte. Mein \textcolor{blue}{Onkel}{}\ledrightnote{→\textcolor{blue}{Fedor Mamroth}} verſpricht {\pb}ſofortigen Abdruck. Wenn
           ...
           Über den \textcolor{green}{Roman}{}\ledrightnote{→\textcolor{green}{Sterben. Novelle}} haben wir lange
               ...
               des Publicums. Weder mein \textcolor{blue}{Onkel}{}\ledrightnote{→\textcolor{blue}{Fedor Mamroth}} noch ich ſind in keinen Beziehungen mit einem Verleger. {\pb}Das Einzige, was man für’s Erſte thun könnte, wäre
               ein Brief, den Du dann beifügſt, wenn Du das \textcolor{green}{Manuſkript}{}\ledrightnote{→\textcolor{green}{Sterben. Novelle}} einem \label{K_L02709-6v}\edtext{\textcolor{brown}{Verleger}{}\ledrightnote{→\textcolor{brown}{S. Fischer Verlag}} Deiner Wahl}{\lemma{\textnormal{\emph{Verleger Deiner Wahl}}}\Cendnote{\textnormal{In Buchform erschien \emph{\textcolor{green}{Sterben}} erstmals im November 1894 (vordatiert auf 1895) bei \emph{\textcolor{brown}{S. Fischer}}.}}}\label{K_L02709-6h} einſchickſt und der
               ...
               verſchmähen iſt. Biſt Du aber erſt ein mal mit einem \textcolor{brown}{Verleger}{}\ledrightnote{→\textcolor{brown}{S. Fischer Verlag}} in Beziehung und brauchſt Du meinen \textcolor{blue}{Onkel}{}\ledrightnote{→\textcolor{blue}{Fedor Mamroth}} oder mich zur weiteren
           ...
           \leftskip=0em{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1893-06-031@{3. 6. 1893}|)be}\mylabel{h}\begin{anhang}\end{anhang}\input{../tex-inputs/latex-korrekturansicht-abspann}
