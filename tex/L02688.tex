...
\newline{}Schnitzler: mit Bleistift datiert: »Feber 99« \newline{}Ordnung: beschnitten }\toendnotes[C]{\smallbreak}\pstart
           ...
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1896-02-052@{{[}5.? 2. 1896{]}}|)be}\mylabel{h}\begin{anhang}\end{anhang}\input{latex-korrekturansicht-abspann}
