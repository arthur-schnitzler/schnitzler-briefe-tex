...
\newline{}Schnitzler: 1) mit Bleistift das Jahr »93« vermerkt 2) mit rotem Buntstift drei Unterstreichungen sowie ein nach unten
           ...
           \pstart
           \textcolor{gray}{\textbf{\textbf{(\textcolor{brown}{\begin{otherlanguage}{french}Gazette de
                           Francfort\end{otherlanguage}}{}\ledrightnote{\textcolor{brown}{Frankfurter Zeitung}}.)}}}\pend
           \pstart
           ...
           \pstart
           \begin{otherlanguage}{french}\textcolor{gray}{\textbf{commercial et
                     litteraire.}}\end{otherlanguage}\pend
           \pstart
           \begin{otherlanguage}{french}\textcolor{gray}{\textbf{\textbf{Paraissant
                        trois fois par jour}}}\end{otherlanguage}\pend
           \pstart
           ...
           \pstart
           Dank für die Kritiken; ich kannte ſie größtentheils ſchon. Drei oder vier verſtehen
               Dich oder geben ſich wenigſtens ehrliche Mühe, Dich zu verſtehen. Der kleine \textsc{Salonblatt\textcolor{red}{\textsuperscript{\textbf{KEY}}}}-Mann\textcolor{red}{\textsuperscript{\textbf{KEY}}}, der \strikeout{Dich} Dir zum Luſtſpiel räth,
               iſt auch auf der richtigen Fährte. Du brauchteſt unbedingt ein Paar Monate Pariſ\textcolor{red}{\textsuperscript{\textbf{KEY}}}er Theater; Du würdeſt die unermüdliche Anſtren gung
               des jungen Stücks ſehen, objectiv, kurz, natürlich, luſtig zu werden. Das iſt Dir
               Weg, {\pb} der geradeaus in die Zukunft geht. Das iſt
               auch dir Weg Deines Talents. Ein Luſtſpiel, theuerſter Freund, – odir ein Schauſpiel,
           ...
           \pstart
           \textsc{Bahr}\textcolor{red}{\textsuperscript{\textbf{KEY}}}– der kränkt Dich ſo? Er iſt frech, größenwahn ſinnig, unausſtehlich doctrinär.
                  \strikeout{E} Der Verweis\textcolor{red}{\textsuperscript{\textbf{KEY}}} auf
               ſeine »Neuen Menſchen\textcolor{red}{\textsuperscript{\textbf{KEY}}}« iſt eine glatte Gemeinheit. Und
               doch finde ich ihn nicht reſpect los; und doch finde ich, daß {\pb} er manches Richtige ſagt. Vielleicht aber fehlt mir
               auch das richtige Urtheil; ich bin ſo außer Zuſammenhang mit den Wien\textcolor{red}{\textsuperscript{\textbf{KEY}}}er Verhältniſſen. Heiter iſt nur, wie der Burſch\textcolor{red}{\textsuperscript{\textbf{KEY}}} franzöſiſche Dinge citirt: »Le grappin\textcolor{red}{\textsuperscript{\textbf{KEY}}}«,
               das Theâtre-Libre\textcolor{red}{\textsuperscript{\textbf{KEY}}}-Sück\textcolor{red}{\textsuperscript{\textbf{KEY}}}, von dem er ſpricht, behandelt
               etwas abſolut Anderes als das, was er behauptet. Ein frecher Schwindel, um ſich in
               allen franzöſiſcher Sätteln moderner Literatur gerecht zu zeigen. \pend
           \pstart
           \textsc{Granichstaedten\textcolor{red}{\textsuperscript{\textbf{KEY}}}} hätte ich an Deiner Stelle geohrfeigt. Das iſt keine Kritik, ſondern ein
               Gaſſenbubenſtreich. \pend
           \pstart
           Freut mich, daß Du nicht {\pb} verbittert biſt. Das
               gehört ſich auch ſo. Ich meine, Du kannſt mit Deinem Debüt ſehr zufrieden ſein. Man
               gibt Dir Credit, und das iſt enorm für einen Jungen. \pend
           \pstart
           Haſt Du \textsc{Loris\textcolor{red}{\textsuperscript{\textbf{KEY}}}} über \textsc{Bau\textcolor{red}{\textsuperscript{\textbf{KEY}}}}\textcolor{red}{\textsuperscript{\textbf{KEY}}}\textsc{\textcolor{red}{\textsuperscript{\textbf{KEY}}}}\textsc{ernfeld\textcolor{red}{\textsuperscript{\textbf{KEY}}}\textcolor{red}{\textsuperscript{\textbf{KEY}}}\textcolor{red}{\textsuperscript{\textbf{KEY}}}\textcolor{red}{\textsuperscript{\textbf{KEY}}}\textcolor{red}{\textsuperscript{\textbf{KEY}}}\textcolor{red}{\textsuperscript{\textbf{KEY}}}} geleſen? Wie aus dieſem\textcolor{red}{\textsuperscript{\textbf{KEY}}} geleſen? Wie aus dieſem
               gottbegnadeten Menſchen\textcolor{red}{\textsuperscript{\textbf{KEY}}} die entzückenden Dinge heraus
               quellen, ſo leicht und ſprudelnd. Ein Dichter\textcolor{red}{\textsuperscript{\textbf{KEY}}}!
               Derjenige vielleicht, den man ſeit fünfzig Jahren erwartet! \pend
           \pstart
           Grüß’ ihn von mir, denn ich habe keine directe Ver bindung mehr mit ihm; Grüße auch
                  \textsc{Richard\textcolor{red}{\textsuperscript{\textbf{KEY}}}} aus ſelbigem Grunde; ſei ſelbſt herzlichſt, gegrüßt und ſchreibe
                  bald\textcolor{gray}{!}\pend
           \pstart
           Dein Paul Goldm\pend
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1893-12-081@{8. 12. {[}1893{]}}|)be}\mylabel{h}\begin{anhang}\end{anhang}
         \normalsize
