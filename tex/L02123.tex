...
\newline{}Schnitzler: 1) mit Bleistift beschriftet: »\textsc{G. Engländer}« 2) mit rotem Buntstift eine Unterstreichung und Markierungen}\toendnotes[C]{\smallbreak}\pstart
           ...
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzEnglaender, Georg@\emph{von Georg Engländer}!1913-04-182@{18. 4. 1913}|)be}\mylabel{h}  
         \normalsize
