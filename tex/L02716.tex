...
\newline{}Schnitzler: mit Bleistift das Jahr »93« vermerkt }\toendnotes[C]{\smallbreak}\pstart
           ...
           Ich würdige das Opfer, das Du mir bringſt, in ſeinem vollen Werth und danke es Dir
               ...
               ein letztes Mal: geringe Erwartung, bitte, in Bezug auf mich. Ich bin ſo \label{XXXXv}\edtext{\textsc{par terre}[Kommentar:
                  französisch\u003a\u0020am\u0020Boden\u0020sein]}{\lemma{\textnormal{\emph{XXXX Lemmafehler}}}\Cendnote{\textnormal{}}}\label{XXXX} durch all’ das Unheil. \pend
           \pstart
           Mein Onkel\textcolor{red}{\textsuperscript{\textbf{KEY}}} iſt hier. Ob er noch zur Zeit Deiner Ankunft
               hier ſein wird, iſt nicht ſicher, aber wahrſcheinlich. Ob das {\pb}Hotel\textcolor{red}{\textsuperscript{\textbf{KEY}}} düſter iſt oder nicht, weiß ich eigentlich nicht
               recht zu ſagen. Aber billige Wohnung, gute Koſt, angenehme Bedienung. Bitte,
               telegraphire noch Samſtag: Abgereiſt \strikeout{.}–
               ein Wort. Dann beſtelle ich Dir ein Zimmer. \pend
           \pstart
           Volkstheater\textcolor{red}{\textsuperscript{\textbf{KEY}}}: Ich bin nicht einverſtanden, wünſche aber
               natürlich, daß es zum Guten ſein möge. Nun, wir reden ja darüber. Reden! Es iſt ſo
               ſchön, daß ich feſt überzeugt bin, es wird nichts daraus. \pend
           \pstart
           Grüß’ Dich Gott, Lieber und Treuer! \pend
           \pstart
           Dein Paul Goldmann. \pend
           \pstart
           \textsc{Getreidegasse\textcolor{red}{\textsuperscript{\textbf{KEY}}}}, nicht -\textsc{markt\textcolor{red}{\textsuperscript{\textbf{KEY}}}}.\pend
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzGoldmann, Paul@\emph{von Paul Goldmann}!1893-09-141@{14. 9. {[}1893{]}}|)be}\mylabel{h}\begin{anhang}\end{anhang}
         \normalsize
