...
\physDesc{maschinelle Abschrift}\buchAbdrucke{\weitereDrucke{\emph{Karl Kraus und Arthur Schnitzler. Eine Dokumentation.} Hg. Reinhard Urbach. In: \emph{Literatur und Kritik}, Bd. 49, Oktober 1970, S. 518.} }\toendnotes[C]{\smallbreak}\pstart
           ...
           \pstart treuen \spacefill\mbox{Karl Kraus}\pend{}\endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzKraus, Karl@\emph{von Karl Kraus}!1893-05-051@{5. 5. 1893}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
