...
\newline{}Schnitzler: 1) mit Bleistift beschriftet mit »\textsc{Fels}« 2) mit rotem Buntstift beschriftet mit »\textsc{Fels}«}\toendnotes[C]{\smallbreak}\pstart
           ...
           \endnumbering\briefempfaengerindex{Schnitzler, Arthur@\textsc{Schnitzler, Arthur}!zzzFels, Friedrich Michael@\emph{von Friedrich Michael Fels}!1891-06-181@{18. 6. 1891}|)be}\mylabel{h}  \input{../tex-inputs/latex-korrekturansicht-abspann}
